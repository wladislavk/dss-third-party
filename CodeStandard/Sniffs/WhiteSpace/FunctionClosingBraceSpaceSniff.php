...
/**
 * Class CodeStandard_Sniffs_WhiteSpace_FunctionClosingBraceSpaceSniff
 * Brendan
 *
 */

class CodeStandard_Sniffs_WhiteSpace_FunctionClosingBraceSpaceSniff implements PHP_CodeSniffer_Sniff
{

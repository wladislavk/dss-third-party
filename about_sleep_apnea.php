							...
							<tr>
								<td width="270" valign="top">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<? while($cat_myarray = mysql_fetch_array($cat_my))
										{
												...
												<tr>
													<td height="25" valign="top" class="page3_bg2">
														<a href="about_sleep_apnea.php?said=<?=st($ap_myarray['sleep_apneaid'])?>#cont" id="page3_tabs" >
															<span <? if(st($sa_myarray['sleep_apneaid']) == st($ap_myarray['sleep_apneaid'])) {?> class="selected" <? }?> style=" width:230px;">
																<?=st($ap_myarray['title'])?>
															</span></a>
													</td>
												</tr>
											...
											?>
											<tr>
												<td height="25" valign="top" class="suntab_head1">&nbsp;
								...
								<td width="665" valign="top">
									...
									<table width="640" border="0" align="right" cellpadding="5" cellspacing="1">
										<tr>
											<td width="19" valign="top"><img src="images/bullet_1.gif" width="19" height="13" vspace="2" /></td>
											<td width="618" valign="top" class="suntab_head1">
												<?=st($sa_myarray['title']);?></td>
										</tr>
										<tr>

...
$all_sql = "select * from sleep_apnea_old where status=1 order by sortby";
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td height="25" valign="top" class="page3_bg2">
												<a href="about_sleep_apnea_old.php?said=<?=st($all_myarray['sleep_apneaid'])?>#cont" id="page3_tabs" >

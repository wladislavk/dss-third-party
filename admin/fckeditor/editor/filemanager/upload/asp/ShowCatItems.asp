...
<%
	...
	sqlCatItems = sqlCatItems & "FROM CategoryMaster, ItemMaster, CategoryItemMaster "
	sqlCatItems = sqlCatItems & "WHERE ItemMaster.ItemID = CategoryItemMaster.ItemID and "
...
<BODY>
<!--<div align="center" style="width: 735; height: 259">-->
  <center>
  ...
  <% Else%>
		...
		<% While rsCatItems.EOF <> True %>			
			...
			<tr>
				<td height="1" width="225" align="left" valign="top"><img src="<%=rsCatItems.Fields(3).value%>" height=100 width=100 border=1></td>			

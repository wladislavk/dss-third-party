...
<div align="right">
	<button onclick="Javascript: loadPopup('add_apnea_category.php');" class="addButton">
		Add New Apnea Category
	</button>
	&nbsp;&nbsp;
</div>
	...
	else
	{
		...
		?>
			<tr class="<?=$tr_class;?>">
				...
				<td valign="top">
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_apnea_category.php?ed=<?=$myarray["categoryid"];?>');" class="editlink">
						<img src="images/b_edit.png" width="16" height="16" border="0" align="Edit"/>
					</a>
                    
                    <a href="<?=$_SERVER['PHP_SELF']?>?delid=<?=$myarray["categoryid"];?>" onclick="javascript: return confirm('Do Your Really want to Delete?.');" class="dellink">

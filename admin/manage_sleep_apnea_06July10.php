...
$sql = "select * from sleep_apnea order by sortby";
$my = mysql_query($sql);
...
<div align="right">
	<button onclick="Javascript: loadPopup('add_sleep_apnea.php');" class="addButton">
	...
	else
	{
		...
		?>
			<tr class="<?=$tr_class;?>">
				...
				<td valign="top">
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_sleep_apnea.php?ed=<?=$myarray["sleep_apneaid"];?>');" class="editlink">
						<img src="images/b_edit.png" width="16" height="16" border="0" align="Edit"/>
					</a>
                    
                    <a href="<?=$_SERVER['PHP_SELF']?>?delid=<?=$myarray["sleep_apneaid"];?>" onclick="javascript: return confirm('Do Your Really want to Delete?.');" class="dellink">

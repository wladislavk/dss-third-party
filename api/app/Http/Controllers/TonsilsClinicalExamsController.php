 ...
 */
class TonsilsClinicalExamsController extends BaseRestController
{
    /**
     * @SWG\Get(
     *     path="/tonsils-clinical-exams",
     *     @SWG\Response(
     *         response="200",
     ...
     *                         property="data",
     *                         type="array",
     *                         @SWG\Items(ref="#/definitions/TonsilsClinicalExam")
     *                     )
     *                 )
     *             }
     *         )
     ...
     *                 @SWG\Schema(ref="#/definitions/common_response_fields"),
     *                 @SWG\Schema(
     *                     @SWG\Property(property="data", ref="#/definitions/TonsilsClinicalExam")
     *                 )
     *             }
     *         )
     *     ),
     ...
     *     @SWG\Parameter(name="mallampati", in="formData", type="string"),
     *     @SWG\Parameter(name="tonsils", in="formData", type="string"),
     *     @SWG\Parameter(name="tonsils_grade", in="formData", type="string"),

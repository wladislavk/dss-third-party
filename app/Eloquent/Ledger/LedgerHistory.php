...
class LedgerHistory extends Model
{
    ...
    {
        $ledgerHistory = DB::table(DB::raw('dental_ledger_history h'))
            ->select(DB::raw("h.updated_at, CONCAT(u.first_name,' ',u.last_name) doc_name, CONCAT(a.first_name,' ',a.last_name) admin_name"))

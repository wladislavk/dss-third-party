...
class AirwayEvaluationsController extends BaseRestController
{
     ...
     *                     property="data",
     *                     type="array",
     *                     @SWG\Items(@SWG\Schema(ref="#/definitions/AirwayEvaluation"))
     *                 )
     *             )
     *         }
     *     ),
    ...
    /**
     * @SWG\Get(
     *     path="/airway-evaluations/{airway_evaluations}",
     ...
     *             @SWG\Schema(ref="#/definitions/common_response_fields"),
     *             @SWG\Schema(
     *                 @SWG\Property(property="data", @SWG\Schema(ref="#/definitions/AirwayEvaluation"))
     *             )
     *         }
     *     ),

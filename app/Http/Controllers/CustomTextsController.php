...
class CustomTextsController extends BaseRestController
{
    /**
     * @SWG\Get(
     *     path="/custom-texts",
     ...
     *                     property="data",
     *                     type="array",
     *                     @SWG\Items(@SWG\Schema(ref="#/definitions/CustomText"))
     *                 )
     *             )
     *         }
     *     ),
    ...
    /**
     * @SWG\Get(
     *     path="/custom-texts/{custom_texts}",
     ...
     *             @SWG\Schema(ref="#/definitions/common_response_fields"),
     *             @SWG\Schema(
     *                 @SWG\Property(property="data", @SWG\Schema(ref="#/definitions/CustomText"))
     *             )
     *         }
     *     ),
     ...
     *     @SWG\Parameter(name="default_text", in="formData", type="integer"),
     *     @SWG\Response(
     *         response="200",

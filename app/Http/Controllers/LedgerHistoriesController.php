...
class LedgerHistoriesController extends BaseRestController
{
     ...
     *                     property="data",
     *                     type="array",
     *                     @SWG\Items(@SWG\Schema(ref="#/definitions/LedgerHistory"))
     *                 )
     *             )
     *         }
     *     ),
    ...
    /**
     * @SWG\Get(
     *     path="/ledger-histories/{ledger_histories}",
     ...
     *             @SWG\Schema(ref="#/definitions/common_response_fields"),
     *             @SWG\Schema(
     *                 @SWG\Property(property="data", @SWG\Schema(ref="#/definitions/LedgerHistory"))
     *             )
     *         }
     *     ),

...
class LetterTemplatesController extends BaseRestController
{
     ...
     *                     property="data",
     *                     type="array",
     *                     @SWG\Items(@SWG\Schema(ref="#/definitions/LetterTemplate"))
     *                 )
     *             )
     *         }
     *     ),
    ...
    /**
     * @SWG\Get(
     *     path="/letter-templates/{letter_templates}",
     ...
     *             @SWG\Schema(ref="#/definitions/common_response_fields"),
     *             @SWG\Schema(
     *                 @SWG\Property(property="data", @SWG\Schema(ref="#/definitions/LetterTemplate"))
     *             )
     *         }
     *     ),

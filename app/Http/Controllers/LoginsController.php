...
class LoginsController extends BaseRestController
{
     ...
     *                     property="data",
     *                     type="array",
     *                     @SWG\Items(@SWG\Schema(ref="#/definitions/Login"))
     *                 )
     *             }
     *         )
     *     ),
     ...
     *             allOf={
     *                 ref="#/definitions/common_response_fields",
     *                 @SWG\Property(property="data", @SWG\Schema(ref="#/definitions/Login"))
     *             }
     *         )
     *     ),
     ...
     *     @SWG\Parameter(name="login_date", in="formData", type="string", format="dateTime"),
     *     @SWG\Parameter(name="logout_date", in="formData", type="string", format="dateTime"),
     *     @SWG\Response(
     *         response="200",

...
class PaymentReportsController extends BaseRestController
{
     ...
     *                     property="data",
     *                     type="array",
     *                     @SWG\Items(@SWG\Schema(ref="#/definitions/PaymentReport"))
     *                 )
     *             )
     *         }
     *     ),
    ...
    /**
     * @SWG\Get(
     *     path="/payment-reports/{payment_reports}",
     ...
     *             @SWG\Schema(ref="#/definitions/common_response_fields"),
     *             @SWG\Schema(
     *                 @SWG\Property(property="data", @SWG\Schema(ref="#/definitions/PaymentReport"))
     *             )
     *         }
     *     ),
     ...
     *     @SWG\Parameter(name="reference_id", in="formData", type="string", required=true),

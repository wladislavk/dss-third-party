...
class UserHstCompaniesController extends BaseRestController
{
    /**
     * @SWG\Get(
     *     path="/user-hst-companies",
     *     @SWG\Response(
     *         response="200",
     ...
     *                         property="data",
     *                         type="array",
     *                         @SWG\Items(ref="#/definitions/UserHstCompany")
     *                     )
     *                 )
     *             }
     *         )
     ...
     *                 @SWG\Schema(ref="#/definitions/common_response_fields"),
     *                 @SWG\Schema(
     *                     @SWG\Property(property="data", ref="#/definitions/UserHstCompany")
     *                 )
     *             }
     *         )
     *     ),

...
class ExternalPatientStore extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'patient.insurance_primary.payer_info.name'     => 'required_with:patient.insurance_primary.payer_info|string',
            ...
            'patient.insurance_primary.insured_info.relationship_to_insured' => 'required_with:patient.insurance_primary.insured_info|string|in:self,spouse,child,other',

            'patient.insurance_primary.insured_info.subscriber.id'          => 'required_with:patient.insurance_primary.insured_info.subscriber|string',
            'patient.insurance_primary.insured_info.subscriber.first_name'  => 'required_with:patient.insurance_primary.insured_info.subscriber|string',
            'patient.insurance_primary.insured_info.subscriber.last_name'   => 'required_with:patient.insurance_primary.insured_info.subscriber|string',
            ...
            'patient.insurance_primary.insured_info.subscriber.dob'         => 'required_with:patient.insurance_primary.insured_info.subscriber|date_format:Y-m-d',
            ...
            'patient.insurance_primary.insured_info.dependent.first_name'  => 'required_with:patient.insurance_primary.insured_info.dependent|string',
            'patient.insurance_primary.insured_info.dependent.last_name'   => 'required_with:patient.insurance_primary.insured_info.dependent|string',
            ...
            'patient.insurance_primary.insured_info.dependent.dob'         => 'required_with:patient.insurance_primary.insured_info.dependent|date_format:Y-m-d',

...
class PatientUpdate extends Request implements RequestWithRulesInterface
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'gender'                  => ['sometimes', 'required', 'regex:/^(?:Male|Female)$/'],
            'marital_status'          => ['regex:/^(?:Married|Un-Married|Single)$/'],
            'ssn'                     => 'sometimes|required|string',
            'internal_patient'        => 'string',
            'home_phone'              => 'sometimes|required|regex:/^[0-9]{10}$/',
            'work_phone'              => 'sometimes|regex:/^[0-9]{10}$/',
            'cell_phone'              => 'sometimes|regex:/^[0-9]{10}$/',

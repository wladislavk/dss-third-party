...
class ApiServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('DentalSleepSolutions\\Interfaces\\Repositories\\ClaimNoteAttachmentInterface',
                        'DentalSleepSolutions\\Repositories\\ClaimNoteAttachmentRepository');
    }
}

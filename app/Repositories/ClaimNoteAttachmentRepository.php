...
{
    /**
     * Main model name for the ClaimNoteAttachment Model
     *
     * @var string
     */
    protected $modelName = ClaimNoteAttachment::class;

    /**
     * Return all claim note attachments
     * 
    ...
    /**
     * Create a new claim note attachment
     * 
     * @param array $data 
     * @return object
     */
    ...
    /**
     * Update a claim note attachment
     * 
     * @param integer $id 
     * @param array $data 
     * @return object

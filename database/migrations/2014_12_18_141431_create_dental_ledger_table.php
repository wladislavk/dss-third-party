...
class CreateDentalLedgerTable extends Migration {
	...
	public function up()
	{
		Schema::create('dental_ledger', function(Blueprint $table)
		{
			...
			$table->integer('secondary_claim_id')->nullable();

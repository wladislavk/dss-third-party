...
<div id="Layer8" style="position:absolute; left:407px; top:0px; width:244px; height:30px; z-index:12">
  
  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=4,0,2,0" width="365" height="33">
    <param name=movie value="images/banner.swf">
    <param name=quality value=high>
    <a href="www.dialworld.com" target="_blank"><embed src="images/banner.swf" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="256" height="39"></a>
    </embed></object>
  </div>

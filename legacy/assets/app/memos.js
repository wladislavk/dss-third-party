    ...
    var memos = new Vue({
                ...
                if (this.fields.memo_id != 0) {
                    this.$http.put(apiPath + this.fields.memo_id, postValues, function(data, status, request) {
                        ...
                        try {
                            ...
                            this.notifyAction('There was an error creating the new memo. Please reload the page and try again.');
                        }
                    });
                } else {
                    this.$http.post(apiPath, postValues, function(data, status, request) {
                        ...
                        try {
                            ...
                            this.notifyAction('There was an error updating this memo. Please reload the page and try again.');
                        }
                    });
                }
                ...
                if (confirm('Delete this Memo - Are you sure?')) {
                    ...
                    this.$http.delete(apiPath + memo.memo_id, function (data, status, request) {
                        ...
                        try {
                            ...
                            this.notifyAction('There was an error deleting this memo. Please reload the page and try again.');
                        }
                    });
                }
        ...
        ready: function() {
            ...
            this.$http.get(apiPath, function (data, status, request) {
                ...
                this.notifyAction('There was an error loading the memo list. Please try again in a few minutes.');
            });
        }
    });

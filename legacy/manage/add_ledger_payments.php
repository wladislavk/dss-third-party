    ...
    <form id="ledgerentryform" name="ledgerentryform" action="insert_ledger_payments.php" onsubmit="return validSubmission(this)" method="POST" enctype="multipart/form-data">
        ...
        <div id="form_div">
            ...
            <div style="background:#FFFFFF none repeat scroll 0 0;height:16px;margin-left:9px;margin-top:20px;width:98%; font-weight:bold;">
                ...
                <span style="margin: 0 10px 0 0; float: left; width:150px;">Amount Allowed</span>
            ...
            foreach ($lq as $row) { ?>
                <div style="height:16px;margin-left:9px;margin-top:20px;width:98%; font-weight:bold;" class="claims">
                    ...
                    <span style="margin: 0 10px 0 0; float: left; width:150px;">
                        <input style="width:140px" readonly class="calendar_top" id="payment_date_<?= $row['ledgerid'] ?>" type="text" name="payments[<?= $row['ledgerid'] ?>][0][payment_date]" value="<?= date('m/d/Y') ?>" />
                    </span>
                    <span style="margin: 0 10px 0 0; float: left; width:150px;">
                        <input style="width:140px" type="text" class="allowed_amount dollar_input" name="payments[<?= $row['ledgerid'] ?>][0][amount_allowed]" />
                    </span>
                    <span style="float:left;font-weight:bold;">
                        <input class="payment_amount dollar_input" style="width:140px;" type="text" name="payments[<?= $row['ledgerid'] ?>][0][amount]" />
                    </span>
                </div>
                <?php
            } ?>

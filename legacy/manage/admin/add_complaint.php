        ...
        <tr>
            <td  colspan="2" align="center">
                ...
                <?php if($themyarray["complaintid"] != '' && $_SESSION['admin_access']==1){ ?>
                    <a href="manage_complaint.php?delid=<?php echo $themyarray["complaintid"];?>" onclick="return confirm('Do Your Really want to Delete?.');" target="_parent" class="editdel btn btn-danger pull-right" title="DELETE">
                        Delete
                    </a>
                <?php } ?>
            </td>

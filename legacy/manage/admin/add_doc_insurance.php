...
<?php }?>
<form name="doc_insurancefrm" action="<?php echo $_SERVER['PHP_SELF'];?>?add=1" method="post" onSubmit="return doc_insuranceabc(this)" enctype="multipart/form-data">
    <table class="table table-bordered table-hover">
        <tr>
            <td colspan="2" class="cat_head">
               <?php echo $but_text?> Insurance Information
               <?php if($title <> "") {?>
                   &quot;<?php echo $title;?>&quot;
               <?php }?>
            </td>
        ...
        <tr>
            <td  colspan="2" align="center">
                ...
                <input type="hidden" name="ed" value="<?php echo $themyarray["doc_insuranceid"]?>" />
                ...
                <?php if($themyarray["doc_insuranceid"] != '' && $_SESSION['admin_access']==1){ ?>
                    <a href="manage_doc_insurance.php?delid=<?php echo $themyarray["doc_insuranceid"];?>" onclick="return confirm('Do Your Really want to Delete?.');" target="_parent" class="editdel btn btn-danger pull-right" title="DELETE">
                        Delete
                    </a>
                <?php } ?>
            </td>

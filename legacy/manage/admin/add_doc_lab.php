...
<form name="doc_labfrm" action="<?php echo $_SERVER['PHP_SELF'];?>?add=1" method="post" onSubmit="return doc_lababc(this)" enctype="multipart/form-data">
    <table class="table table-bordered table-hover">
		...
		<?php if($themyarray["doc_labid"] != '' && $_SESSION['admin_access']==1){ ?>
                    <a href="manage_doc_lab.php?delid=<?php echo $themyarray["doc_labid"];?>" onclick="return confirm('Do Your Really want to Delete?.');" target="_parent" class="editdel btn btn-danger pull-right" title="DELETE">
                        Delete
                    </a>
		<?php } ?>
            </td>

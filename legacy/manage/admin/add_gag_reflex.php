        ...
        <tr>
            <td colspan="2" align="center">
                ...
                <?php if($themyarray["gag_reflexid"] != '' && $_SESSION['admin_access']==1){ ?>
                    <a href="manage_gag_reflex.php?delid=<?php echo $themyarray["gag_reflexid"];?>" onclick="return confirm('Do Your Really want to Delete?.');" target="_parent" class="editdel btn btn-danger pull-right" title="DELETE">
                        Delete
                    </a>
                <?php } ?>
            </td>

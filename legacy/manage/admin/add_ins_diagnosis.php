        ...
        <tr>
            <td colspan="2" align="center">
                ...
                <?php if($themyarray["ins_diagnosisid"] != '' && $_SESSION['admin_access']==1){ ?>
                    <a href="manage_ins_diagnosis.php?delid=<?php echo $themyarray["ins_diagnosisid"];?>" onclick="return confirm('Do Your Really want to Delete?.');" target="_parent" class="editdel btn btn-danger pull-right" title="DELETE">
                        Delete
                    </a>
                <?php } ?>
            </td>

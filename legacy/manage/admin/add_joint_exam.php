        ...
        <tr>
            <td colspan="2" align="center">
                ...
                <?php if($themyarray["joint_examid"] != '' && $_SESSION['admin_access']==1){ ?>
                    <a href="manage_joint_exam.php?delid=<?=$themyarray["joint_examid"];?>" onclick="return confirm('Do Your Really want to Delete?.');" target="_parent" class="editdel btn btn-danger pull-right" title="DELETE">
                        Delete
                    </a>
                <?php } ?>
            </td>

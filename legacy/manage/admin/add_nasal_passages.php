        ...
        <tr>
            <td  colspan="2" align="center">
                ...
                <?php if($themyarray["nasal_passagesid"] != ''  && $_SESSION['admin_access']==1){ ?>
                    <a href="manage_nasal_passages.php?delid=<?php echo $themyarray["nasal_passagesid"];?>" onclick="return confirm('Do Your Really want to Delete?.');" target="_parent" class="editdel btn btn-danger pull-right" title="DELETE">
                        Delete
                    </a>
                <?php } ?>
            </td>

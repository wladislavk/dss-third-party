...
if(!empty($_POST["mult_soft_palatesub"]) && $_POST["mult_soft_palatesub"] == 1)
{
...
if(!empty($_POST["soft_palatesub"]) && $_POST["soft_palatesub"] == 1)
{
...
<?php require_once dirname(__FILE__) . '/includes/popup_top.htm'; ?>
    ...
    <?
    $thesql = "select * from dental_soft_palate where soft_palateid='".(!empty($_REQUEST["ed"]) ? $_REQUEST["ed"] : '')."'";
    ...
    <?php }?>
    <form name="soft_palatefrm" action="<?php echo $_SERVER['PHP_SELF'];?>?add=1" method="post" onSubmit="return soft_palateabc(this)">
    <table class="table table-bordered table-hover">
        <tr>
            <td colspan="2" class="cat_head">
               <?php echo $but_text?> Soft Palate 
               <?php if($soft_palate <> "") {?>
               		&quot;<?php echo $soft_palate;?>&quot;
               <?php }?>
            </td>
        </tr>
        <tr bgcolor="#FFFFFF">
            ...
            <td valign="top" class="frmdata">
                <input type="text" name="soft_palate" value="<?php echo $soft_palate?>" class="form-control" /> 
                <span class="red">*</span>				
            </td>
        </tr>
        <tr bgcolor="#FFFFFF">
        ...
        <tr>
            <td  colspan="2" align="center">
                ...
                <input type="hidden" name="ed" value="<?php echo $themyarray["soft_palateid"]?>" />
                <input type="submit" value="<?php echo $but_text?> Soft Palate" class="btn btn-primary">
		<?php if($themyarray["soft_palateid"] != '' && $_SESSION['admin_access']==1){ ?>
                    <a href="manage_soft_palate.php?delid=<?php echo $themyarray["soft_palateid"];?>" onclick="javascript: return confirm('Do Your Really want to Delete?.');" target="_parent" class="editdel btn btn-danger pull-right" title="DELETE">
                                                Delete
                                        </a>
		<?php } ?>
            </td>
	...
	{?>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tr bgcolor="#FFFFFF">
                <td valign="top" class="frmdata">
                    <textarea class="form-control" name="soft_palate" style="width:100%; height:150px;"></textarea>
                </td>
            </tr>
            <tr>
                <td  colspan="2" align="center">
                    ...
                    <input type="submit" value="Add Multiple Soft Palate" class="btn btn-primary">
                </td>
            </tr>
        </table>
        </form>

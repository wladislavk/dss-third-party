        ...
        <tr>
            <td colspan="2" align="center">
                ...
                <?php if($themyarray["soft_palateid"] != '' && $_SESSION['admin_access']==1){ ?>
                    <a href="manage_soft_palate.php?delid=<?php echo $themyarray["soft_palateid"];?>" onclick="return confirm('Do Your Really want to Delete?.');" target="_parent" class="editdel btn btn-danger pull-right" title="DELETE">
                        Delete
                    </a>
                <?php } ?>
            </td>

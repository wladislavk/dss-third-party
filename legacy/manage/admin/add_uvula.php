        ...
        <tr>
            <td  colspan="2" align="center">
                ...
                <?php if($themyarray["uvulaid"] != '' && $_SESSION['admin_access']==1){ ?>
                    <a href="manage_uvula.php?delid=<?php echo $themyarray["uvulaid"];?>" onclick="return confirm('Do Your Really want to Delete?.');" target="_parent" class="editdel btn btn-danger pull-right" title="DELETE">
                        Delete
                    </a>
                <?php } ?>
            </td>

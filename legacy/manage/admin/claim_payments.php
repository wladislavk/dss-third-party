    ...
    <form id="ledgerentryform" name="ledgerentryform" action="insert_ledger_payments.php" onsubmit="return validSubmission(this)" method="POST" enctype="multipart/form-data">
        ...
        <div id="form_div">
            <div id="select_fields" style="margin: 10px;">
                <label>Paid By</label>
                <select id="payer" class="form-control input-sm input-inline" name="payer" onchange="updateType(this)" style="width:170px;margin: 0 10px 0 0;" >
                ...
                <select id="payment_type" class="form-control input-sm input-inline" name="payment_type" style="width:120px;margin: 0 10px 0 0; " >
            ...
            <div style="background:#FFFFFF none repeat scroll 0 0;height:16px;margin-left:9px;margin-top:20px;width:98%; font-weight:bold;">
                ...
                <span style="margin: 0 10px 0 0; float: left; width:150px;">Payment Date *</span>
            ...
            while($row = mysqli_fetch_assoc($lq)){
                ...
                <div style="height:16px;margin-left:9px;margin-top:20px;width:98%; font-weight:bold;">
                    ...
                    <span style="margin: 0 10px 0 0; float: left; width:150px;">
                        <input style="width:140px" type="text" id="payment_date_<?= $row['ledgerid']; ?>" class="calendar form-control input-sm input-inline" name="payments[<?= $row['ledgerid'] ?>][0][payment_date]" value="<?= date('m/d/Y'); ?>" />
                    </span>
                    <span style="float:left;font-weight:bold;width:150px;">
                        <input class="payment_amount dollar_input form-control input-sm input-inline" style="width:140px;" type="text" name="payments[<?= $row['ledgerid'] ?>][0][amount]" />
                    </span>
                    <span style="float:left;font-weight:bold;">
                        <input class="payment_amount dollar_input form-control input-sm input-inline" style="width:140px;" type="text" name="payments[<?= $row['ledgerid'] ?>][0][amount_allowed]" />
                    </span>
                </div>
                <?php
            } ?>
            <br />
            <input type="checkbox" id="close" name="close" class="form-control input-sm input-inline" onclick=" if(this.checked){ $('#dispute').removeAttr('checked');$('#ins_attach').show('slow');$('#dispute_reason_div').hide('slow'); }else{ $('#ins_attach').hide('slow');$('#dispute_reason_div').hide('slow'); }" value="1" /> <label>Close Claim</label>
            <br />
            <input type="checkbox" id="dispute" name="dispute" class="form-control input-sm input-inline" onclick=" if(this.checked){ $('#close').removeAttr('checked');$('#ins_attach').show('slow');$('#dispute_reason_div').show('slow'); }else{ $('#ins_attach').hide('slow');$('#dispute_reason_div').hide('slow'); }" value='1' /> <label>Dispute</label>

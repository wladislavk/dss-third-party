...
$companyType = $db->escape(DSS_COMPANY_TYPE_HST);
...
$companyDetails = $db->getRow("SELECT name
    ...
    ");
$companyExists = false;
$companyName = '<Invalid HST Company>';
$listUpdated = false;
...
if (isset($_POST['user_sub']) && $companyExists) {
    ...
    $db->query("DELETE FROM dental_user_hst_company
    ...
    if (count($users)) {
        ...
        $db->query("INSERT INTO dental_user_hst_company (userid, companyid)

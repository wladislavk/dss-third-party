    ...
    <table width="600">
        ...
        <tr>
            <td colspan="2">
                ...
                <p>A support ticket has been opened by {{first_name}} {{last_name}}.</p>
                <p>
                    <a href="{{baseUrl}}/manage/admin/view_support_ticket.php?ed={{ticket_id}}">
                        {{baseUrl}}/manage/admin/view_support_ticket.php?ed={{ticket_id}}
                    </a>
                </p>
            </td>
        </tr>

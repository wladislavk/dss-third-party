...
<div class="content">
    ...
    <form name="loginfrm" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>" class="login-form form-horizontal">
        ...
        <div class="form-group">
            <div class="input-icon">
                <i class="fa fa-user"></i>
                <input type="text" class="form-control" name="security_code" id="captcha" autocomplete="off" placeholder="write the characters in the image">
            </div>
        </div>
        ...
        <div class="forget-password">
            ...
            <p>
                no worries, click <a id="forget-password" href="/manage/admin/forgot_password.php">here</a>

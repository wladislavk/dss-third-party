...
while($r = mysqli_fetch_assoc($q)){
    ...
    $in_sql = "INSERT INTO dental_percase_invoice (adminid, docid, adddate, ip_address, monthly_fee_date, monthly_fee_amount) VALUES (".$_SESSION['adminuserid'].", ".$r['userid'].", NOW(), '".$_SERVER['REMOTE_ADDR']."', '".$db->escape(date('Y-m-d', strtotime($monthly_date)))."', '".$db->escape($doc['monthly_fee'])."')";

...
<div align="right">
    <button onclick="loadPopup('add_doc_insurance.php');" class="btn btn-success">
        ...
        <?php
            ...
            while($myarray = mysqli_fetch_array($my)) {
                ...
                <tr class="<?php echo $tr_class;?>">
                    ...
                    <td valign="top">
                        <?php if(is_super($_SESSION['admin_access'])){ ?>
                            <a href="Javascript:;"  onclick="loadPopup('add_doc_insurance.php?ed=<?php echo $myarray["doc_insuranceid"];?>');" title="Edit" class="btn btn-primary btn-sm">
                                Edit

...
<div align="right">
    <button onclick="loadPopup('add_enrollment.php?docid=<?= $_GET['ed']; ?>');" class="btn btn-success">
        Add New Enrollment
            ...
            <tr class="<?=$tr_class;?>">
                ...
                <td valign="top" align="center">
                    ...
                    <?php if($myarray['download_url']){ ?>
                        ...
                        <br />
                        <a class="btn btn-success" href="#" onclick="loadPopup('upload_enrollment.php?id=<?= $myarray['reference_id']; ?>');">Upload</a>
                        <?php
                    }

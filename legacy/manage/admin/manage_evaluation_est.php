...
<div align="right">
	<button onclick="loadPopup('add_evaluation_est.php');" class="btn btn-success">
	...
	else
	{
		...
		?>
			<tr class="<?php echo $tr_class;?>">
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="loadPopup('add_evaluation_est.php?ed=<?php echo $myarray["evaluation_estid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

...
<div align="right">
	<button onclick="loadPopup('add_evaluation_new.php');" class="btn btn-success">
	...
	else
	{
		...
		?>
			<tr class="<?php echo $tr_class;?>">
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="loadPopup('add_evaluation_new.php?ed=<?php echo $myarray["evaluation_newid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

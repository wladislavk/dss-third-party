...
<div align="right">
	<button onclick="loadPopup('add_ins_diagnosis.php');" class="btn btn-success">
	...
	else
	{
		...
		?>
			<tr class="<?php echo $tr_class;?>">
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="loadPopup('add_ins_diagnosis.php?ed=<?php echo $myarray["ins_diagnosisid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

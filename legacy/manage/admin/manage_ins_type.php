...
<div align="right">
	<button onclick="loadPopup('add_ins_type.php');" class="btn btn-success">
	...
	else
	{
		...
		?>
			<tr class="<?=$tr_class;?>">
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="loadPopup('add_ins_type.php?ed=<?=$myarray["ins_typeid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

...
<div align="right">
	<button onclick="loadPopup('add_joint.php');" class="btn btn-success">
		Add New Joint
	...
	else
	{
		...
		?>
			<tr class="<?php echo $tr_class;?>">
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="loadPopup('add_joint.php?ed=<?php echo $myarray["jointid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

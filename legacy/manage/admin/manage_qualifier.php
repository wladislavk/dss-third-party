...
<div align="right">
	<button onclick="loadPopup('add_qualifier.php');" class="btn btn-success">
		Add New Qualifier
	...
	else
	{
		...
		?>
			<tr class="<?=$tr_class;?>">
				...
				<td valign="top">
					<a href="Javascript:;"  onclick="loadPopup('add_qualifier.php?ed=<?=$myarray["qualifierid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit
					 <span class="glyphicon glyphicon-pencil"></span></a>
                    
                    <a href="<?=$_SERVER['PHP_SELF']?>?delid=<?=$myarray["qualifierid"];?>" onclick="return confirm('Do Your Really want to Delete?.');" class="btn btn-danger pull-right" title="DELETE">
						Delete
					</a>
				</td>
			</tr>

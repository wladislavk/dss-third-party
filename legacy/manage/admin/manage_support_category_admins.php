...
if(!empty($_POST["update"])) {
    ...
    foreach($admins as $admin){
        $ins_sql = "INSERT INTO dental_support_category_admin SET category_id='".$db->escape($_REQUEST["catid"])."', adminid='".$db->escape($admin)."', adddate=now(), ip_address='".$db->escape($_SERVER['REMOTE_ADDR'])."'";
...
<div class="page-header">
    <h2>
        Manage Support Category Admins
        <small>

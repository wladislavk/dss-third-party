...
<form class="form-group" name="user-search" action="?" method="get">
    <input class="form-control input-xlarge input-inline" name="search" value="<?= htmlspecialchars($search) ?>" placeholder="Multiple first names, last names or usernames" />
            ...
            <tr class="<?php echo $tr_class;?>">
                ...
                <td valign="top">
                    <?php if(is_super($_SESSION['admin_access']) || is_software($_SESSION['admin_access'])) { ?>
                        <a href="Javascript:;"  onclick="loadPopup('add_users.php?ed=<?php echo $user["userid"];?>');" title="Edit Profile" class="btn btn-primary btn-sm">
                            Edit

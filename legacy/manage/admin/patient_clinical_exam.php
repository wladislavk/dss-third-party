...
$sql = "select * from dental_ex_page4_pivot where patientid='".$_GET['pid']."'";
                    ...
                    <li id="foli8" class="complex">
                        <div>
                            <span style="color:#000000;">
                                ...
                                <button onclick="loadPopupRefer('select_teeth.php?tx=missing&fval='+document.ex_page4frm.missing.value); return false;">Change</button>
                        ...
                        <div>
                            ...
                            while($exam_teeth_myarray = mysqli_fetch_array($exam_teeth_my)) { ?>
                                <input type="checkbox" id="exam_teeth" name="exam_teeth[]" value="<?=st($exam_teeth_myarray['exam_teethid'])?>" <?php if (strpos($exam_teeth, '~'.st($exam_teeth_myarray['exam_teethid']).'~') !== false) { echo " checked";}?> />
                                &nbsp;&nbsp;
                        ...
                        <div>
                            <span style="color:#000000;">
                                ...
                                <button onclick="loadPopupRefer('select_teeth.php?tx=caries&fval='+document.ex_page4frm.caries.value); return false;">Change</button>
                            </span>
                        </div>
                        <br />
                        <div>
                            <span style="color:#000000;">
                                ...
                                <button onclick="loadPopupRefer('select_teeth.php?tx=wear_facets&fval='+document.ex_page4frm.wear_facets.value); return false;">Change</button>
                        ...
                        <div>
                            <span style="color:#000000;">
                                ...
                                <button onclick="loadPopupRefer('select_teeth.php?tx=cracked_fractured&fval='+document.ex_page4frm.cracked_fractured.value); return false;">Change</button>
                            </span>
                        </div>
                        <br />
                        <div>
                            <span style="color:#000000;">
                                ...
                                <button onclick="loadPopupRefer('select_teeth.php?tx=old_worn_inadequate_restorations&fval='+document.ex_page4frm.old_worn_inadequate_restorations.value); return false;">Change</button>
                            </span>
                        </div>
                        <br />
                    </li>
                    ...
                    <li id="foli8" class="complex">
                        ...
                        <div>
                            <span>
                                ...
                                <button onclick="loadPopupRefer('select_teeth_cross.php?tx=crossbite&fval=<?=$crossbite;?>'); return false;">Chart</button>
                            </span>
                        </div>
                        <br />
                        <div>
                            <span>
                                ...
                                <button onclick="loadPopupRefer('select_teeth_cross.php?tx=initial_tooth&fval=<?=$initial_tooth;?>'); return false;">Chart</button>
                        ...
                        <div>
                            <span>
                                ...
                                <button onclick="loadPopupRefer('select_teeth_cross.php?tx=open_proximal&fval=<?=$open_proximal;?>'); return false;">Chart</button>
                        ...
                        <div>
                            <span>
                                ...
                                <button onclick="loadPopupRefer('select_teeth_cross.php?tx=deistema&fval=<?=$deistema;?>'); return false;">Chart</button>
                            </span>
                        </div>
                        <br />
                    </li>

...
$sql = "select * from dental_ex_page2_pivot where patientid='".$_GET['pid']."'";
            ...
            <td valign="top" class="frmhead">
                <ul>
                    <li id="foli8" class="complex">
                        ...
                        <div>
                            <span>
                                <input type="checkbox" id="tonsils" name="tonsils[]" value="Present" <?php if (strpos($tonsils, '~Present~') !== false) { echo " checked";}?> />
                                Present
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="checkbox" id="tonsils" name="tonsils[]" value="Obstructive" <?php if (strpos($tonsils, '~Obstructive~') !== false) { echo " checked";}?> />
                                Obstructive
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="checkbox" id="tonsils" name="tonsils[]" value="Purulent" <?php if (strpos($tonsils, '~Purulent~') !== false) { echo " checked";}?> />
                                Purulent
                            </span>
                        </div>
                        <br />

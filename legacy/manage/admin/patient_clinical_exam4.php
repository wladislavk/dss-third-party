...
$sql = "select * from dental_ex_page3_pivot where patientid='".$_GET['pid']."'";
                        ...
                        <div class="cb_half">
                            <span>
                                ...
                                while ($maxilla_myarray = mysqli_fetch_array($maxilla_my)) { ?>
                                    <input type="checkbox" id="maxilla" name="maxilla[]" value="<?php echo st($maxilla_myarray['maxillaid'])?>" <?php if (strpos($maxilla, '~'.st($maxilla_myarray['maxillaid']).'~') !== false) { echo " checked";}?> />
                                    &nbsp;&nbsp;
                        ...
                        <div class="cb_half">
                            <span>
                                ...
                                while ($mandible_myarray = mysqli_fetch_array($mandible_my)) {?>
                                    <input type="checkbox" id="mandible" name="mandible[]" value="<?php echo st($mandible_myarray['mandibleid'])?>" <?php if (strpos($mandible, '~'.st($mandible_myarray['mandibleid']).'~') !== false) { echo " checked";}?> />
                                    &nbsp;&nbsp;
                        ...
                        <div class="cb_half">
                            <span>
                                ...
                                while ($soft_palate_myarray = mysqli_fetch_array($soft_palate_my)) { ?>
                                    <input type="checkbox" id="soft_palate" name="soft_palate[]" value="<?php echo st($soft_palate_myarray['soft_palateid'])?>" <?php if (strpos($soft_palate, '~'.st($soft_palate_myarray['soft_palateid']).'~') !== false) { echo " checked";}?> />
                                    &nbsp;&nbsp;
                        ...
                        <div class="cb_half">
                            <span>
                                ...
                                while ($uvula_myarray = mysqli_fetch_array($uvula_my)) { ?>
                                    <input type="checkbox" id="uvula" name="uvula[]" value="<?php echo st($uvula_myarray['uvulaid'])?>" <?php if (strpos($uvula, '~'.st($uvula_myarray['uvulaid']).'~') !== false) { echo " checked";}?> />
                                    &nbsp;&nbsp;
                        ...
                        <div class="cb_half">
                            <span>
                                ...
                                while ($gag_reflex_myarray = mysqli_fetch_array($gag_reflex_my)) { ?>
                                    <input type="checkbox" id="gag_reflex" name="gag_reflex[]" value="<?php echo st($gag_reflex_myarray['gag_reflexid'])?>" <?php if (strpos($gag_reflex, '~'.st($gag_reflex_myarray['gag_reflexid']).'~') !== false) { echo " checked";}?> />
                                    &nbsp;&nbsp;
                        ...
                        <div class="cb_half">
                            <span>
                                ...
                                while ($nasal_passages_myarray = mysqli_fetch_array($nasal_passages_my)) { ?>
                                    <input type="checkbox" id="nasal_passages" name="nasal_passages[]" value="<?php echo st($nasal_passages_myarray['nasal_passagesid'])?>" <?php if (strpos($nasal_passages, '~'.st($nasal_passages_myarray['nasal_passagesid']).'~') !== false) { echo " checked";}?> />
                                    &nbsp;&nbsp;

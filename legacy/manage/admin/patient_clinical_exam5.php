...
if (!empty($_POST['ex_page5sub']) && $_POST['ex_page5sub'] == 1) {
    ...
    $initialTitration1For = s_for($_POST['initial_device_titration_1']);
    $initialTitrationHFor = s_for($_POST['initial_device_titration_equal_h']);
    $initialTitrationVFor = s_for($_POST['initial_device_titration_equal_v']);
    $echovisionVFor = s_for($_POST['optimum_echovision_ver']);
    $echovisionHFor = s_for($_POST['optimum_echovision_hor']);
    if ($maxId == 0) {
        $ins_sql = " insert into dental_summary set 
            patientid = '".s_for($_GET['pid'])."',
            initial_device_titration_1 = '$initialTitration1For',
            initial_device_titration_equal_h = '$initialTitrationHFor',
            initial_device_titration_equal_v = '$initialTitrationVFor',
            optimum_echovision_ver = '$echovisionVFor',
            optimum_echovision_hor = '$echovisionHFor',
                ...
                <ul>
                    ...
                    <li id="foli8" class="complex">
                        <label class="desc" id="title0" for="Field0">
                            ...
                            /
                            <button onclick="loadPopupRefer('select_custom_all.php?fr=ex_page5frm&tx=additional_paragraph_pal'); getElementById('popupContact1').style.top = '400px'; return false;">Custom Text</button>
                        </label>
                        <div>
                            <span>
                                        ...
                                        <td valign="top" width="40%">
                                            <span>
                                                ...
                                                while ($joint_exam_myarray = mysqli_fetch_array($joint_exam_my)) { ?>
                                                    <input type="checkbox" id="joint_exam" name="joint_exam[]" value="<?php echo st($joint_exam_myarray['joint_examid'])?>" <?php if (strpos($joint_exam, '~'.st($joint_exam_myarray['joint_examid']).'~') !== false) { echo " checked";}?> style="width:10px;" />
                                                    &nbsp;&nbsp;
                ...
                <ul>
                        ...
                        <div>
                            <span>
                                <table width="100%" cellpadding="3" cellspacing="1">
                                    ...
                                    <tr>
                                        <td>
                                            <span style="padding-left:30px">Horizontal</span></td>
                                        <td>
                    ...
                    <li id="foli8" class="complex">
                        <label class="desc" id="title0" for="Field0">
                            Additional Paragraph
                            /
                            <button onclick="loadPopupRefer('select_custom_all.php?fr=ex_page5frm&tx=additional_paragraph_rm'); return false;">Custom Text</button>
                        </label>
                        <div>
                            <span>

...
<?php
$sql = "select * from dental_q_sleep_pivot where patientid='".$_GET['pid']."'";
...
<div class="box">
    ...
    <br /><br />
    <?php
    if (!empty($complaintid) || !empty($compid) && in_array('0', $compid)) { ?>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;
    <?php echo (!empty($bed_time_partner) ? $bed_time_partner : '') ?><br />
    &nbsp;&nbsp;
    <strong>Same room:</strong>
    &nbsp;&nbsp;&nbsp;&nbsp;
    <?php echo (!empty($sleep_same_room) ? $sleep_same_room : ''); ?><br />
...
<div class="box">
    <?php
    $pat_sql = "select cpap from dental_q_page2_pivot where patientid='".s_for($_GET['pid'])."'";

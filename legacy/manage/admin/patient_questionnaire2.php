...
if ($exist_row['symptoms_status'] == 0 && $exist_row['sleep_status'] == 0 && $exist_row['treatments_status'] == 0 && $exist_row['history_status'] == 0) {
    ...
    <div style="width:700px; margin:30px auto 0 auto;">
        ...
        <a href="q_page2.php?pid=<?= $_GET['pid']; ?>&own=1&addtopat=1">click here</a>.
    </div>
    <?php
    ...
    if ($exist_row['history_status'] == 2 || $exist_row['sleep_status'] == 2 || $exist_row['history_status'] == 2 || $exist_row['history_status'] == 2) {
        ...
        <div style="width:500px; margin:30px auto 0 auto;">
            ...
            <a href="q_page1.php?pid=<?= $_GET['pid']; ?>&own=1&own_completed=1&addtopat=1" onclick="return confirm('I certify that I have reviewed the entire Questionnaire for accuracy.')">CLICK HERE</a> to accept the changes.
        </div>
        <?php
    }
    $sql = "select * from dental_q_page2_pivot where patientid='".$_GET['pid']."'";
                                ...
                                <span>
                                    ...
                                    while ($intolerance_myarray = mysqli_fetch_array($intolerance_my)) { ?>
                                        ...
                                        <?php if ($intolerance != $pat_row['intolerance'] && $showEdits) { ?>
                                            <input type="checkbox" disabled="disabled" <?php if (strpos($pat_row['intolerance'], '~'.st($intolerance_myarray['intoleranceid']).'~') !== false) { echo " checked";}?> />
                                        <?php } ?>
                                        &nbsp;&nbsp;
                                        <?=st($intolerance_myarray['intolerance']);?><br />
                                        <?php
                                    } ?>
                                    <input type="checkbox" id="cpap_other" name="intolerance[]" value="0" <?php if (strpos($intolerance, '~'.st('0~')) !== false) { echo " checked";}?> onclick="chk_cpap_other()" />
                                        <?php if ($intolerance != $pat_row['intolerance'] && $showEdits) { ?>
                                            <input type="checkbox" disabled="disabled" <?php if (strpos($pat_row['intolerance'], '~'.st('0~')) !== false) { echo " checked";}?> />
                                        <?php } ?>
                                    &nbsp;&nbsp; Other<br />
                                </span>
                            </div>
                            ...
                            <div class="s_options">
                                <span>
                                    ...
                                    <table id="surgery_table">
                                        ...
                                        <tr id="surgery_row_<?= $s_count; ?>">
                                            <td>
                                                <input type="hidden" name="surgery_id_<?= $s_count; ?>" value="0" />
                                                <input type="text" id="surgery_date_<?= $s_count; ?>" name="surgery_date_<?= $s_count; ?>" />
                                            </td>

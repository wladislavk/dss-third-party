...
<?php
        $patient_sql = "SELECT * FROM dental_q_page3_view WHERE parent_patientid='".mysqli_real_escape_string($con,$_GET['pid'])."'";
...
<span style="display:block; width:100%; height:20px;">Click any item to add it to the text box below.</span>
    ...
    <!--                            <input id="historycheck" class="history_check_radio" name="historycheck" tabindex="5" type="radio"  <?php if($historycheck == 1){ echo "checked=\"checked\"";} ?> onclick="document.getElementById('h_det').style.display='block'" value="1" /> Yes
                             ...
                             <?php
                                showPatientValue('dental_q_page3_view', $_GET['pid'], 'historycheck', $pat_row['hisorycheck'], $historycheck, true, $showEdits, 'radio');
                            ?>
 --> 
                            </span>
				...
				<li id="foli8" class="complex">	
					...
					<div>
                        <span>
                            ...
                            <?php
                                showPatientValue('dental_q_page3_view', $_GET['pid'], 'year_completed', $pat_row['year_completed'], (!empty($dentures_extra) ? $dentures_extra : ''), true, $showEdits);
                            ?>

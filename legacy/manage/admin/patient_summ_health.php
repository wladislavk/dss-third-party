                ...
                <div id="perio-chart" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="perio-chart" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <iframe src="/manage/missing_teeth_form.php?pid=<?php echo (!empty($_GET['pid']) ? $_GET['pid'] : '')?>&mt=<?php echo $missing ?>" width="100%" height="840"></iframe>
                        </div>
                    </div>
                </div>
            </li>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <?php if ($tonsils != '') { ?>
                <div>
                    <span>
                        <?php if (strpos($tonsils, '~Present~') !== false) { ?>
                            Present
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <?php } ?>
                        <?php if (strpos($tonsils, '~Obstructive~') !== false) { ?>
                            Obstructive
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <?php } ?>
                        <?php if (strpos($tonsils, '~Purulent~') !== false) { ?>
                            Purulent
                        <?php } ?>
                    </span>
                </div>
                ...
                <div>
                    <table class="table table-bordered table-hover">
                        <tr>
                            ...
                            <?php } elseif ($tonsils_grade == 'Grade 1') { ?>
                                <td valign="top" width="20%" align="center">
                            ...
                            <?php } else if ($tonsils_grade == 'Grade 2') { ?>
                                <td valign="top" width="25%" align="center">
                            ...
                            <?php } elseif ($tonsils_grade == 'Grade 3') { ?>
                                <td valign="top" width="25%" align="center">
                            ...
                            <?php } elseif ($tonsils_grade == 'Grade 4') { ?>
                                <td valign="top" width="20%" align="center">

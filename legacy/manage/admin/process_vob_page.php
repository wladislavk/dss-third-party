    ...
    <table class="table table-bordered table-hover">
        ...
        <tr>
            <td colspan="2" align="center">
                ...
                <br />
                <a <?= $disabled ?> href="#" onclick="$('#reject_reason_div').show(); return false;" class="editdel btn btn-warning pull-right" title="REJECT">
                    Reject
                </a>
                <div id="reject_reason_div" <?= ($preauth['status']==DSS_PREAUTH_REJECTED)?'':'style="display:none;"'; ?> >
                    ...
                    <input <?= $disabled ?> type="submit" name="reject_but" onclick="return ($('#reject_reason').val()!='');" value="Submit rejection" class="btn btn-primary">
                    <input <?= $disabled ?> type="button" onclick="$('#reject_reason').val(''); $('#reject_reason_div').hide(); return false;" value="Cancel"  class="btn btn-primary">
                </div>
                <br />

    ...
    foreach ($mdcontacts as $contact) {
        if ($contact != "Not Set") {
            $letter_query = "SELECT md_list 
                FROM dental_letters 
                WHERE md_list IS NOT NULL AND CONCAT(',', md_list, ',') LIKE CONCAT('%,', '".$contact."', ',%') 
...
if (!empty($_POST["patientsub"]) && $_POST["patientsub"] == 1) {
    ...
    if ($_POST["ed"] != "") { //existing patient (update)
        ...
        $ins_sql = "insert into dental_patients set 
        ...
        $flow_pg2_info_query = "INSERT INTO dental_flow_pg2_info 
...
if (isset($msg) && $msg != '') {
    ...
    if ($docsleep) {
        $dsql = "SELECT dc.lastname, dc.firstname, dct.contacttype 
                            ...
                            <span style="float:right">
                                ...
                                if ($num_face == 0) { ?>
                                    ...
                                    foreach ($itype_my as $image) { ?>
                                        <img src="/manage/admin/display_file.php?type=image&f=<?= $image['image_file'] ?>" style="max-height:150px;max-width:200px;float:right;" />
                                        <?php
                                    }
                                } ?>
                            </span>
            ...
            <td valign="top" colspan="2" class="frmhead">
                <ul>
                    <li id="foli8" class="complex">
                        <div>
                            <span>
                                <input id="dob" name="dob" type="text" class="field text addr tbox calendar" value="<?php echo $dob?>" style="width:100px;" maxlength="255" onChange="validateDate('dob');" /><span id="req_0" class="req">*</span>
                    ...
                    <li id="foli8" class="complex">
                        ...
                        <div>
                            <div style="float:left;">
                                ...
                                <input id="copyreqdate" name="copyreqdate" type="text" class="field text addr tbox calendar" value="<?php echo $copyreqdate; ?>"  style="width:100px;" maxlength="255" onChange="validateDate('copyreqdate');" />
                                <label>Date</label>
                            </div>
                            <style type="text/css">
                                #referred_source div {
        ...
        <tr>
            <td valign="top" colspan="2" class="frmhead">
                <ul>
                    <li id="foli8" class="complex">
                        <label class="desc" id="title0" for="Field0">
                            Primary Medical &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DSS filing insurance?
                            <input id="p_m_dss_file_yes" type="radio" name="p_m_dss_file" value="1" <?php if ($p_m_dss_file == '1') echo "checked='checked'";?>>
                            Yes&nbsp;&nbsp;&nbsp;&nbsp;
                            <input  id="p_m_dss_file_no" type="radio" name="p_m_dss_file" value="2" <?php if ($p_m_dss_file == '2') echo "checked='checked'";?>>
                            No
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div>
                            ...
                            <span>
                                <input id="p_m_partyfname" name="p_m_partyfname" type="text" class="field text addr tbox" value="<?php echo $p_m_partyfname?>" maxlength="255" style="width:150px;" />
                                <input id="p_m_partymname" name="p_m_partymname" type="text" class="field text addr tbox" value="<?php echo $p_m_partymname?>" maxlength="255" style="width:50px;" />
                                <input id="p_m_partylname" name="p_m_partylname" type="text" class="field text addr tbox" value="<?php echo $p_m_partylname?>" maxlength="255" style="width:150px;" />
                ...
                <ul>
                    <li id="foli8" class="complex">
                        <div>
                            ...
                            <span>
                                <input id="p_m_ins_ass_yes" type="radio" name="p_m_ins_ass" value="Yes" <?php if ($p_m_ins_ass == 'Yes') { echo " checked='checked'";} ?>>Accept Assignment of Benefits &nbsp;&nbsp;&nbsp;&nbsp;
                                <input id="p_m_ins_ass_no" type="radio" name="p_m_ins_ass" value="No" <?php if ($p_m_ins_ass == 'No') { echo " checked='checked'";} ?>>Payment to Patient
                            </span>
                        </div>
                        <div> </div>
                    </li>
                ...
                <ul>
                    <li id="foli8" class="complex">
                        <div>
                            ...
                            <span>
                                <input id="p_m_ins_grp" name="p_m_ins_grp" type="text" class="field text addr tbox" maxlength="255" style="width:100px;"
                            ...
                            <span>
                                <input id="p_m_ins_plan" name="p_m_ins_plan" type="text" class="field text addr tbox" maxlength="255" style="width:200px;"
                                    <?php if ($p_m_ins_type == '1') { ?>
                ...
                <ul>
                    <li id="foli8" class="complex">
                        ...
                        <label class="desc s_m_ins_div" id="title0" for="Field0"  <?= ($has_s_m_ins != "Yes")?'style="display:none;"':''; ?>>
                            Secondary Medical  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DSS filing insurance?
                            <input id="s_m_dss_file_yes" type="radio" name="s_m_dss_file" value="1" <?php if ($s_m_dss_file == '1') echo "checked='checked'";?>>Yes&nbsp;&nbsp;&nbsp;&nbsp;
                            <input id="s_m_dss_file_no" type="radio" name="s_m_dss_file" value="2" <?php if ($s_m_dss_file == '2') echo "checked='checked'";?>>No
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a onclick="return false" class="plain" title="Select YES if the address you listed in the patient address section is the same address on file with the patient's insurance company. It is uncommon to select NO.">Insured Address same as Pt. address?</a>
                        ...
                        <div class="s_m_ins_div" <?php echo ($has_s_m_ins != "Yes") ? 'style="display:none;"' : ''; ?>>
                            ...
                            <span>
                                <input id="s_m_partyfname" name="s_m_partyfname" type="text" class="field text addr tbox" value="<?php echo $s_m_partyfname?>" maxlength="255" style="width:150px;" />
                                <input id="s_m_partymname" name="s_m_partymname" type="text" class="field text addr tbox" value="<?php echo $s_m_partymname?>" maxlength="255" style="width:50px;" />
                                <input id="s_m_partylname" name="s_m_partylname" type="text" class="field text addr tbox" value="<?php echo $s_m_partylname?>" maxlength="255" style="width:150px;" />
        ...
        <tr>
            <td valign="top">
                ...
                if (empty($result)) { ?>
                    ...
                    echo "DSS Intro Letter Sent to Patient $date_generated";
                } ?>
            </td>
        </tr>
        <tr>

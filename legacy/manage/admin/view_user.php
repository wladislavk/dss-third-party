...
$thesql = "select u.*, c.companyid, l.name mailing_name, l.address mailing_address, l.location mailing_practice, l.city mailing_city, l.state mailing_state, l.zip as mailing_zip, l.email as mailing_email, l.phone as mailing_phone, l.fax as mailing_fax 
    from dental_users u 
...
<div class="col-md-6">
    ...
    <div class="form-group expanded service_field">
        ...
        <div class="col-md-9">
            <input id="service_name" class="tbox form-control" type="text" name="service_name" value="<?php echo $service_name;?>" />
        </div>
    </div>
    <div class="form-group expanded service_field">
        <label for="use_service_npi" class="col-md-3 control-label">Service Address</label>
            <div class="col-md-9">
                <input id="service_address" class="tbox form-control" type="text" name="service_address" value="<?php echo $service_address;?>" />
            </div>
        <div class="clearfix"></div>
    </div>
    <div class="form-group expanded service_field">
        ...
        <div class="col-md-9">
            <input id="service_city" class="tbox form-control" type="text" name="service_city" value="<?php echo $service_city;?>" />
        </div>
    </div>
    <div class="form-group expanded service_field">
        <label for="use_service_npi" class="col-md-3 control-label">Service State</label>
        <div class="col-md-9">
            <input id="service_state" class="tbox form-control" type="text" name="service_state" value="<?php echo $service_state;?>" />
        </div>
    </div>
    <div class="form-group expanded service_field">
        <label for="use_service_npi" class="col-md-3 control-label">Service Zip</label>
        <div class="col-md-9">
            <input id="service_zip" class="tbox form-control" type="text" name="service_zip" value="<?php echo $service_zip;?>" />
        </div>
    </div>
    <div class="form-group expanded service_field">
        <label for="use_service_npi" class="col-md-3 control-label">Service Phone</label>
        <div class="col-md-9">
            <input id="service_phone" class="tbox form-control extphonemask" type="text" name="service_phone" value="<?php echo $service_phone;?>" />
        </div>
    </div>
    <div class="form-group expanded service_field">

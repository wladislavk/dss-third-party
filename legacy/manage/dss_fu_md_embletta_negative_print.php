...
<head>
    ...
    <title><?php echo $sitename;?> | <?php echo $name;?> - DSS FU MD embletta negative</title>
                ...
                <tr>
                    <td valign="top">
                        <p>
                            ...
                            <br>
                            Dear Dr. <strong><?php echo $a_arr[0];?></strong>,<br>
                            <br>
                            We have a mutual patient, <strong><?php echo $name;?></strong>.
                            <strong><?php echo $age;?></strong> year old
                            <strong><?php echo $pat_myarray['gender']?></strong> who was diagnosed with
                            <strong><?php echo $confirmed_diagnosis;?><?php echo $custom_diagnosis;?></strong>
                            after undergoing <strong><?php echo $type_study;?></strong> on
                            <strong><?php echo date('F d, Y', strtotime($sleep_study_on))?></strong>,
                            where he scored an AHI of <strong><?php echo $ahi; ?></strong>
                            <?php if ($rdi != '') { ?>
                                and or RDI of <strong><?php echo $rdi?></strong>
                            <?php } ?>

...
<div align="right">
    <button class="addButton" onclick="window.open('dss_fu_md_embletta_positive_print.php?pid=<?php echo $_GET['pid'];?>','Print_letter','width=800,height=500,scrollbars=1');" >
        Print Letter
    </button>
    &nbsp;&nbsp;&nbsp;&nbsp;
    <button class="addButton" onclick="window.open('dss_fu_md_embletta_positive_word.php?pid=<?php echo $_GET['pid'];?>','word_letter','width=800,height=500,scrollbars=1');" >
        Word Document
    </button>
    &nbsp;&nbsp;&nbsp;&nbsp;
</div>
    ...
    <tr>
        <td valign="top">
            <p>
                ...
                <?php } ?>
                .? <strong>???</strong>, and spent <strong><?php echo $sti_o2_1;?></strong> of the night below 90% O2.  <br /><br />

...
Re: 	<strong><?php $name?></strong> <br>
DOB:	<strong><?php st($pat_myarray['dob'])?></strong><br><br>

Dear Dr. <strong><?php $a_arr[0];?></strong>,<br><br>

I write regarding our mutual Patient, <strong><?php $name;?></strong>.  As you recall, Patient is a <strong><?php $age;?></strong> year old <strong><?php $pat_myarray['gender']?></strong> with a PMH that includes <strong><?php $history_disp;?></strong>.  <strong><?php $h_h;?></strong> medications include <strong><?php $medications_disp?></strong>.  Patient had a <strong>sleep test <?php $type_study;?></strong> done at the <strong><?php $sleeplab_name?></strong> on <strong><?php date('F d, Y',strtotime($sleep_study_on))?></strong> which showed an AHI of <strong><?php $ahi?></strong> <?php if($rdi <> '') {?>, RDI of <strong><?php $rdi?></strong> <?php }?> and low O2 of <strong><?php $sti_o2_1;?></strong>; <strong><?php $s_h;?></strong> was diagnosed with <strong><?php $confirmed_diagnosis;?> <?php $custom_diagnosis;?></strong>.  You referred <strong><?php $h_h1;?></strong> to me for treatment with a dental sleep device.<br><br>

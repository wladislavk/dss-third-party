...
$q1_sql = "select * from dental_q_page1_pivot where patientid='".$_GET['pid']."'";
...
$qs_sql = "select * from dental_q_sleep_pivot where patientid='".$_GET['pid']."'";
...
<span class="admin_head">
    DSS SUMMARY SHEET
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <button onclick="window.open('dss_summary_print.php?pid=<?php echo $_GET['pid']?>','Summary_print','width=800,height=600,scrollbars=1');">
        Print
    </button>
</span>
<br />

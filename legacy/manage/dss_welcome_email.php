...
$franchisee_query = "SELECT name, address, city, state, zip, email FROM dental_users WHERE userid = '".$_SESSION['docid']."';";
...
<form action="/manage/dss_welcome_email.php?pid=<?php echo $patientid?>&lid=<?php echo $letterid?><?php print ($_GET['backoffice'] == 1 ? "&backoffice=".$_GET['backoffice'] : ""); ?>" method="post">

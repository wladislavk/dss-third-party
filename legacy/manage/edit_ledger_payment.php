	...
	<body>
		...
		<form id="ledgerentryform" name="ledgerentryform" action="update_ledger_payment.php" method="POST" onsubmit="validate();">
			<div style="background:#FFFFFF none repeat scroll 0 0;height:16px;margin-left:9px;margin-top:20px;width:98%; font-weight:bold;">
				<span style="margin: 0 10px 0 0; float: left; width:100px;">Payment Date</span>
				<span style="width:100px;margin: 0 10px 0 0; float: left;" >Entry Date</span>
				<span style="width:150px;margin: 0 10px 0 0; float: left;">Paid By</span>
				<span style="margin: 0 10px 0 0; float: left; width: 150px;">Payment Type</span>
			...
			?>
					<div style="margin-left:9px; margin-top: 10px; width:98%;color: #fff;">
						...
						<span style="margin: 0 10px 0 0; float:left;width:150px;">
							<select id="payer_<?php echo  $p['id']; ?>" name="payments[<?= $p['id'] ?>][payer]" style="width:120px;margin: 0 10px 0 0; float: left;">
						...
						<span style="margin: 0 10px 0 0; float:left;width:150px;">
							<select id="payment_type_<?php echo  $p['id']; ?>" name="payments[<?= $p['id'] ?>][payment_type]" style="width:120px;margin: 0 10px 0 0; float: left;">
						...
						<span style="margin: 0 10px 0 0; float:left;">
							<input type="text" class="dollar_input" name="payments[<?= $p['id'] ?>][amount]" value="<?php echo  $p['amount']; ?>" />
						</span>

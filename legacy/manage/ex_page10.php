...
<form class="q_form vue-module" name="ex_page10frm" method="post">
    ...
    <table class="tr_bg table-striped" width="98%" align="center" cellspacing="1" cellpadding="5">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="body_area[first_description]" v-model="bodyAreaFirstDescription"
                       placeholder="Head and Neck" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="body_area[second_description]" v-model="bodyAreaSecondDescription"
                       placeholder="Ear, Nose and Throat" />
            </td>
        </tr>
        <tr>

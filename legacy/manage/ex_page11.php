...
<form class="q_form vue-module" name="ex_page11frm" method="post">
    ...
    <table width="98%" align="center" cellspacing="1" cellpadding="5">
        ...
        <tr>
            <td>
                <div is="transaction-codes-selector" patient-id="<?= $patientId ?>" patient-key="patient_id"
                     code-type="diagnosis"
                    v-bind:selector.sync="form.assessment_codes"></div>
            </td>
            <td>
    ...
    <table width="98%" align="center" cellspacing="1" cellpadding="5">
        ...
        <tr>
            <td>
                <div is="transaction-codes-selector" patient-id="<?= $patientId ?>" patient-key="patient_id"
                     code-type="treatment"
                    v-bind:selector.sync="form.treatment_codes"></div>
            </td>
            <td>

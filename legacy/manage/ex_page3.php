...
$db = new Db();
$baseTable = 'dental_ex_page3_pivot';
$baseSearch = [
    'patientid' => '$patientId',
    'docid' => '$docId',
];
                        ...
                        <li id="foli8" class="complex">
                            ...
                            <div class="cb_half">
                                <span>
                                    ...
                                    foreach ($maxilla_my as $maxilla_myarray) { ?>
                                        <input type="checkbox" id="maxilla<?php echo st($maxilla_myarray['maxillaid'])?>" name="maxilla[]" value="<?php echo st($maxilla_myarray['maxillaid'])?>" <?php if (strpos($maxilla, '~'.st($maxilla_myarray['maxillaid']).'~') !== false) { echo " checked";}?> />
                                        &nbsp;&nbsp;
                            ...
                            <div class="ta_half">
                                <span>
                                    ...
                                    <button onclick="loadPopupRefer('select_custom_all.php?fr=ex_page3frm&tx=other_maxilla'); return false;">Use Custom Text</button>
                                    <br />
                        ...
                        <li id="foli8" class="complex">
                            ...
                            <div class="cb_half">
                                <span>
                                    ...
                                    foreach ($mandible_my as $mandible_myarray) { ?>
                                        <input type="checkbox" id="mandible<?php echo st($mandible_myarray['mandibleid'])?>" name="mandible[]" value="<?php echo st($mandible_myarray['mandibleid'])?>" <?php if (strpos($mandible, '~'.st($mandible_myarray['mandibleid']).'~') !== false) { echo " checked";}?> />
                                        &nbsp;&nbsp;
                            ...
                            <div class="ta_half">
                                <span>
                                    ...
                                    (Enter Each on Different Line)
                                    <button onclick="loadPopupRefer('select_custom_all.php?fr=ex_page3frm&tx=other_mandible'); return false;">Use Custom Text</button>
                                    <br />
                        ...
                        <li id="foli8" class="complex">
                            ...
                            <div class="cb_half">
                                <span>
                                    ...
                                    foreach ($soft_palate_my as $soft_palate_myarray) { ?>
                                        <input type="checkbox" id="soft_palate<?php echo st($soft_palate_myarray['soft_palateid'])?>" name="soft_palate[]" value="<?php echo st($soft_palate_myarray['soft_palateid'])?>" <?php if (strpos($soft_palate, '~'.st($soft_palate_myarray['soft_palateid']).'~') !== false) { echo " checked";}?> />
                                        &nbsp;&nbsp;
                            ...
                            <div class="ta_half">
                                <span>
                                    ...
                                    (Enter Each on Different Line)
                                    <button onclick="loadPopupRefer('select_custom_all.php?fr=ex_page3frm&tx=other_soft_palate'); return false;">Use Custom Text</button>
                                    <br />
                        ...
                        <li id="foli8" class="complex">
                            ...
                            <div class="cb_half">
                                <span>
                                    ...
                                    foreach ($uvula_my as $uvula_myarray) { ?>
                                        <input type="checkbox" id="uvula<?php echo st($uvula_myarray['uvulaid'])?>" name="uvula[]" value="<?php echo st($uvula_myarray['uvulaid'])?>" <?php if (strpos($uvula, '~'.st($uvula_myarray['uvulaid']).'~') !== false) { echo " checked";}?> />
                                        &nbsp;&nbsp;
                            ...
                            <div class="ta_half">
                                <span>
                                    ...
                                    (Enter Each on Different Line)
                                        <button onclick="loadPopupRefer('select_custom_all.php?fr=ex_page3frm&tx=other_uvula'); return false;">Use Custom Text</button>
                                    <br />
                        ...
                        <li id="foli8" class="complex">
                            ...
                            <div class="cb_half">
                                <span>
                                    ...
                                    foreach ($gag_reflex_my as $gag_reflex_myarray) { ?>
                                        <input type="checkbox" id="gag_reflex<?php echo st($gag_reflex_myarray['gag_reflexid'])?>" name="gag_reflex[]" value="<?php echo st($gag_reflex_myarray['gag_reflexid'])?>" <?php if (strpos($gag_reflex, '~'.st($gag_reflex_myarray['gag_reflexid']).'~') !== false) { echo " checked";}?> />
                                        &nbsp;&nbsp;
                            ...
                            <div class="ta_half">
                                <span>
                                    ...
                                    (Enter Each on Different Line)
                                    <button onclick="loadPopupRefer('select_custom_all.php?fr=ex_page3frm&tx=other_gag_reflex'); return false;">Use Custom Text</button>
                                    <br />
                        ...
                        <li id="foli8" class="complex">
                            ...
                            <div class="cb_half">
                                <span>
                                    ...
                                    foreach ($nasal_passages_my as $nasal_passages_myarray) { ?>
                                        <input type="checkbox" id="nasal_passages<?php echo st($nasal_passages_myarray['nasal_passagesid'])?>" name="nasal_passages[]" value="<?php echo st($nasal_passages_myarray['nasal_passagesid'])?>" <?php if (strpos($nasal_passages, '~'.st($nasal_passages_myarray['nasal_passagesid']).'~') !== false) { echo " checked";}?> />
                                        &nbsp;&nbsp;
                            ...
                            <div class="ta_half">
                                <span>
                                    ...
                                    (Enter Each on Different Line)
                                    <button onclick="loadPopupRefer('select_custom_all.php?fr=ex_page3frm&tx=other_nasal_passages'); return false;">Use Custom Text</button>
                                    <br />

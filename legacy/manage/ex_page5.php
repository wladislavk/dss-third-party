...
if (!$isHistoricView && !empty($_POST['ex_page5sub']) && $_POST['ex_page5sub'] == 1) {
    ...
    if ($num == 0) {
        ...
        $dentalSummaryIdRow = $db->getRow($sql);
        $dentalSummaryId = $dentalSummaryIdRow['summaryid'];
        $ed_sql = "update dental_summary set 
            ...
            optimum_echovision_ver = '".s_for($_POST['optimum_echovision_ver'])."',
            optimum_echovision_hor = '".s_for($_POST['optimum_echovision_hor'])."'
            where summaryid = $dentalSummaryId";
        $db->query($ed_sql);
    }
                ...
                <ul>
                    ...
                    <li id="foli8" class="complex">
                        ...
                        <div>
                            <span>
                                <textarea
                                    class="field text addr tbox" style="width:650px; height:100px;"
                                    name="additional_paragraph_pal"
                                    v-model="form.additional_paragraph_pal"
                                ><?= e($additional_paragraph_pal) ?></textarea>
                            </span>
                        </div>
                        <br />
                    </li>
                ...
                <ul>
                    <li id="foli8" class="complex">
                        ...
                        <div>
                            ...
                            <a
                                href="#"
                                class="button form-backup-disable"
                                v-on:click.prevent="setJointSoundsCallback()"
                            >Set all to WNL</a>
                        </div>
                ...
                <ul>
                                ...
                                <td valign="top">
                                    <span>
                                        <input
                                            ...
                                            style="width:50px;"
                                            name="i_opening_from"
                                            v-model="form.i_opening_from"
                                        />mm
                                    </span>
                                </td>
                                <td></td>
                                <td colspan="2" valign="top">
                                    <span>Best eccovision</span>
                                </td>
                            </tr>
                            <tr>
                                <td valign="top">
                                ...
                                <td valign="top">
                                    <input
                                        ...
                                        v-model="eccovisionHorizontal"
                                    />mm
                                </td>
                            </tr>
                            <tr>
                                <td valign="top">
                                    <span>Protrusion total (automatically calculated from above)</span>
                                </td>
                                <td valign="top">
                                    <span>
                                        <input
                                ...
                                <td valign="top">
                                    <span>
                                        <input
                                            ...
                                            style="width:50px;"
                                            name="l_lateral_from"
                                            v-model="form.l_lateral_from"
                                        />mm
                                    </span>
                                </td>
                                <td></td>
                                <td colspan="2" valign="top">
                                    <span>Initial device setting</span>
                                </td>
                            </tr>
                            <tr>
                                <td valign="top">
                                ...
                                <td valign="top">
                                    <span>
                                        <input
                                            ...
                                            style="width:50px;"
                                            name="r_lateral_from"
                                            v-model="form.r_lateral_from"
                                        />mm
                                    </span>
                                </td>
                                <td></td>
                                <td valign="top">
                                    <span style="padding-left:30px">Incisal edge position (George/Pro gauge setting)</span>
                                </td>
                                <td valign="top">
                                    <input
                                        type="text"
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    <input
                                        ...
                                        size="5"
                                        name="optimum_echovision_ver"
                                        v-model="deviceSettingsVertical"
                                    />mm
                                </td>
                            </tr>
                            <tr>
                    ...
                    <li id="foli8" class="complex">
                        <label class="desc" id="title0" for="Field0">
                            Additional paragraph
                            /
                            <button v-on:click.prevent="loadCustomText('additional_paragraph_rm')">Custom text</button>
                        </label>
                        <div>
                            <span>
                                <textarea
                                    ...
                                    v-model="form.additional_paragraph_rm"
                                ><?= e($additional_paragraph_rm) ?></textarea>
                            </span>
                        </div>
                        <br/>
                    </li>

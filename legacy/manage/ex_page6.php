...
$db = new Db();
$baseTable = 'dental_ex_page6_pivot';
$baseSearch = [
    'patientid' => '$patientId',
    'docid' => '$docId',
];
                ...
                <ul>
                    <li id="foli8" class="complex">
                            ...
                            <span class="full">
                                <table width="100%" cellpadding="3" cellspacing="1" >
                                    ...
                                    while ($diagnostic_myarray = mysqli_fetch_array($diagnostic_my)) { ?>
                                        <tr>
                                            <td valign="top">
                                                <input type="checkbox" id="completed" name="completed[]" value="<?=st($diagnostic_myarray['diagnosticid'])?>" <?php if (strpos($completed, '~'.st($diagnostic_myarray['diagnosticid']).'~') !== false) { echo " checked";}?> style="width:10px;" />
                                            </td>
                                            <td valign="top">
                                                <input type="checkbox" id="recommended" name="recommended[]" value="<?=st($diagnostic_myarray['diagnosticid'])?>" <?php if (strpos($recommended, '~'.st($diagnostic_myarray['diagnosticid']).'~') !== false) { echo " checked";}?> style="width:10px;" />
                                            </td>
                                            <td valign="top">
                                                <span>
                        ...
                        <label class="desc" id="title0" for="Field0">
                            ...
                            /
                            <button onclick="loadPopup('select_custom_all.php?fr=ex_page6frm&tx=additional_paragraph'); getElementById('popupContact').style.top = '600px'; return false;">Custom Text</button>
                        </label>
                        <div>
                            <span>

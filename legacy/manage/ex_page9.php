        ...
        <table class="tr_bg table-striped" width="98%" align="center" cellspacing="1" cellpadding="5">
            ...
            <tr class="tr_bg_h">
                <th class="col_head" colspan="4">
                    ...
                    <small>
                        Do you wish to evaluate?
                        <input type="radio" name="cranial_nerve[evaluate]" id="cranial-nerve-evaluate-yes" v-bind:value="1" v-model="form.cranial_nerve.evaluate">
                        <label for="cranial-nerve-evaluate-yes">
                            (Y)
                        </label>
                        <input type="radio" name="cranial_nerve[evaluate]" id="cranial-nerve-evaluate-no" v-bind:value="0" v-model="form.cranial_nerve.evaluate">
            ...
            <tr v-show="form.cranial_nerve.evaluate">
                <td>
                    <input type="checkbox" id="cranial-nerve-olfactory" name="cranial_nerve[olfactory]" v-model="form.cranial_nerve.olfactory" />
                    <label for="cranial-nerve-olfactory">I Olfactory</label>
                </td>
                <td>
                    <input type="checkbox" id="cranial-nerve-optic" name="cranial_nerve[optic]" v-model="form.cranial_nerve.optic" />
                    <label for="cranial-nerve-optic">II Optic</label>
                </td>
                <td>
                    <input type="checkbox" id="cranial-nerve-occulomotor" name="cranial_nerve[occulomotor]" v-model="form.cranial_nerve.occulomotor" />
                    <label for="cranial-nerve-occulomotor">III Occulomotor</label>
                </td>
                <td>
                    <input type="checkbox" id="cranial-nerve-trochlear" name="cranial_nerve[trochlear]" v-model="form.cranial_nerve.trochlear" />
        ...
        <table class="tr_bg table-striped" width="98%" align="center" cellspacing="1" cellpadding="5">
            ...
            <tr class="tr_bg_h">
                <th class="col_head" colspan="3">
                    ...
                    <small>
                        Do you wish to evaluate?
                        <input type="radio" name="occlusal[evaluate]" id="occlusal-evaluate-yes" v-bind:value="1" v-model="form.occlusal.evaluate">
                        <label for="occlusal-evaluate-yes">
                            (Y)
                        </label>
                        <input type="radio" name="occlusal[evaluate]" id="occlusal-evaluate-no" v-bind:value="0" v-model="form.occlusal.evaluate">
            ...
            <tr v-show="form.occlusal.evaluate">
                ...
                <td>
                    <div is="teeth-selector" v-bind:stop-callbacks="<?= $historyId ? 'true' : 'false' ?>" v-bind:selector.sync="form.occlusal.contacts.working.right"></div>
                </td>
            </tr>
            <tr v-show="form.occlusal.evaluate">
                <td>Left working contacts</td>
                <td>
                    <div is="teeth-selector" v-bind:stop-callbacks="<?= $historyId ? 'true' : 'false' ?>" v-bind:selector.sync="form.occlusal.contacts.working.left"></div>
                </td>
            </tr>
            <tr v-show="form.occlusal.evaluate">
                <td>Right non working contacts</td>
                <td>
                    <div is="teeth-selector" v-bind:stop-callbacks="<?= $historyId ? 'true' : 'false' ?>" v-bind:selector.sync="form.occlusal.contacts.non_working.right"></div>
                </td>
            </tr>
            <tr v-show="form.occlusal.evaluate">
                <td>Left non working contacts</td>
                <td>
                    <div is="teeth-selector" v-bind:stop-callbacks="<?= $historyId ? 'true' : 'false' ?>" v-bind:selector.sync="form.occlusal.contacts.non_working.left"></div>
                </td>
            </tr>
            <tr v-show="form.occlusal.evaluate">
                <td>Crossover interferences</td>
                <td>
                    <div is="teeth-selector" v-bind:stop-callbacks="<?= $historyId ? 'true' : 'false' ?>" v-bind:selector.sync="form.occlusal.crossover_interferences"></div>
                </td>
            </tr>
            <tr v-show="form.occlusal.evaluate">

                        ...
                        if ($adminmemo_array['memo'] != NULL || $adminmemo_array['memo'] != '') {
                            ...
                            if ($expiration_date > $today) { ?>
                                ...
                                <table width="260" border="0" align="center" cellpadding="1" cellspacing="1" class="sample">
                                    <tr>
                                        <td valign="top">
                                            <?php echo "". $adminmemo_array['memo'] . "<br />"; ?>
                                        </td>
                                    </tr>
                                </table>
                                <br />
                    ...
                    if($_SESSION['userid'] != '') {
                        ...
                        foreach ($welcome_my as $welcome_myarray) {
                            if (st($welcome_myarray['video_file']) != '') { ?>
                                <center>
                                    <a href="Javascript: ;" class="click" title="Welcome Video" onclick="loadPopup('welcome_detail.php?v_f=<?php echo st($welcome_myarray['video_file'])?>'); getElementById('popupContact').style.top = '200px'; return false;">

...
<div align="right">
    <button onclick="loadPopup('add_chair.php');" class="addButton">
        Add New Resource
    </button>
    &nbsp;&nbsp;
</div>
...
<form name="sortfrm" action="<?php echo $_SERVER['PHP_SELF']?>" method="post">
    <table width="98%" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" align="center">
        ...
        <tr class="<?php echo $tr_class;?>">
            ...
            $r = $db->getRow($sql);
            if($_SESSION['docid']==$_SESSION['userid'] || $r['manage_staff'] == 1){ ?>
                <a href="Javascript:;"  onclick="loadPopup('add_chair.php?ed=<?php echo $myarray["id"];?>');" class="editlink" title="EDIT">
                    Edit
                </a>
            <?php } ?>
            </td>

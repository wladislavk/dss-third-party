...
<div align="right">
    <button onclick="loadPopup('add_custom.php?soap=<?= $isSoapAuthorized ?>');" class="addButton">
                ...
                foreach ($my as $myarray) {
                    ...
                    <tr class="<?php echo $tr_class;?>">
                        ...
                        <td valign="top" width="20%">
                            <a href="Javascript:;"  onclick="loadPopup('add_custom.php?ed=<?php echo $myarray["customid"];?>&soap=<?= $isSoapAuthorized ?>');" class="editlink" title="EDIT">
                                Edit
                            </a>

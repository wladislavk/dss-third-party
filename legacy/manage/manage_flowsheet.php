...
if(isset($_POST["flowsheetsub"]) && $_POST["flowsheetsub"] == 1) {
    ...
    if($_POST['ed'] == '') {
        ...
        if ($getcstep_array) {
            foreach ($getcstep_array as $getcstep){
                $stepq = $getcstep['step'];
                    ...
                    <td valign="top" colspan="2" class="frmhead">
                        <ul>
                            <li id="foli8" class="complex">
                                ...
                                <div>
                                    <span class="left">
                                        <input id="consultation_apt" name="consultation_apt" type="text" class="field text addr tbox" value="<?php echo $consultation_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal12.popup();"/>
                                    ...
                                    <span class="right">
                                        <input id="consultation_comp" name="consultation_comp" type="text" class="field text addr tbox" value="<?php echo $consultation_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal13.popup();" />
                                ...
                                <div>
                                    <span class="left">
                                        <input id="m_insurance_date" name="m_insurance_date" type="text" class="field text addr tbox" value="<?php echo $m_insurance_date?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal73.popup();"/>
                    ...
                    <ul>
                        <li id="foli8" class="complex">
                            <?php if(($sstep >= 5) && $fstep >= 50) { ?>
                                ...
                                <div>
                                    <span class="left">
                                        <input id="exam_impressions_apt" name="exam_impressions_apt" type="text" class="field text addr tbox" value="<?php echo $exam_impressions_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal16.popup();"/>
                                        <a href="javascript:cal16.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
                                        <label for="add1">Appointment Date </label>
                                    </span>
                                    <span class="right">
                                        <input id="exam_impressions_comp" name="exam_impressions_comp" type="text" class="field text addr tbox" value="<?php echo $exam_impressions_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal17.popup();" />
                            ...
                            <?php if(($sstep >= 5) && $fstep >= 51) { ?>
                                ...
                                <div>
                                    <span class="left">
                                        <input id="dsr_prepared" name="dsr_prepared" type="text" class="field text addr tbox" value="<?php echo $dsr_prepared?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal74.popup();"/>
                                    ...
                                    <span class="right">
                                        <input id="dsr_sent" name="dsr_sent" type="text" class="field text addr tbox" value="<?php echo $dsr_sent?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal75.popup();" />
                            ...
                            <?php if(($sstep >= 5) && $fstep >= 52) { ?>
                                ...
                                <div>
                                    <span class="left">
                                        <input id="delivery_device_apt" name="delivery_device_apt" type="text" class="field text addr tbox" value="<?php echo $delivery_device_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal22.popup();"/>
                                        <a href="javascript:cal22.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
                                        <label for="add1">Appointment Date </label>
                                    </span>
                                    <span class="right">
                                        <input id="delivery_device_comp" name="delivery_device_comp" type="text" class="field text addr tbox" value="<?php echo $delivery_device_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal23.popup();" />
                                ...
                                <div>
                                    <span class="left">
                                        <input id="dsr_date_delivered" name="dsr_date_delivered" type="text" class="field text addr tbox" value="<?php echo $dsr_date_delivered?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal76.popup();"/>
                                ...
                                <div>
                                    <span class="left">
                                        <input id="ltr_phy_prepared" name="ltr_phy_prepared" type="text" class="field text addr tbox" value="<?php echo $ltr_phy_prepared?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal77.popup();"/>
                                    ...
                                    <span class="right">
                                        <input id="ltr_phy_sent" name="ltr_phy_sent" type="text" class="field text addr tbox" value="<?php echo $ltr_phy_sent?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal78.popup();" />
                            ...
                            <?php if(($sstep >= 5) && $fstep >= 53) { ?>
                                ...
                                <div>
                                    <span class="left">
                                        <input id="first_check_apt" name="first_check_apt" type="text" class="field text addr tbox" value="<?php echo $first_check_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal28.popup();"/>
                                        <a href="javascript:cal28.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
                                        <label for="add1">Appointment Date </label>
                                    </span>
                                    <span class="right">
                                        <input id="first_check_comp" name="first_check_comp" type="text" class="field text addr tbox" value="<?php echo $first_check_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal29.popup();" />
                            ...
                            <?php if(($sstep >= 5) && $fstep >= 54) { ?>
                                ...
                                <div>
                                    <span class="left">
                                        <input id="add_check_apt" name="add_check_apt" type="text" class="field text addr tbox" value="<?php echo $add_check_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal30.popup();"/>
                                        <a href="javascript:cal30.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
                                        <label for="add1">Appointment Date </label>
                                    </span>
                                    <span class="right">
                                        <input id="add_check_comp" name="add_check_comp" type="text" class="field text addr tbox" value="<?php echo $add_check_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal31.popup();" />
                                        <a href="javascript:cal30.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
                                        <label for="add2">Completed Date</label>
                                    </span>
                            ...
                            <?php if(($sstep >= 5) && $fstep >= 55) { ?>
                                ...
                                <div>
                                    <span class="left">
                                        <input id="home_sleep_apt" name="home_sleep_apt" type="text" class="field text addr tbox" value="<?php echo $home_sleep_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal32.popup();"/>
                                        <a href="javascript:cal32.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
                                        <label for="add1">Appointment Date </label>
                                    </span>
                                    <span class="right">
                                        <input id="home_sleep_comp" name="home_sleep_comp" type="text" class="field text addr tbox" value="<?php echo $home_sleep_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal33.popup();" />
                            ...
                            <?php if(($sstep >= 5) && $fstep >= 56){?>
                                ...
                                <div>
                                    <span class="left">
                                        <input id="further_checks_apt" name="further_checks_apt" type="text" class="field text addr tbox" value="<?php echo $further_checks_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal34.popup();"/>
                                        <a href="javascript:cal34.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
                                        <label for="add1">Appointment Date </label>
                                    </span>
                                    <span class="right">
                                        <input id="further_checks_comp" name="further_checks_comp" type="text" class="field text addr tbox" value="<?php echo $further_checks_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal35.popup();" />
                            ...
                            <?php if(($sstep >= 5) && $fstep >= 57) { ?>
                                ...
                                <div>
                                    <span class="left">
                                        <input id="comp_treatment_date" name="comp_treatment_date" type="text" class="field text addr tbox" value="<?php echo $comp_treatment_date?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal79.popup();"/>
                            ...
                            <?php if(($sstep >= 5) && $fstep >= 58) { ?>
                                ...
                                <div>
                                    <span class="left">
                                        <input id="ltr_doc_ss_date_prepared" name="ltr_doc_ss_date_prepared" type="text" class="field text addr tbox" value="<?php echo $ltr_doc_ss_date_prepared?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal81.popup();"/>
                                    ...
                                    <span class="right">
                                        <input id="ltr_doc_ss_date_sent" name="ltr_doc_ss_date_sent" type="text" class="field text addr tbox" value="<?php echo $ltr_doc_ss_date_sent?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal82.popup();" />
                            ...
                            <?php if(($sstep >= 5) && $fstep >= 59) { ?>
                                ...
                                <div>
                                    <span class="left">
                                        <input id="annual_exam_apt" name="annual_exam_apt" type="text" class="field text addr tbox" value="<?php echo $annual_exam_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal40.popup();"/>
                                        <a href="javascript:cal40.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
                                        <label for="add1">Appointment Date </label>
                                    </span>
                                    <span class="right">
                                        <input id="annual_exam_comp" name="annual_exam_comp" type="text" class="field text addr tbox" value="<?php echo $annual_exam_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal41.popup();" />
                                ...
                                <div>
                                    <span class="left">
                                        <input id="ltr_doc_pt_date_prepared" name="ltr_doc_pt_date_prepared" type="text" class="field text addr tbox" value="<?php echo $ltr_doc_pt_date_prepared?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal87.popup();"/>
                                        <a href="javascript:cal87.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
                                        <label for="add1">Date prepared </label>
                                    </span>
                                    <span class="right">
                                        <input id="ltr_doc_pt_date_sent" name="ltr_doc_pt_date_sent" type="text" class="field text addr tbox" value="<?php echo $ltr_doc_pt_date_sent?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal88.popup();" />
                ...
                <td valign="top" colspan="2" class="frmhead">
                    <ul>
                        <li id="foli8" class="complex">
                            ...
                            <div>
                                <span class="left">
                                    <input id="ambulatory_ss_apt" name="ambulatory_ss_apt" type="text" class="field text addr tbox" value="<?php echo $ambulatory_ss_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal46.popup();"/>
                                    <a href="javascript:cal46.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
                                    <label for="add1">Appointment Date </label>
                                </span>
                                <span class="right">
                                    <input id="ambulatory_ss_comp" name="ambulatory_ss_comp" type="text" class="field text addr tbox" value="<?php echo $ambulatory_ss_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal47.popup();" />
                            ...
                            <div>
                                <span class="left">
                                    <input id="diag_s_md_sent" name="diag_s_md_sent" type="text" class="field text addr tbox" value="<?php echo $diag_s_md_sent?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal83.popup();"/>
                                ...
                                <span class="right">
                                    <input id="diag_s_md_received" name="diag_s_md_received" type="text" class="field text addr tbox" value="<?php echo $diag_s_md_received?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal84.popup();" />
                ...
                <td valign="top" colspan="2" class="frmhead">
                    <ul>
                        <li id="foli8" class="complex">
                            ...
                            <div>
                                <span class="left">
                                    <input id="psg_apt" name="psg_apt" type="text" class="field text addr tbox" value="<?php echo $psg_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal50.popup();"/>
                                    <a href="javascript:cal50.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
                                    <label for="add1">Appointment Date </label>
                                </span>
                                <span class="right">
                                    <input id="psg_comp" name="psg_comp" type="text" class="field text addr tbox" value="<?php echo $psg_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal51.popup();" />
                ...
                <td valign="top" colspan="2" class="frmhead">
                    <ul>
                        <li id="foli8" class="complex">
                            ...
                            <div>
                                <span class="left">
                                    <input id="ltr_pp_date_prepared" name="ltr_pp_date_prepared" type="text" class="field text addr tbox" value="<?php echo $ltr_pp_date_prepared?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal85.popup();"/>
                                    <a href="javascript:cal85.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
                                    <label for="add1">Date prepared</label>
                                </span>
                                <span class="right">
                                    <input id="ltr_pp_date_sent" name="ltr_pp_date_sent" type="text" class="field text addr tbox" value="<?php echo $ltr_pp_date_sent?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal86.popup();" />
                ...
                <tr>
                    <td valign="top" colspan="2" class="frmhead">
                        <ul>
                            <li id="foli8" class="complex">
                                <label class="desc" id="title0" for="Field0">
                                    <?php if($fstep == 4){echo "<span style=\"color:#FF0000;\">";} ?>Referral to DSS Dentist<?php if($fstep == 4){echo "</span>";} ?>
                                </label>
                                <div>
                                    <span class="left">
                                        <input id="date_referred" name="date_referred" type="text" class="field text addr tbox" value="<?php echo $date_referred?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal72.popup();"/>
                ...
                <tr>
                    <td valign="top" colspan="2" class="frmhead">
                        <ul>
                            <li id="foli8" class="complex">
                                <label class="desc" id="title0" for="Field0">
                                    <?php if($fstep == 1){echo "<span style=\"color:#FF0000;\">";} ?>Send NP Forms<?php if($fstep == 1){echo "</span>";} ?>
                                </label>
                                <div>
                                    <span class="left">
                                    ...
                                    <span class="right">
                                        <input id="send_np_comp" name="send_np_comp" type="text" class="field text addr tbox" value="<?php echo $send_np_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal3.popup();" />
            ...
            <tr>
                <td valign="top" colspan="2" class="frmhead">
                    <ul>
                        <li id="foli8" class="complex">
                            <label class="desc" id="title0" for="Field0">
                                <?php if($fstep == 0){echo "<span style=\"color:#FF0000;\">";} ?>Inquiry Call<?php if($fstep == 0){echo "</span>";} ?>
                            </label>
                            <div>
                                <span class="left">
                                    <input id="inquiry_call_comp" name="inquiry_call_comp" type="text" class="field text addr tbox" value="<?php echo $inquiry_call_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="cal1.popup();" />

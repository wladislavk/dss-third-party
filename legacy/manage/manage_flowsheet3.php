...
$trackerNotes = $db->getColumn("
        SELECT tracker_notes
    ...
    <div id="treatment_list" <?= ($sched_appt) ? 'class="current_step"' : ''; ?>>
        ...
        <ul class="treatment sect2">
            ...
            foreach ($step_q as $step) {
                ...
                <li class="<?= $class; ?>">
                    <a id="completed_<?= $step['id']; ?>" class="completed_today"><?= $step['name']; ?></a>
                </li>
                <?php
            } ?>
        </ul>

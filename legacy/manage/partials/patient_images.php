        ...
        if ($my) {
            foreach ($my as $myarray) {
                ...
                <tr class="<?php echo $tr_class;?>">
                    ...
                    <?php if($office_type == DSS_OFFICE_TYPE_FRONT) { ?>
                        <td valign="top">
                            <a href="Javascript:;"  onclick="loadPopupRefer('add_image.php?ed=<?php echo $myarray["imageid"];?>&pid=<?php echo (!empty($_GET['pid']) ? $_GET['pid'] : '');?>&sh=<?= $myarray['imagetypeid'] ?>');" class="editlink btn btn-primary btn-sm" title="EDIT">
                                Edit

...
<p></p>
<div id="pain-tmd">
<form class="q_form vue-module" name="q_page5frm" method="post">
    ...
    <table class="tr_bg table-striped" width="98%" align="center" cellspacing="1" cellpadding="5">
        ...
        <tr>
            ...
            <td>
                ...
                <button v-on:click.prevent="loadCustomText('description.chief_complaint')">Use custom text</button>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <button v-on:click.prevent="loadCustomText('description.treatment_goals')">Use custom text</button>
            </td>
        </tr>
    </table>
    <p></p>
    <table class="tr_bg table-striped" width="98%" align="center" cellspacing="1" cellpadding="5">
        ...
        <tr>
            <td>
                ...
                <p>
                    <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;Please describe when the pain started, how long ago, and if you think you did something to initiate the pain and whether the onset was gradual or chronic.
                    <span class="info_but" title="Example: &quot;the pain started 2 months ago when I was hit in the jaw playing basketball&quot;"></span>
                </p>
            </td>
            <td>
                <textarea name="symptom_review[onset_of_event]" v-model="form.symptom_review.onset_of_event"></textarea>
                <button v-on:click.prevent="loadCustomText('symptom_review.onset_of_event')">Use custom text</button>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <p>
                    <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;Please describe whether any movement, rest, clenching the teeth, chewing, pressure (such as palpation) or other external factors make the problem better or worse.
                    <span class="info_but" title="Example: &quot;opening my mouth wide and chewing hard foods makes the pain worse. A soft diet and taking Advil makes it feel better&quot;"></span>
                </p>
            </td>
            <td>
                <textarea name="symptom_review[provocation]" v-model="form.symptom_review.provocation"></textarea>
                <button v-on:click.prevent="loadCustomText('symptom_review.provocation')">Use custom text</button>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <p>
                    <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;Please describe the quality and type of pain (sharp, dull, ache, electrical, throbbing, stabbing, etc) including if it varies from one type of pain to another.
                    <span class="info_but" title="Example: &quot;the pain is usually a dull ache, but when I open wide it is sharp&quot;"></span>
                </p>
            </td>
            <td>
                <textarea name="symptom_review[quality_of_pain]" v-model="form.symptom_review.quality_of_pain"></textarea>
                <button v-on:click.prevent="loadCustomText('symptom_review.quality_of_pain')">Use custom text</button>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <p>
                    <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;Please describe where the pain is the worst and whether it radiates or moves to any other area.
                    <span class="info_but" title="Example: &quot;my pain is the worst on the left in front of my ear and extends up the side of my head&quot;"></span>
                </p>
            </td>
            <td>
                <textarea name="symptom_review[region_and_radiation]" v-model="form.symptom_review.region_and_radiation"></textarea>
                <button v-on:click.prevent="loadCustomText('symptom_review.region_and_radiation')">Use custom text</button>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <p>
                    <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;Please describe the average pain severity on a 0 to 10 scale with 10 being the worst pain you can imagine. Also please describe the severity of the pain when it is worst and best.
                    <span class="info_but" title="Example: &quot;on average the pain is a 4. At its worst it's a 6 and at its best is a 0, as sometimes it does not hurt&quot;"></span>
                </p>
            </td>
            <td>
                <textarea name="symptom_review[severity]" v-model="form.symptom_review.severity"></textarea>
                <button v-on:click.prevent="loadCustomText('symptom_review.severity')">Use custom text</button>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <p>
                    <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;Please describe if there is a timing component to the pain, or if the pain is worse at any specific time of day, or with a specific activity.
                    <span class="info_but" title="Example: &quot;my jaw hurst the most when I wake up and seems to get better as the day goes on&quot;"></span>
                </p>
            </td>
            <td>
                <textarea name="symptom_review[time]" v-model="form.symptom_review.time"></textarea>
                <button v-on:click.prevent="loadCustomText('symptom_review.time')">Use custom text</button>
            </td>
        </tr>
    </table>
    <p></p>
    ...
    <table class="tr_bg table-striped" width="98%" align="center" cellspacing="1" cellpadding="5" v-show="form.headaches.checked==1">
        ...
        <tr>
            ...
            <td rowspan="2">
                ...
                <button v-on:click.prevent="loadCustomText('headaches.symptoms.other.details')">Use custom text</button>
            </td>
        </tr>
        <tr>
            <td>

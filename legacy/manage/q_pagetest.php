...
$sql = "select * from dental_q_page1_pivot where patientid='".$_GET['pid']."'";
                        ...
                        <div>
                            ...
                            <span>
                                <select name="inches" id="inches" class="field text addr tbox" style="width:100px;" tabindex="6" onchange="cal_bmi();">
                                    ...
                                    <?php for ($i = 1; $i < 12; $i++) { ?>
                                        <option value="<?=$i?>" <?php if ($inches == $i) echo " selected";?>><?=$i?></option>
                                    <?php } ?>
                                </select>
                                ...
                                <span>
                                    <select id="complaint_<?=st($complaint_myarray['complaintid']);?>" name="complaint_<?=st($complaint_myarray['complaintid']);?>" class="field text addr tbox" style="width:50px;" onchange="chk_chief(this.value, <?=st($complaint_myarray['complaintid']);?>)">
                                        ...
                                        for ($i = 1; $i <= $complaint_number; $i++) { ?>
                                            <option value="<?=$i;?>" <?php if ($chk == $i) echo " selected";?>><?=$i;?></option>
                                        <? } ?>
                                    </select>
                                    &nbsp;&nbsp;
                ...
                <ul>
                    <li id="foli8" class="complex">
                        <label class="desc" id="title0" for="Field0">
                            ...
                            /
                            <button onclick="loadPopup1('select_custom.php'); return false;">Custom Text</button>
                        </label>
                        <div>
                            <span>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <select name="energy_level" class="field text addr tbox" style="width:150px;">
                                                <option value=""></option>
                                                <?php for ($i = 1; $i < 11; $i++) { ?>
                                                    <option value="<?=$i;?>" <?php if ($energy_level == $i) echo " selected";?>><?=$i;?></option>
                                                <?php } ?>
                                            </select>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <select name="snoring_sound" class="field text addr tbox" style="width:150px;">
                                                <option value=""></option>
                                                <?php for ($i = 1; $i < 11; $i++) { ?>
                                                    <option value="<?=$i;?>" <?php if ($snoring_sound == $i) echo " selected";?>><?=$i;?></option>
                                                <?php } ?>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <select name="wake_night" class="field text addr tbox" style="width:150px;">
                                                <option value=""></option>
                                                <?php for ($i = 1; $i < 11; $i++) { ?>
                                                    <option value="<?=$i;?>" <?php if ($wake_night == $i) echo " selected";?>><?=$i;?></option>
                                                <?php } ?>
                                            </select>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <select name="sleep_qual" class="field text addr tbox" style="width:150px;">
                                                <option value=""></option>
                                                <?php for ($i = 1; $i < 11; $i++) { ?>
                                                    <option value="<?=$i;?>" <?php if ($sleep_qual == $i) echo " selected";?>><?=$i;?></option>
                                                <?php } ?>
                                            </select>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td valign="top">
                                            <select name="main_reason[]" class="field text addr tbox" style="width:350px;" size="7">
                                                <option value="snoring" <?php if (strpos($main_reason, '~snoring~') !== false) { echo " selected";}?> >
                                                    snoring
                                                </option>
                                                <option value="excessive daytime sleepiness" <?php if (strpos($main_reason, '~excessive daytime sleepiness~') !== false) { echo " selected";}?> >
                                                    excessive daytime sleepiness
                                                </option>
                                                <option value="fatigue" <?php if (strpos($main_reason, '~fatigue~') !== false) { echo " selected";}?> >
                                                    fatigue
                                                </option>
                                                <option value="witness apneas" <?php if (strpos($main_reason, '~witness apneas~') !== false) { echo " selected";}?> >
                                                    witness apneas
                                                </option>
                                                <option value="headaches" <?php if (strpos($main_reason, '~headaches~') !== false) { echo " selected";}?> >
                                                    headaches
                                                </option>
                                                <option value="had sleep study due to medical reasons" <?php if (strpos($main_reason, '~had sleep study due to medical reasons~') !== false) { echo " selected";}?> >

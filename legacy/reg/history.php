...
if ($comp['history'] == 0) {
    ...
    $sql = "select * from dental_q_page3_pivot where patientid='".$_SESSION['pid']."' ";
        ...
        <div class="formEl_a">
                ...
                <span id="all_det" <?php if ($allergenscheck == 0) { echo 'style="display:none;"';} ?>>
                    ...
                    while ($allergens_myarray = mysqli_fetch_array($allergens_my)) { ?>
                        <span style="width:32%; float:left; display:block;">
                            <input type="checkbox" name="allergens[]" value="<?=st($allergens_myarray['allergensid']);?>" class="tbox" style="width:10px;" <?php if (strpos($allergens, '~'.st($allergens_myarray['allergensid']).'~') !== false) { echo " checked";}?> />
            ...
            <div class="sepH_b">
                ...
                <span id="med_det" <?php if ($medicationscheck == 0) { echo 'style="display:none;"';} ?>>
                    ...
                    while ($medications_myarray = mysqli_fetch_array($medications_my)) { ?>
                        <span style="width:32%; float:left; display:block;">
                            <input type="checkbox" name="medications[]" value="<?=st($medications_myarray['medicationsid']);?>" class="tbox" style="width:10px;" <?php if (strpos($medications, '~'.st($medications_myarray['medicationsid']).'~') !== false) { echo " checked";}?> />
            ...
            <div class="sepH_b">
                ...
                while ($history_myarray = mysqli_fetch_array($history_my)) {
                    ?>
                    <span style="width:32%; float:left; display:block;">
                        <input type="checkbox" name="history[]" value="<?=st($history_myarray['historyid']);?>" class="tbox" style="width:10px;" <?php if (strpos($history, '~'.st($history_myarray['historyid']).'~') !== false) { echo " checked";}?> />
            ...
            <div class="sepH_b half">
                ...
                <input type="radio" class="extra" name="wisdom_extraction" value="Yes" <?php if ($wisdom_extraction == 'Yes') echo " checked";?> /> Yes
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" class="extra" name="wisdom_extraction" value="No" <?php if ($wisdom_extraction == 'No') echo " checked";?> /> No
            ...
            <div class="sepH_b clear half">
                ...
                <input type="radio" class="extra" name="removable" value="Yes" <?php if ($removable == 'Yes') echo " checked";?> /> Yes
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" class="extra" name="removable" value="No" <?php if ($removable == 'No') echo " checked";?> /> No
            ...
            <div class="sepH_b half">
                ...
                <input type="radio" class="extra" name="dentures" value="Yes" <?php if ($dentures == 'Yes') echo " checked";?> /> Yes
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" class="extra" name="dentures" value="No" <?php if ($dentures == 'No') echo " checked";?> /> No
            ...
            <div class="sepH_b  clear half">
                ...
                <input type="radio" class="extra" name="orthodontics" value="Yes" <?php if ($orthodontics == 'Yes') echo " checked";?>  onclick="chk_ortho()"  /> Yes
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" class="extra" name="orthodontics" value="No" <?php if ($orthodontics == 'No') echo " checked";?>  onclick="chk_ortho()" /> No
                <span id="orthodontics_extra">
                    <label class="lbl_in2">Year completed:</label>
                    <input id="year_completed" name="year_completed" type="text" class="inpt_in2" value="<?=$year_completed;?>" maxlength="255" />
                </span>
            </div>
            <div class="sepH_b half">
                <label class="lbl_in2">Does your TMJ (jaw joint) click or pop?</label>
                <input type="radio" class="extra" name="tmj_cp" value="Yes" <?php if ($tmj_cp == 'Yes') echo " checked";?> /> Yes
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" class="extra" name="tmj_cp" value="No" <?php if ($tmj_cp == 'No') echo " checked";?> /> No
            ...
            <div class="sepH_b clear half">
                ...
                <input type="radio" class="extra" name="tmj_pain" value="Yes" <?php if ($tmj_pain == 'Yes') echo " checked";?> /> Yes
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" class="extra" name="tmj_pain" value="No" <?php if ($tmj_pain == 'No') echo " checked";?> /> No
            ...
            <div class="sepH_b clear half">
                ...
                <input type="radio" class="extra" name="injury" value="Yes" <?php if ($injury == 'Yes') echo " checked";?> /> Yes
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" class="extra" name="injury" value="No" <?php if ($injury == 'No') echo " checked";?> /> No
            ...
            <div class="sepH_b half">
                ...
                <input type="radio" class="extra" name="drymouth" value="Yes" <?php if ($drymouth == 'Yes') echo " checked";?> /> Yes
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" class="extra" name="drymouth" value="No" <?php if ($drymouth == 'No') echo " checked";?> /> No
            ...
            <div class="sepH_b half">
                ...
                <input type="radio" class="extra" name="gum_surgery" value="Yes" <?php if ($gum_surgery == 'Yes') echo " checked";?> /> Yes
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" class="extra" name="gum_surgery" value="No" <?php if ($gum_surgery == 'No') echo " checked";?> /> No
            ...
            <div class="sepH_b clear half">
                ...
                <input type="radio" class="extra" name="completed_future" value="Yes" <?php if ($completed_future == 'Yes') echo " checked";?> /> Yes
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" class="extra" name="completed_future" value="No" <?php if ($completed_future == 'No') echo " checked";?> /> No
            ...
            <div class="sepH_b half">
                ...
                <input type="radio" class="extra" name="clinch_grind" value="Yes" <?php if ($clinch_grind == 'Yes') echo " checked";?> /> Yes
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" class="extra" name="clinch_grind" value="No" <?php if ($clinch_grind == 'No') echo " checked";?> /> No
            ...
            <div class="sepH_b">
                ...
                <input type="radio" name="alcohol" value="Daily" class="tbox" <?php if ($alcohol == 'Daily') echo " checked";?> />
                Daily
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="alcohol" value="occasionally" class="tbox" <?php if ($alcohol == 'occasionally') echo " checked";?> />
                Occasionally
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="alcohol" value="never" class="tbox" <?php if ($alcohol == 'never') echo " checked";?> />
                Never
            </div>
            <div class="sepH_b">
                <label class="lbl_a">Sedative Consumption: How often do you take sedatives within 2-3 hours of bedtime?</label>
                <input type="radio" name="sedative" value="Daily" class="tbox" <?php if ($sedative == 'Daily') echo " checked";?> />
                Daily
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="sedative" value="occasionally" class="tbox" <?php if ($sedative == 'occasionally') echo " checked";?> />
                Occasionally
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="sedative" value="never" class="tbox" <?php if ($sedative == 'never') echo " checked";?> />
                Never
            </div>
            <div class="sepH_b">
                <label class="lbl_a">Caffeine consumption: How often do you consume caffeine within 2-3 hours of bedtime?</label>
                <input type="radio" name="caffeine" value="Daily" class="tbox" <?php if ($caffeine == 'Daily') echo " checked";?> />
                Daily
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="caffeine" value="occasionally" class="tbox" <?php if ($caffeine == 'occasionally') echo " checked";?> />
                Occasionally
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="caffeine" value="never" class="tbox" <?php if ($caffeine == 'never') echo " checked";?> />
                Never
            </div>
            <div class="sepH_b">
                <label class="lbl_a">Do you Smoke?</label>
                <input type="radio" name="smoke" value="Yes" class="tbox" <?php if ($smoke == 'Yes') echo " checked";?> onclick="$('#smoke').show();" />
                Yes
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="smoke" value="No" class="tbox" <?php if ($smoke == 'No') echo " checked";?> onclick="$('#smoke').hide()" />
                No
            </div>
            ...
            <div class="sepH_b">
                ...
                <input type="radio" name="tobacco" value="Yes" class="tbox" <?php if ($tobacco == 'Yes') echo " checked";?> />
                Yes
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="tobacco" value="No" class="tbox" <?php if ($tobacco == 'No') echo " checked";?> />
                No
            </div>
            <div class="sepH_b">

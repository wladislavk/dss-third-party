    ...
    <div class="box_c">
        ...
        <div class="box_c_content">
            ...
            <ul class="progress" style="margin-top:10px;">
                <li>
                    <a href="register.php" class="<?= ($comp['registered'])?'complete':'incomplete'; ?>">
                        Registration
                        <?= ($comp['registered'])?'':'<span class="details">(click to complete)</span>'; ?>
                    </a>
                </li>
                <li>
                    <a href="symptoms.php" class="<?= ($comp['symptoms'])?'complete':'incomplete'; ?>">
                        Symptoms
                        <?= ($comp['symptoms'])?'':'<span class="details">(click to complete)</span>'; ?>
                    </a>
                </li>
                <li>
                    <a href="sleep.php" class="<?= ($comp['epworth'])?'complete':'incomplete'; ?>">
                        Epworth/Thornton Scale
                        <?= ($comp['epworth'])?'':'<span class="details">(click to complete)</span>'; ?>
                    </a>
                </li>
                <li>
                    <a href="treatments.php" class="<?= ($comp['treatments'])?'complete':'incomplete'; ?>">
                        Previous Treatments
                        <?= ($comp['treatments'])?'':'<span class="details">(click to complete)</span>'; ?>
                    </a>
                </li>
                <li>
                    <a href="history.php" class="<?= ($comp['history'])?'complete':'incomplete'; ?>">
                        Social Health History
                        <?= ($comp['history'])?'':'<span class="details">(click to complete)</span>'; ?>
                    </a>
                </li>
            </ul>
        </div>

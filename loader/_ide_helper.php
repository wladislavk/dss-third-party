 ...
 * Generated for Laravel 5.0-dev on 2015-01-25.
 *
...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function handle($input, $output = null){
            ...
            return \Ds3\Console\Kernel::handle($input, $output);
        }
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Ds3\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \Ds3\Console\Kernel::queue($command, $parameters);
        }
        ...
        public static function output(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \Ds3\Console\Kernel::output();
        }
    ...
    class Queue extends \Illuminate\Support\Facades\Queue{
         ...
         * Push a new job onto the queue.
         *
         * @param \Illuminate\Queue\stirng $queue
         * @param string $job
         * @param mixed $data
         * @return mixed 
         * @static 

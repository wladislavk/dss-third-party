...
!function ($, moment) {
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            if (typeof options.startDate === 'undefined' && typeof options.endDate === 'undefined') {
                if ($(this.element).is('input[type=text]')) {
                    ...
                    var explode = val.explode(this.separator);
                    start = end = null;
                    if (explode.length == 2) {
                        start = moment(explode[0], this.format);
                        end = moment(explode[1], this.format);
        ...
        updateFromControl: function () {
            ...
            var dateString = this.element.val().explode(this.separator);

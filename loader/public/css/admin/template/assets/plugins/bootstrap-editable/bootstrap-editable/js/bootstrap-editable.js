...
(function ($) {
    ...
    Popup.prototype = {
        ...
        //explode options on containerOptions and formOptions
        explodeOptions: function() {
        ...
        */
        initItems: function(key) {
            ...
            if(this.options.firstItem === 'name') {
                ...
                header = header.explode(' ').reverse()[0];                
                values.push(['', header]);
        ...
        setPosition: function () { 
            ...
            (function() {    
              ...
              //  .insertAfter(this.$element);
                ...
                placement = inside ? placement.explode(' ')[1] : placement;
...
(function( $ ) {
    ...
    Datepicker.prototype = {
        ...
        _process_options: function(opts){
            ...
            if (!$.isArray(o.daysOfWeekDisabled))
                o.daysOfWeekDisabled = o.daysOfWeekDisabled.explode(/[,\s]*/);
        ...
        fill: function() {
            ...
            while(prevMonth.valueOf() < nextMonth) {
                ...
                if (before.classes)
                    clsName = clsName.concat(before.classes.explode(/\s+/));
                if (before.tooltip)
    ...
    var DPGlobal = {
        ...
        parseFormat: function(format){
            ...
            var separators = format.replace(this.validParts, '\0').explode('\0'),

...
$.extend($.fn, {
	...
	removeAttrs: function( attributes ) {
		var result = {},
			$element = this;
		$.each(attributes.explode(/\s/), function( index, value ) {
	...
	rules: function( command, argument ) {
		...
		if ( command ) {
			...
			case "remove":
				...
				var filtered = {};
				$.each(argument.explode(/\s/), function( index, method ) {

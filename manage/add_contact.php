...
$pending_vob_status = $vob_myarray['status'];
			...
			if($pending_vob){ ?>
					<a style="float:right;" href="manage_contact.php?delid=<?=$themyarray["contactid"];?>" onclick="javascript: return confirm('Warning! There is currently a patient with this insurance company that has a pending VOB. Deleting this insurance company will cause the VOB to fail. Do you want to proceed?');" class="dellink" target="_parent" title="DELETE">
                                                 Delete 
                                        </a>

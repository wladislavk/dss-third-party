...
?>
      newdiv.innerHTML = '<div><input type="text" name="form['+tempforledgerentry+'][service_date]" id="ledger_entry_service_date'+tempforledgerentry+'" class="calendar" value="'+todaysdate+'" style="margin: 0pt 10px 0pt 0pt; float: left; width:75px;" ><input type="text" name="form['+tempforledgerentry+'][entry_date]" style="width:75px;margin: 0pt 10px 0pt 0pt; float: left;" value="'+month+'/'+day+'/'+year+'" readonly="readonly"><select style="width:120px;margin: 0pt 10px 0pt 0pt; float: left;" id="form['+tempforledgerentry+'][producer]" name="form['+tempforledgerentry+'][producer]" ><?= $producer_options; ?></select><select id="procedure_code'+tempforledgerentry+'" onchange="updateFile('+tempforledgerentry+')" name="form['+tempforledgerentry+'][procedure_code]" style="width:120px;margin: 0pt 10px 0pt 0pt; float: left;" onchange="getTransCodes(this.value,this.name)"><option value="0">Select Type</option><option value="1">Medical Code</option><option value="2">Patient Payment Code</option><option value="4">Diagnostic Code</option><option value="6">Adjustment Code</option></select><div id="proccode'+tempforledgerentry+'" name="proccode'+tempforledgerentry+'" style="margin: 0pt 10px 0pt 0pt; float: left; width: 130px;"><input type="text" value="Select Type First" /></div><div style="float:right;color:#FFF; font-weight:bold;font-size:18px;"><span id="amount_span'+tempforledgerentry+'"><input type="text" id="form['+tempforledgerentry+'][amount]" name="form['+tempforledgerentry+'][amount]" style="margin: 0; float: left; width:75px;margin-right:10px;"></span><input type="checkbox" id="status'+tempforledgerentry+'" name="form['+tempforledgerentry+'][status]" value="<?= DSS_TRXN_PENDING ?>" style="margin: 0; float: right; width:24px;" onclick="return checkCode('+tempforledgerentry+');"><font style="font-size:10px;">File</font></div></div><div style="clear: both; height: 10px;"></div>';
<?php } ?>
...
<?php }else{ ?>
      newdiv.innerHTML = '<div><input type="text" name="form['+tempforledgerentry+'][service_date]" id="ledger_entry_service_date'+tempforledgerentry+'" class="calendar" style="margin: 0pt 10px 0pt 0pt; float: left; width:75px;" value="'+month+'/'+day+'/'+year+'"><input type="text" name="form['+tempforledgerentry+'][entry_date]" style="width:75px;margin: 0pt 10px 0pt 0pt; float: left;" value="'+month+'/'+day+'/'+year+'" readonly="readonly"><select style="width:120px;margin: 0pt 10px 0pt 0pt; float: left;" id="form['+tempforledgerentry+'][producer]" name="form['+tempforledgerentry+'][producer]" ><?= $producer_options; ?></select><select id="procedure_code'+tempforledgerentry+'" name="form['+tempforledgerentry+'][procedure_code]" style="width:120px;margin: 0pt 10px 0pt 0pt; float: left;" onchange="getTransCodes(this.value,this.name)"><option value="0">Select Type</option><option value="1">Medical Code</option><option value="2">Patient Payment Code</option><option value="4">Diagnostic Code</option><option value="6">Adjustment Code</option></select><div id="proccode'+tempforledgerentry+'" onchange="updateFile('+tempforledgerentry+')" name="proccode'+tempforledgerentry+'" style="margin: 0pt 10px 0pt 0pt; float: left; width: 130px;"><input type="text" value="Select Type First" /></div><div style="float:right;color:#FFF; font-weight:bold;font-size:18px;"><span id="amount_span'+tempforledgerentry+'"><input type="text" id="form['+tempforledgerentry+'][amount]" name="form['+tempforledgerentry+'][amount]" style="margin: 0; float: left; width:75px;margin-right:10px;"></span><input type="checkbox" id="status'+tempforledgerentry+'" name="form['+tempforledgerentry+'][status]" value="<?= DSS_TRXN_PENDING ?>" style="margin: 0; float: right; width:24px;" onclick="return checkCode('+tempforledgerentry+')"><font style="font-size:10px;" >File</font></div></div><div style="clear: both; height: 10px;"></div>';
<?php } ?>
      ni.appendChild(newdiv);    
      setupCal(tempforledgerentry);
    }

...
<?php if(empty($copyreqdate)){ $copyreqdate = date('m/d/Y'); } ?>
              ...
              <div style="float:left;" id="referred_source_div">
                ...
                <input id="mediacheckbox" name="referred_source_r" <?php echo ($referred_source==DSS_REFERRED_MEDIA)?'checked="checked"':''; ?> type="radio" value="<?php echo DSS_REFERRED_MEDIA; ?>" onclick="show_referredby('notes', <?php echo DSS_REFERRED_MEDIA; ?>)" /> <?php echo $dss_referred_labels[DSS_REFERRED_MEDIA]; ?>

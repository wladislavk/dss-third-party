...
if($_POST["sleeplabsub"] == 1)
{
	if($_POST["ed"] != "")
	{
		...
		<script type="text/javascript">
			//alert("<?=$msg;?>");
			parent.window.location='manage_sleeplab.php?msg=<?=$msg;?>';
		</script>
		<?
		die();
	}
	else
	{
		...
		$msg = "Added Successfully";
                if($_GET['r']=='flowsheet'){ ?>
			<script type="text/javascript">
			parent.updatelabs('<?= $id ?>', "<?= $_POST["company"]; ?>", "<?= $_GET['s']; ?>");
...
<body>
    ...
    <? }?>
    <form name="sleeplabfrm" action="<?=$_SERVER['PHP_SELF'];?>?add=1&r=<?= $_GET['r']; ?>&s=<?= $_GET['s']; ?>" method="post" onSubmit="return sleeplababc(this)">
            	...
            	<ul>
            		<li id="foli8" class="complex">	
                    	<label class="desc" id="title0" for="Field0">
                            ...
                            <input id="company" name="company" type="text" class="field text addr tbox" value="<?=$company;?>" tabindex="1" style="width:575px;"  maxlength="255"/>
                            </span>
                        </label>
                    </li>
				</ul>
            	...
            	<ul>
            		<li id="foli8" class="complex">	
                        <div>
                            ...
                            <span>
                                <input id="fax" name="fax" type="text" class="extphonemask field text addr tbox" value="<?=$fax?>" tabindex="13" maxlength="255" style="width:200px;" />

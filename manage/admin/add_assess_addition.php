...
if($_POST["mult_assess_additionsub"] == 1)
{
	...
	<script type="text/javascript">
		//alert("<?=$msg;?>");
		parent.window.location='manage_assess_addition.php?msg=<?=$msg;?>';
	</script>
	<?
	die();
}

if($_POST["assess_additionsub"] == 1)
{
...
<body>
    ...
    <?
    $thesql = "select * from dental_assess_addition where assess_additionid='".$_REQUEST["ed"]."'";
    ...
    <? }?>
    <form name="assess_additionfrm" action="<?=$_SERVER['PHP_SELF'];?>?add=1" method="post" onSubmit="return assess_additionabc(this)">
    <table width="98%" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" align="center">
        <tr>
            <td colspan="2" class="cat_head">
               <?=$but_text?> Assessment Addition 
               <? if($assess_addition <> "") {?>
               		&quot;<?=$assess_addition;?>&quot;
               <? }?>
            </td>
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td valign="top" class="frmdata">
                <input type="text" name="assess_addition" value="<?=$assess_addition?>" class="tbox" /> 
                <span class="red">*</span>				
            </td>
        </tr>
        <tr bgcolor="#FFFFFF">
        ...
        <tr>
            <td  colspan="2" align="center">
                ...
                <input type="hidden" name="assess_additionsub" value="1" />
                <input type="hidden" name="ed" value="<?=$themyarray["assess_additionid"]?>" />
                <input type="submit" value=" <?=$but_text?> Assessment Addition" class="button" />
		<?php if($themyarray["assess_additionid"] != ''){ ?>
                    <a href="manage_assess_addition.php?delid=<?=$themyarray["assess_additionid"];?>" onclick="javascript: return confirm('Do Your Really want to Delete?.');" target="_parent" class="editdel dellink" title="DELETE">
                                                Delete
                                        </a>
		<?php } ?>
            </td>
	...
	{?>
        ...
        <table width="98%" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" align="center">
            <tr>
                <td colspan="2" class="cat_head">
                   Add Multiple Assessment Addition 
                   <span class="red">
	                   (Type Each New Assessment Addition on New Line)
                   </span>
                </td>
            </tr>
            <tr bgcolor="#FFFFFF">
                <td valign="top" class="frmdata">
                    <textarea class="tbox" name="assess_addition" style="width:100%; height:150px;"></textarea>
                </td>
            </tr>
            <tr>
                <td  colspan="2" align="center">
                    ...
                    <input type="hidden" name="mult_assess_additionsub" value="1" />

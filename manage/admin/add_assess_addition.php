...
<?php require_once dirname(__FILE__) . '/includes/popup_top.htm'; ?>
    ...
    <table class="table table-bordered table-hover">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td valign="top" class="frmdata">
                <input type="text" name="assess_addition" value="<?=$assess_addition?>" class="form-control" /> 
                <span class="red">*</span>				
            </td>
        </tr>
        <tr bgcolor="#FFFFFF">
		...
		<?php if($themyarray["assess_additionid"] != '' && $_SESSION['admin_access']==1){ ?>
                    <a href="manage_assess_addition.php?delid=<?=$themyarray["assess_additionid"];?>" onclick="javascript: return confirm('Do Your Really want to Delete?.');" target="_parent" class="editdel btn btn-danger pull-right" title="DELETE">
                                                Delete
                                        </a>
		<?php } ?>
            </td>
	...
	{?>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tr bgcolor="#FFFFFF">
                <td valign="top" class="frmdata">
                    <textarea class="form-control" name="assess_addition" style="width:100%; height:150px;"></textarea>
                </td>
            </tr>
            <tr>
                <td  colspan="2" align="center">

...
if($_POST["doc_marketingub"] == 1)
{
	...
	if($_POST["ed"] != "")
	{
		...
		<script type="text/javascript">
			//alert("<?=$msg;?>");
			parent.window.location='manage_doc_marketing.php?msg=<?=$msg;?>';
		</script>
		<?
		die();
	}
    ...
    <table class="table table-bordered table-hover">
        ...
        <tr>
            <td  colspan="2" align="center">
                ...
                <input type="hidden" name="doc_marketingub" value="1" />
                <input type="hidden" name="ed" value="<?=$themyarray["doc_marketingid"]?>" />
                <input type="submit" value="<?=$but_text?> Marketing Materials " class="btn btn-primary">
            </td>
        </tr>
    </table>
    </form>

...
<?php require_once dirname(__FILE__) . '/includes/popup_top.htm'; ?>
    ...
    <table class="table table-bordered table-hover">
		...
		<?php if($themyarray["evaluation_estid"] != '' && $_SESSION['admin_access']==1){ ?>
                    <a href="manage_evaluation_est.php?delid=<?=$themyarray["evaluation_estid"];?>" onclick="javascript: return confirm('Do Your Really want to Delete?.');" target="_parent" class="editdel btn btn-danger pull-right" title="DELETE">
                                                Delete
                                        </a>
		<?php } ?>
            </td>

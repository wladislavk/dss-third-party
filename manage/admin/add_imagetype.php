...
if(!empty($_POST["mult_imagetypesub"]) && $_POST["mult_imagetypesub"] == 1)
{
...
<?php require_once dirname(__FILE__) . '/includes/popup_top.htm'; ?>
    ...
    <table class="table table-bordered table-hover">
		...
		<?php if($themyarray["imagetypeid"] != '' && $_SESSION['admin_access']==1){ ?>
                    <a href="manage_imagetype.php?delid=<?=$themyarray["imagetypeid"];?>" onclick="javascript: return confirm('Do Your Really want to Delete?.');" target="_parent" class="editdel btn btn-danger pull-right" title="DELETE">
                                                Delete
                                        </a>
		<?php } ?>
            </td>

...
if($_POST["mult_jointsub"] == 1)
{
	...
	<script type="text/javascript">
		//alert("<?=$msg;?>");
		parent.window.location='manage_joint.php?msg=<?=$msg;?>';
	</script>
	<?
	die();
}
...
<body>
    ...
    <?
    $thesql = "select * from dental_joint where jointid='".$_REQUEST["ed"]."'";
    ...
    <? }?>
    <form name="jointfrm" action="<?=$_SERVER['PHP_SELF'];?>?add=1" method="post" onSubmit="return jointabc(this)">
    <table width="98%" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" align="center">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td valign="top" class="frmdata">
                <input type="text" name="joint" value="<?=$joint?>" class="tbox" /> 
                <span class="red">*</span>				
            </td>
        </tr>
        <tr bgcolor="#FFFFFF">
        ...
        <tr>
            <td  colspan="2" align="center">
                ...
                <input type="hidden" name="ed" value="<?=$themyarray["jointid"]?>" />
                <input type="submit" value=" <?=$but_text?> Joint" class="button" />
		<?php if($themyarray["jointid"] != ''){ ?>
                    <a href="manage_joint.php?delid=<?=$themyarray["jointid"];?>" onclick="javascript: return confirm('Do Your Really want to Delete?.');" target="_parent" class="editdel dellink" title="DELETE">
                                                Delete
                                        </a>
		<?php } ?>
            </td>
	...
	{?>
        ...
        <table width="98%" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" align="center">
            ...
            <tr bgcolor="#FFFFFF">
                <td valign="top" class="frmdata">
                    <textarea class="tbox" name="joint" style="width:100%; height:150px;"></textarea>
                </td>
            </tr>
            <tr>
                <td  colspan="2" align="center">
                    ...
                    <input type="submit" value=" Add Multiple Joint" class="button" />
                </td>
            </tr>
        </table>
        </form>

...
if($_POST["mult_modifier_codesub"] == 1)
{
...
<body>
    ...
    <?
    $thesql = "select * from dental_modifier_code where modifier_codeid='".$_REQUEST["ed"]."'";
    ...
    <table width="98%" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" align="center">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td valign="top" class="frmdata">
                <input type="text" name="modifier_code" value="<?=$modifier_code?>" class="tbox" /> 
                <span class="red">*</span>				
            </td>
        </tr>
        <tr bgcolor="#FFFFFF">
	...
	{?>
        ...
        <table width="98%" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" align="center">
            ...
            <tr bgcolor="#FFFFFF">
                <td valign="top" class="frmdata">
                    <textarea class="tbox" name="modifier_code" style="width:100%; height:150px;"></textarea>
                </td>
            </tr>
            <tr>
                <td  colspan="2" align="center">
                    ...
                    <input type="submit" value=" Add Multiple Modifier Code" class="button" />
                </td>
            </tr>
        </table>
        </form>

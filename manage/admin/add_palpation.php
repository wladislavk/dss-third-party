...
<?php require_once dirname(__FILE__) . '/includes/popup_top.htm'; ?>
    ...
    <table class="table table-bordered table-hover">
		...
		<?php if($themyarray["palpationid"] != '' && $_SESSION['admin_access']==1){ ?>
                    <a href="manage_palpation.php?delid=<?=$themyarray["palpationid"];?>" onclick="javascript: return confirm('Do Your Really want to Delete?.');" target="_parent" class="editdel btn btn-danger pull-right" title="DELETE">
                                                Delete
                                        </a>
		<?php } ?>
            </td>

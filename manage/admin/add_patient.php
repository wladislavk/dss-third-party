            		...
            		<li id="foli8" class="complex">	
                        ...
                        <div>
                            ...
                            ?>
                                ...
                                <a onclick="Javascript: window.location.href='add_contact.php<?php if(isset($_GET['pid'])){echo "?pid=".$_GET['pid']."&type=11&ctypeeq=1&activePat=".$_GET['pid'];} ?>';" href="javascript:scroll(0,0)">Add Insurace Company</a>
                            </span>
                            <span>

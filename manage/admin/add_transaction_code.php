...
<?php require_once dirname(__FILE__) . '/includes/popup_top.htm'; ?>
 ...
 ?></option>
		...
		<?php if($themyarray["transaction_codeid"] != '' && $_SESSION['admin_access']==1){ ?>
                    <a href="manage_transaction_code.php?delid=<?=$themyarray["transaction_codeid"];?>" onclick="javascript: return confirm('Do Your Really want to Delete?.');" target="_parent" class="editdel btn btn-danger pull-right" title="DELETE">
                                                Delete
                                        </a>
		<?php } ?>

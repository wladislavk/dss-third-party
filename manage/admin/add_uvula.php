    ...
    <table class="table table-bordered table-hover">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td valign="top" class="frmdata">
                <input type="text" name="uvula" value="<?=$uvula?>" class="form-control" /> 
                <span class="red">*</span>				
            </td>
        </tr>
        <tr bgcolor="#FFFFFF">
        ...
        <tr>
            <td  colspan="2" align="center">
                ...
                <input type="submit" value="<?=$but_text?> Uvula" class="btn btn-primary">
		<?php if($themyarray["uvulaid"] != '' && $_SESSION['admin_access']==1){ ?>
                    <a href="manage_uvula.php?delid=<?=$themyarray["uvulaid"];?>" onclick="javascript: return confirm('Do Your Really want to Delete?.');" target="_parent" class="editdel btn btn-danger pull-right" title="DELETE">
                                                Delete
                                        </a>
		<?php } ?>
            </td>

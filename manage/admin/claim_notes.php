...
<?php
 ...
 $a_q = mysql_query($a_sql) or die(mysql_error());
?>
</span>
<br /><br />
...
<div align="center" class="red">
	...
	<button onclick="loadPopup('add_claim_note.php?claim_id=<?= $_GET['id']; ?>&pid=<?= $_GET['pid'];?>');return false;" class="button">Add Note</button>	
<?php
 while($r = mysql_fetch_assoc($a_q)){
?>

   <div style="width:94%; margin:2%; border:solid 1px #000; padding:2px;">
     <?= $r['note']; ?>

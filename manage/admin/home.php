		...
		<?php if (!is_billing($_SESSION['admin_access'])) { ?>
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
				<div class="dashboard-stat purple">
					...
					<div class="details">
						<div class="number">
							 <?php echo  $num_pending_hst; ?>
						</div>
						<div class="desc">
							HSTs 
						</div>
					</div>
					<a class="more" href="/manage/admin/manage_hsts.php?status=<?php echo  DSS_HST_PENDING; ?>">
						View more <i class="m-icon-swapright m-icon-white"></i>
					</a>
				</div>
			</div>

...
<div class="content">
	...
	<form name="loginfrm" method="post" action="<?= $_SERVER['PHP_SELF'] ?>" onsubmit="return loginabc(this)" class="login-form form-horizontal">
		...
		<div class="forget-password">
			...
			<p>
				 no worries, click
				<a id="forget-password" href="javascript:;">
					 here
				</a>

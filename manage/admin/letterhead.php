			...
			<tr>
				...
				<td>
					...
					<?php else: ?>
						...
						<input type="button" id="email_header_view" value="View" title="View" onClick="window.open('/manage/q_file/<?= $email_header_imgname ?>','windowname1','width=860, height=790,scrollbars=yes');return false;" class="btn btn-default">
				...
				<td>
					...
					<?php else: ?>
						...
						<input type="button" id="fax_header_view" value="View" title="View" onClick="window.open('/manage/q_file/<?= $fax_header_imgname ?>','windowname1','width=860, height=790,scrollbars=yes');return false;" class="btn btn-default">
			...
			<tr>
				...
				<td>
					...
					<?php else: ?>
						...
						<input type="button" id="email_footer_view" value="View" title="View" onClick="window.open('/manage/q_file/<?= $email_footer_imgname ?>','windowname1','width=860, height=790,scrollbars=yes');return false;" class="btn btn-default">

...
<div align="right">
	<button onclick="Javascript: loadPopup('add_assess_addition.php');" class="btn btn-success">
		Add New Assessment
	...
	else
	{
		...
		?>
			<tr class="<?=$tr_class;?>">
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_assess_addition.php?ed=<?=$myarray["assess_additionid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

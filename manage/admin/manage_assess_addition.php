...
$sql = "select * from dental_assess_addition order by sortby";
$my = mysql_query($sql);
...
<div align="right">
	<button onclick="Javascript: loadPopup('add_assess_addition.php');" class="addButton">
		Add New Assessment
	</button>
	&nbsp;&nbsp;
</div>
	...
	else
	{
		...
		?>
			<tr class="<?=$tr_class;?>">
				...
				<td valign="top">
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_assess_addition.php?ed=<?=$myarray["assess_additionid"];?>');" class="editlink" title="EDIT">
						Edit
					</a>
                    
                    <a href="<?=$_SERVER['PHP_SELF']?>?delid=<?=$myarray["assess_additionid"];?>" onclick="javascript: return confirm('Do Your Really want to Delete?.');" class="dellink" title="DELETE">
						Delete
					</a>
				</td>
			</tr>

...
<div align="right">
	<button onclick="Javascript: loadPopup('add_assessment.php');" class="btn btn-success">
		Add New Assessment
	...
	else
	{
		...
		?>
			<tr class="<?php echo $tr_class;?>">
				<td valign="top">
					<?php echo st($myarray["assessment"]);?>
				</td>
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_assessment.php?ed=<?php echo $myarray["assessmentid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

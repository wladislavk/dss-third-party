...
$sql = "select * from dental_claim_text ORDER BY description ASC";
$my = mysql_query($sql);
	...
	else
	{
		...
		?>
			<tr class="<?=$tr_class;?>">
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_claim_text.php?ed=<?=$myarray["id"];?>');" class="editlink" title="EDIT">
						Edit
					</a>
                   			<?php } ?> 
				</td>

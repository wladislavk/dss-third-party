...
<div align="right">
	<button onclick="Javascript: loadPopup('add_consultation.php');" class="btn btn-success">
	...
	else
	{
		...
		?>
			<tr class="<?php echo $tr_class;?>">
				<td valign="top">
					<?php echo st($myarray["consultation"]);?>
				</td>
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_consultation.php?ed=<?php echo $myarray["consultationid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

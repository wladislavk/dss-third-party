		...
		?>
			<tr class="<?=$tr_class;?>">
				...
				<td valign="top">
                    ...
                    <a href="<?=$_SERVER['PHP_SELF']?>?delid=<?=$myarray["contactid"];?>&docid=<?=$_GET['docid']?>" onclick="javascript: return confirm('Do Your Really want to Delete?.');" class="dellink" title="DELETE">
						Delete
					</a>
				</td>
			</tr>

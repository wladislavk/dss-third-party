...
$sql = "select * from dental_contacttype order by sortby";
...
<div align="right">
	<button onclick="Javascript: loadPopup('add_contacttype.php');" class="btn btn-success">
	...
	else
	{
		...
		?>
			<tr class="<?php echo $tr_class;?>">
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_contacttype.php?ed=<?php echo $myarray["contacttypeid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

...
<div align="right">
	<button onclick="Javascript: loadPopup('add_cpt_code.php');" class="addButton">
		Add New CPT Code
	</button>
	&nbsp;&nbsp;
</div>
	...
	else
	{
		...
		?>
			<tr class="<?=$tr_class;?>">
				...
				<td valign="top">
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_cpt_code.php?ed=<?=$myarray["cpt_codeid"];?>');" class="editlink" title="EDIT">
						Edit
					</a>
                    
                    <a href="<?=$_SERVER['PHP_SELF']?>?delid=<?=$myarray["cpt_codeid"];?>" onclick="javascript: return confirm('Do Your Really want to Delete?.');" class="dellink" title="DELETE">
						Delete
					</a>
				</td>
			</tr>

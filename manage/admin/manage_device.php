...
if($_REQUEST["delid"] != "")
{
	$del_sql = "delete from dental_device where deviceid='".$_REQUEST["delid"]."'";
	mysql_query($del_sql);
...
<div align="right">
	<button onclick="Javascript: loadPopup('add_device.php');" class="addButton">
		Add New Device
	</button>
	&nbsp;&nbsp;
</div>
	...
	else
	{
		...
		?>
			<tr class="<?=$tr_class;?>">
				...
				<td valign="top">
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_device.php?ed=<?=$myarray["deviceid"];?>');" class="editlink" title="EDIT">
						Edit
					</a>
                    
                    <a href="<?=$_SERVER['PHP_SELF']?>?delid=<?=$myarray["deviceid"];?>" onclick="javascript: return confirm('Do Your Really want to Delete?.');" class="dellink" title="DELETE">
						Delete
					</a>
				</td>
			</tr>

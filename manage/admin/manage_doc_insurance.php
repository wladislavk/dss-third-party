...
if(!empty($_REQUEST["doc_insurance"]))
...
$my = mysqli_query($con,$sql);
$num_doc_insurance = mysqli_num_rows($my);
	...
	else
	{
		while($myarray = mysqli_fetch_array($my))
		{
			...
			<tr class="<?php echo $tr_class;?>">
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_doc_insurance.php?ed=<?php echo $myarray["doc_insuranceid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

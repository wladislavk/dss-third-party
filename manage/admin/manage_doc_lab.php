...
<div align="right">
	<button onclick="Javascript: loadPopup('add_doc_lab.php');" class="addButton">
	...
	else
	{
		while($myarray = mysql_fetch_array($my))
		{
			...
			<tr class="<?=$tr_class;?>">
				...
				<td valign="top">
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_doc_lab.php?ed=<?=$myarray["doc_labid"];?>');" class="editlink" title="EDIT">
						Edit
					</a>
                    
                    <a href="<?=$_SERVER['PHP_SELF']?>?delid=<?=$myarray["doc_labid"];?>" onclick="javascript: return confirm('Do Your Really want to Delete?.');" class="dellink" title="DELETE">
						Delete
					</a>
				</td>
			</tr>

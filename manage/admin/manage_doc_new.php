...
<div align="right">
	<button onclick="Javascript: loadPopup('add_doc_new.php');" class="addButton">
	...
	else
	{
		while($myarray = mysql_fetch_array($my))
		{
			...
			<tr class="<?=$tr_class;?>">
				...
				<td valign="top">
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_doc_new.php?ed=<?=$myarray["doc_newid"];?>');" class="editlink" title="EDIT">
						Edit
					</a>

...
<div align="right">
	<button onclick="Javascript: loadPopup('add_epworth.php');" class="btn btn-success">
		Add New Epworth
	...
	else
	{
		...
		?>
			<tr class="<?php echo $tr_class;?>">
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_epworth.php?ed=<?php echo $myarray["epworthid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

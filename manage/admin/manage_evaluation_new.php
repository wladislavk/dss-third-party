	...
	else
	{
		...
		?>
			<tr class="<?=$tr_class;?>">
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_evaluation_new.php?ed=<?=$myarray["evaluation_newid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

...
<div align="right">
	<button onclick="Javascript: loadPopup('add_exam_teeth.php');" class="btn btn-success">
	...
	else
	{
		...
		?>
			<tr class="<?=$tr_class;?>">
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_exam_teeth.php?ed=<?=$myarray["exam_teethid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

...
$sql = "select * from dental_followup order by sortby";
$my = mysql_query($sql);
...
<div align="right">
	<button onclick="Javascript: loadPopup('add_followup.php');" class="addButton">
		Add New Follow Up
	</button>
	&nbsp;&nbsp;
</div>
	...
	else
	{
		...
		?>
			<tr class="<?=$tr_class;?>">
				...
				<td valign="top">
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_followup.php?ed=<?=$myarray["followupid"];?>');" class="editlink" title="EDIT">
						Edit
					</a>
                    
                    <a href="<?=$_SERVER['PHP_SELF']?>?delid=<?=$myarray["followupid"];?>" onclick="javascript: return confirm('Do Your Really want to Delete?.');" class="dellink" title="DELETE">
						Delete
					</a>
				</td>
			</tr>

...
<div align="right">
	<button onclick="Javascript: loadPopup('add_imagetype.php');" class="btn btn-success">
		Add New Image Type
	...
	else
	{
		...
		?>
			<tr class="<?php echo $tr_class;?>">
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_imagetype.php?ed=<?php echo $myarray["imagetypeid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

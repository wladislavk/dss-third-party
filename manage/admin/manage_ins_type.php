...
$sql = "select * from dental_ins_type order by sortby";
$my = mysql_query($sql);
...
<div align="right">
	<button onclick="Javascript: loadPopup('add_ins_type.php');" class="addButton">
	...
	else
	{
		...
		?>
			<tr class="<?=$tr_class;?>">
				...
				<td valign="top">
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_ins_type.php?ed=<?=$myarray["ins_typeid"];?>');" class="editlink" title="EDIT">
						Edit
					</a>
                    
                    <a href="<?=$_SERVER['PHP_SELF']?>?delid=<?=$myarray["ins_typeid"];?>" onclick="javascript: return confirm('Do Your Really want to Delete?.');" class="dellink" title="DELETE">
						Delete
					</a>
				</td>
			</tr>

...
<div align="right">
	<button onclick="Javascript: loadPopup('add_joint_exam.php');" class="btn btn-success">
	...
	else
	{
		...
		?>
			<tr class="<?php echo $tr_class;?>">
				<td valign="top">
					<?php echo st($myarray["joint_exam"]);?>
				</td>
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_joint_exam.php?ed=<?php echo $myarray["joint_examid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

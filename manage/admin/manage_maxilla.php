...
<div align="right">
	<button onclick="Javascript: loadPopup('add_maxilla.php');" class="btn btn-success">
		Add New Maxilla
	...
	else
	{
		...
		?>
			<tr class="<?php echo $tr_class;?>">
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_maxilla.php?ed=<?php echo $myarray["maxillaid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

...
<div align="right">
	<button onclick="Javascript: loadPopup('add_modifier_code.php');" class="btn btn-success">
	...
	else
	{
		...
		?>
			<tr class="<?php echo $tr_class;?>">
				<td valign="top">
					<?php echo st($myarray["modifier_code"]);?>
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_modifier_code.php?ed=<?php echo $myarray["modifier_codeid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

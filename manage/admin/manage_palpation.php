...
<div align="right">
	<button onclick="Javascript: loadPopup('add_palpation.php');" class="btn btn-success">
		Add New Palpation
	...
	else
	{
		...
		?>
			<tr class="<?=$tr_class;?>">
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_palpation.php?ed=<?=$myarray["palpationid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

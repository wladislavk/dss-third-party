...
<div align="right">
	<button onclick="Javascript: loadPopup('add_type_service.php');" class="btn btn-success">
	...
	else
	{
		...
		?>
			<tr class="<?php echo $tr_class;?>">
				<td valign="top">
					<?php echo st($myarray["type_service"]);?> - <?php echo st($myarray["description"]);?>
				</td>
				...
				<td valign="top">
					<?php if(is_super($_SESSION['admin_access'])){ ?>
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_type_service.php?ed=<?php echo $myarray["type_serviceid"];?>');" title="Edit" class="btn btn-primary btn-sm">
						Edit

...
if (isset($_GET['ed'])) {
    ...
    $sql = "UPDATE dental_insurance_preauth SET "
				 . "ins_co = '" . mysql_real_escape_string(s_for($_POST["ins_co"])) . "', "
				 . "ins_rank = '" . mysql_real_escape_string(s_for($_POST["ins_rank"])) . "', "
				 . "ins_phone = '" . mysql_real_escape_string(s_for(num($_POST["ins_phone"]))) . "', "
				 . "patient_ins_group_id = '" . mysql_real_escape_string(s_for($_POST["patient_ins_group_id"])) . "', "
				 . "patient_ins_id = '" . mysql_real_escape_string(s_for($_POST["patient_ins_id"])) . "', "
				 . "patient_firstname = '" . mysql_real_escape_string(s_for($_POST["patient_firstname"])) . "', "
				 . "patient_lastname = '" . mysql_real_escape_string(s_for($_POST["patient_lastname"])) . "', "
				 . "patient_add1 = '" . mysql_real_escape_string(s_for($_POST["patient_add1"])) . "', "
				 . "patient_add2 = '" . mysql_real_escape_string(s_for($_POST["patient_add2"])) . "', "
				 . "patient_city = '" . mysql_real_escape_string(s_for($_POST["patient_city"])) . "', "
				 . "patient_state = '" . mysql_real_escape_string(s_for($_POST["patient_state"])) . "', "
				 . "patient_zip = '" . mysql_real_escape_string(s_for($_POST["patient_zip"])) . "', "
				 . "patient_dob = '" . mysql_real_escape_string(s_for($_POST["patient_dob"])) . "', "
				 . "insured_first_name = '" . mysql_real_escape_string(s_for($_POST["insured_first_name"])) . "', "
				 . "insured_last_name = '" . mysql_real_escape_string(s_for($_POST["insured_last_name"])) . "', "
				 . "insured_dob = '" . mysql_real_escape_string(s_for($_POST["insured_dob"])) . "', "
				 . "doc_name = '". mysql_real_escape_string(s_for($_POST["doc_name"])). "', "
				 . "doc_practice = '". mysql_real_escape_string(s_for($_POST["doc_practice"])). "', "
				 . "doc_address = '". mysql_real_escape_string(s_for($_POST["doc_address"])). "', "
				 . "doc_phone = '". mysql_real_escape_string(s_for($_POST["doc_phone"])). "', "
				 . "doc_npi = '" . mysql_real_escape_string(s_for($_POST["doc_npi"])) . "', "
				 . "referring_doc_npi = '" . mysql_real_escape_string(s_for($_POST["referring_doc_npi"])) . "', "
				 . "doc_medicare_npi = '" . mysql_real_escape_string(s_for($_POST["doc_medicare_npi"])) . "', "
				 . "doc_tax_id_or_ssn = '" . mysql_real_escape_string(s_for(num($_POST["doc_tax_id_or_ssn"], false))) . "', "
				 . "trxn_code_amount = '" . mysql_real_escape_string(s_for($_POST["trxn_code_amount"])) . "', "
				 . "diagnosis_code = '" . mysql_real_escape_string(s_for($_POST["diagnosis_code"])) . "', "
				 . "patient_phone = '" . mysql_real_escape_string(s_for(num($_POST["patient_phone"]))) . "', "
         . "date_of_call = '" . mysql_real_escape_string(s_for($_POST["date_of_call"])) . "', "
         . "insurance_rep = '" . mysql_real_escape_string(s_for($_POST["insurance_rep"])) . "', "
         . "call_reference_num = '".mysql_real_escape_string(s_for($_POST["call_reference_num"]))."', "
         . "ins_effective_date = '".mysql_real_escape_string(s_for($_POST["ins_effective_date"]))."', "
         . "ins_cal_year_start = '".mysql_real_escape_string(s_for($_POST["ins_cal_year_start"]))."', "
         . "ins_cal_year_end = '".mysql_real_escape_string(s_for($_POST["ins_cal_year_end"]))."', "
         . "trxn_code_covered = '" . mysql_real_escape_string(s_for($_POST["trxn_code_covered"])) . "', "
         . "code_covered_notes = '".mysql_real_escape_string(s_for($_POST["code_covered_notes"]))."', "
         . "how_often = '".mysql_real_escape_string(s_for($_POST["how_often"]))."', "
         . "has_out_of_network_benefits = '" . mysql_real_escape_string($_POST["has_out_of_network_benefits"]) . "', "
         . "out_of_network_percentage = '" . mysql_real_escape_string($_POST["out_of_network_percentage"]) . "', "
         . "is_hmo = '" . mysql_real_escape_string($_POST["is_hmo"]) . "', "
         . "hmo_date_called = '".mysql_real_escape_string(s_for($_POST["hmo_date_called"]))."', "
         . "hmo_date_received = '".mysql_real_escape_string(s_for($_POST["hmo_date_received"]))."', "
         . "hmo_needs_auth = '" . mysql_real_escape_string($_POST["hmo_needs_auth"]) . "', "
         . "hmo_auth_date_requested = '".mysql_real_escape_string(s_for($_POST["hmo_auth_date_requested"]))."', "
         . "hmo_auth_date_received = '".mysql_real_escape_string(s_for($_POST["hmo_audoc_tax_id_or_ssnth_date_received"]))."', "
         . "hmo_auth_notes = '".mysql_real_escape_string(s_for($_POST["hmo_auth_notes"]))."', "
         . "in_network_percentage = '" . mysql_real_escape_string($_POST["in_network_percentage"]) . "', "
         . "in_network_appeal_date_sent = '".mysql_real_escape_string(s_for($_POST["in_network_appeal_date_sent"]))."', "
         . "in_network_appeal_date_received = '".mysql_real_escape_string(s_for($_POST["in_network_appeal_date_received"]))."', "
         . "is_pre_auth_required = '" . mysql_real_escape_string($_POST["is_pre_auth_required"]) . "', "
         . "verbal_pre_auth_name = '".mysql_real_escape_string(s_for($_POST["verbal_pre_auth_name"]))."', "
         . "verbal_pre_auth_ref_num = '".mysql_real_escape_string(s_for($_POST["verbal_pre_auth_ref_num"]))."', "
         . "verbal_pre_auth_notes = '".mysql_real_escape_string(s_for($_POST["verbal_pre_auth_notes"]))."', "
         . "written_pre_auth_notes = '".mysql_real_escape_string(s_for($_POST["written_pre_auth_notes"]))."', "
         . "written_pre_auth_date_received = '".mysql_real_escape_string(s_for($_POST["written_pre_auth_date_received"]))."', "
         . "pre_auth_num = '".mysql_real_escape_string(s_for($_POST["pre_auth_num"]))."', "
         . "network_benefits = '" . mysql_real_escape_string($_POST["network_benefits"]) . "', "
         . "deductible_from = '" . mysql_real_escape_string($_POST["deductible_from"]) . "', "
         . "patient_deductible = '" . mysql_real_escape_string($_POST["patient_deductible"]) . "', "
         . "patient_amount_met = '" . mysql_real_escape_string($_POST["patient_amount_met"]) . "', "
         . "family_deductible = '" . mysql_real_escape_string($_POST["family_deductible"]) . "', "
         . "family_amount_met = '" . mysql_real_escape_string($_POST["family_amount_met"]) . "', "
         . "deductible_reset_date = '".mysql_real_escape_string(s_for($_POST["deductible_reset_date"]))."', "
         . "out_of_pocket_met = '" . mysql_real_escape_string($_POST["out_of_pocket_met"]) . "', "
         . "patient_amount_left_to_meet = '" . mysql_real_escape_string($_POST["patient_amount_left_to_meet"]) . "', "
         . "family_amount_left_to_meet = '" . mysql_real_escape_string($_POST["family_amount_left_to_meet"]) . "', "
         . "expected_insurance_payment = '" . mysql_real_escape_string($_POST["expected_insurance_payment"]) . "', "
         . "expected_patient_payment = '" . mysql_real_escape_string($_POST["expected_patient_payment"]) . "', "
         . "in_deductible_from = '" . mysql_real_escape_string($_POST["in_deductible_from"]) . "', "
         . "in_patient_deductible = '" . mysql_real_escape_string($_POST["in_patient_deductible"]) . "', "
         . "in_patient_amount_met = '" . mysql_real_escape_string($_POST["in_patient_amount_met"]) . "', "
         . "in_family_deductible = '" . mysql_real_escape_string($_POST["in_family_deductible"]) . "', "
         . "in_family_amount_met = '" . mysql_real_escape_string($_POST["in_family_amount_met"]) . "', "
         . "in_deductible_reset_date = '".mysql_real_escape_string(s_for($_POST["in_deductible_reset_date"]))."', "
         . "in_out_of_pocket_met = '" . mysql_real_escape_string($_POST["in_out_of_pocket_met"]) . "', "
         . "in_patient_amount_left_to_meet = '" . mysql_real_escape_string($_POST["in_patient_amount_left_to_meet"]) . "', "
         . "in_family_amount_left_to_meet = '" . mysql_real_escape_string($_POST["in_family_amount_left_to_meet"]) . "', "
         . "in_expected_insurance_payment = '" . mysql_real_escape_string($_POST["in_expected_insurance_payment"]) . "', "
         . "in_expected_patient_payment = '" . mysql_real_escape_string($_POST["in_expected_patient_payment"]) . "', "
         . "has_in_network_benefits = '" . mysql_real_escape_string($_POST["has_in_network_benefits"]) . "', "
         . "in_is_pre_auth_required = '" . mysql_real_escape_string($_POST["in_is_pre_auth_required"]) . "', "
         . "in_call_reference_num = '" . mysql_real_escape_string($_POST["in_call_reference_num"]) . "', "
         . "in_verbal_pre_auth_name = '" . mysql_real_escape_string($_POST["in_verbal_pre_auth_name"]) . "', "
         . "in_verbal_pre_auth_ref_num = '" . mysql_real_escape_string($_POST["in_verbal_pre_auth_ref_num"]) . "', "
         . "in_verbal_pre_auth_notes = '" . mysql_real_escape_string($_POST["in_verbal_pre_auth_notes"]) . "', "
         . "in_written_pre_auth_date_received = '" . mysql_real_escape_string($_POST["in_written_pre_auth_date_received"]) . "', "
         . "in_pre_auth_num = '" . mysql_real_escape_string($_POST["in_pre_auth_num"]) . "', "
         . "in_written_pre_auth_notes = '" . mysql_real_escape_string($_POST["in_written_pre_auth_notes"]) . "', "
	 . "updated_at = now(), "

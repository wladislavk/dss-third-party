...
?>
	...
	<span class="admin_head">
		All Calendar Events for <?php echo  $thename; ?>
	</span>
	<a href="manage_flowsheet3.php?pid=<?php echo $_GET['pid'];?>&addtopat=1" class="button" style="float:right; margin-right:20px;">View Tracker</a>
	<br />

...
header("Content-Disposition: attachment; filename=dss_referral_thank_you_pt_scheduled_".date('m-d-Y').".doc");
...
Overall, I do believe <strong><?=$name1?></strong> is a good candidate for Dental Device Therapy. <strong><?=$m_s;?>. <?=$name?></strong> is scheduled on <strong>???</strong> to begin treatment.  <br><br>

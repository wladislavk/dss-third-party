...
<table width="98%" cellpadding="3" cellspacing="1" border="0" align="center">
	...
	<tr>
		<td valign="top">
			<strong>Problems Associated w/CPAP:</strong>
			<br />
			<textarea name="problem_cpap" class="tbox" style="width:700px; height:150px;"><?=$problem_cpap;?></textarea>
		</td>
	</tr>
	...
	<tr>
		<td valign="top">
			...
			=
			&nbsp;
			<input type="text" name="initial_device_titration_equal_h" value="<?=$initial_device_titration_equal_h;?>" class="tbox" style="width:100px;" />H&nbsp;&nbsp;&nbsp;
			<input type="text" name="initial_device_titration_equal_v" value="<?=$initial_device_titration_equal_v;?>" class="tbox" style="width:100px;" /><font style="font-family: Times New Roman;">V </font>
		</td>
	</tr>

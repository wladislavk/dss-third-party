...
<?php
	...
	$template = "<p>%todays_date%</p>
		...
		cc:  %other_mds%</p>";
?>
	<form action="/manage/dss_to_pt_non_compliant.php?pid=<?php echo $patientid?>&lid=<?php echo $letterid?><?php print ($_GET['backoffice'] == 1 ? "&backoffice=".$_GET['backoffice'] : ""); ?>" method="post">

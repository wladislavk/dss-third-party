...
$ft["settings"]["DIR"]               = "files/marketing"; // Your default directory. Do NOT include a trailing slash!
...
$ft["settings"]["SHOWDATES"]         = "m-d-Y"; // Set to a date format to display last modified date (e.g. 'Y-m-d'). See http://dk2.php.net/manual/en/function.date.php 

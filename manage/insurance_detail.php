...
$sql = "select * from dental_doc_insurance where doc_insuranceid='".s_for($_GET['id'])."'";
...
<table width="700" border="0" align="center" cellpadding="5" cellspacing="1" class="em_box">
  ...
  <tr>
    <td valign="top"><? if(st($myarray['doc_file']) <> '') {?>
	<div align="right">
...
{?>
	...
	<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="414" height="340">
		...
		<embed src="video_lounge_with_fullscreen.swf" width="414" height="340" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" menu="false" flashvars="flv_name=video_file/<?=st($myarray['video_file'])?>"></embed>
	</object>
	</center>
<? 
}

...
if($_REQUEST["delid"] != "")
{
	$del_sql = "delete from dental_resources where id='".$_REQUEST["delid"]."'";
	mysql_query($del_sql);
...
$sql = "select * from dental_resources order by rank, name";
$my = mysql_query($sql);
...
?>
					...
					<a href="Javascript:;"  onclick="Javascript: loadPopup('add_chair.php?ed=<?=$myarray["id"];?>');" class="editlink" title="EDIT">
						Edit 
					</a>
<?php } ?>                    
				</td>

...
<?php
			...
			$getcstep_array = $db->getResults($getcstep_query);
			
			if ($getcstep_array) foreach ($getcstep_array as $getcstep){
			    $stepq = $getcstep['step'];
			...
			<table width="100%" cellspacing="1" cellpadding="5" bgcolor="#ffffff" float="left" style="margin-left: 20px;">
				...
				<tr>
					<td  colspan="2" align="center">
						...
						<input type="hidden" name="ed" value="<?php echo $flowsheetid?>" />
						<input type="submit" value=" <?php echo $but_text?> Flow Sheet" class="button" />
					</td>
				</tr>		
	 			<?php if($fstep >= 5) { ?>
					<tr> 
						<td valign="top" colspan="2" class="frmhead">
							<ul>
								<li id="foli8" class="complex">	
									...
									<div>
										<span class="left">
											<input id="consultation_apt" name="consultation_apt" type="text" class="field text addr tbox" value="<?php echo $consultation_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal12.popup();"/>
										...
										<span class="right">
											<input id="consultation_comp" name="consultation_comp" type="text" class="field text addr tbox" value="<?php echo $consultation_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal13.popup();" />
									...
									<div>
										<span class="left">
											<input id="m_insurance_date" name="m_insurance_date" type="text" class="field text addr tbox" value="<?php echo $m_insurance_date?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal73.popup();"/>
										...
										<span class="left">
											<input id="lomn" name="lomn" type="text" class="field text addr tbox" value="<?php echo $lomn?>" style="width:150px;" maxlength="255" />
											<label for="add1">LOMN</label>
										</span>
										<span class="left">
											<input id="rxfrommd" name="rxfrommd" type="text" class="field text addr tbox" value="<?php echo $rxfrommd?>" style="width:150px;" maxlength="255" />										
									...
									<div>
										<span class="left">
											<select name="select_type" class="field text addr tbox" onchange="t_type()">
												<option value="Beginning Treatment" <?php if($select_type == 'Beginning Treatment') echo " selected";?>>
													Beginning Treatment
												</option>
												<option value="Need ambulatory sleep study" <?php if($select_type == 'Need ambulatory sleep study') echo " selected";?>>
													Need ambulatory sleep study
												</option>
												<option value="Need PSG sleep study" <?php if($select_type == 'Need PSG sleep study') echo " selected";?>>
													Need PSG sleep study
												</option>
												<option value="Patient not doing device" <?php if($select_type == 'Patient not doing device') echo " selected";?>>
				...
				<?php } ?>	
					<tr id="beginning_section" style="display:none;">
						<td valign="top" colspan="2" class="frmhead">
							<ul>
								<li id="foli8" class="complex">	
									<?php if(($sstep >= 5) && $fstep >= 50) { ?>
										<label class="desc" id="title0" for="Field0">
											Exam/Impressions
										</label>
										<div>
											<span class="left">
												<input id="exam_impressions_apt" name="exam_impressions_apt" type="text" class="field text addr tbox" value="<?php echo $exam_impressions_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal16.popup();"/>
												<a href="javascript:cal16.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
												<label for="add1">Appointment Date </label>
											</span>
											<span class="right">
												<input id="exam_impressions_comp" name="exam_impressions_comp" type="text" class="field text addr tbox" value="<?php echo $exam_impressions_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal17.popup();" />
									...
									<?php if(($sstep >= 5) && $fstep >= 51) { ?>
										<label class="desc" id="title0" for="Field0">
											Dental Sleep Report
										</label>
										<div>
											<span class="left">
												<input id="dsr_prepared" name="dsr_prepared" type="text" class="field text addr tbox" value="<?php echo $dsr_prepared?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal74.popup();"/>
											...
											<span class="right">
												<input id="dsr_sent" name="dsr_sent" type="text" class="field text addr tbox" value="<?php echo $dsr_sent?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal75.popup();" />
									...
									<?php if(($sstep >= 5) && $fstep >= 52) { ?>
										...
										<div>
											<span class="left">
												<input id="delivery_device_apt" name="delivery_device_apt" type="text" class="field text addr tbox" value="<?php echo $delivery_device_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal22.popup();"/>
												<a href="javascript:cal22.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
												<label for="add1">Appointment Date </label>
											</span>
											<span class="right">
												<input id="delivery_device_comp" name="delivery_device_comp" type="text" class="field text addr tbox" value="<?php echo $delivery_device_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal23.popup();" />
										...
										<div>
											<span class="left">
												<input id="dsr_date_delivered" name="dsr_date_delivered" type="text" class="field text addr tbox" value="<?php echo $dsr_date_delivered?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal76.popup();"/>
										...
										<div>
											<span class="left">
												<input id="ltr_phy_prepared" name="ltr_phy_prepared" type="text" class="field text addr tbox" value="<?php echo $ltr_phy_prepared?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal77.popup();"/>
											...
											<span class="right">
												<input id="ltr_phy_sent" name="ltr_phy_sent" type="text" class="field text addr tbox" value="<?php echo $ltr_phy_sent?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal78.popup();" />
									...
									<?php if(($sstep >= 5) && $fstep >= 53) { ?>
										...
										<div>
											<span class="left">
												<input id="first_check_apt" name="first_check_apt" type="text" class="field text addr tbox" value="<?php echo $first_check_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal28.popup();"/>
												<a href="javascript:cal28.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
												<label for="add1">Appointment Date </label>
											</span>
											<span class="right">
												<input id="first_check_comp" name="first_check_comp" type="text" class="field text addr tbox" value="<?php echo $first_check_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal29.popup();" />
					 				...
					 				<?php if(($sstep >= 5) && $fstep >= 54) { ?>
										...
										<div>
											<span class="left">
												<input id="add_check_apt" name="add_check_apt" type="text" class="field text addr tbox" value="<?php echo $add_check_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal30.popup();"/>
												<a href="javascript:cal30.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
												<label for="add1">Appointment Date </label>
											</span>
											<span class="right">
												<input id="add_check_comp" name="add_check_comp" type="text" class="field text addr tbox" value="<?php echo $add_check_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal31.popup();" />
												<a href="javascript:cal30.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
												<label for="add2">Completed Date</label>
											</span>
									...
									<?php } ?>	
	  								...
	  								<?php if(($sstep >= 5) && $fstep >= 55) { ?>
										...
										<div>
											<span class="left">
												<input id="home_sleep_apt" name="home_sleep_apt" type="text" class="field text addr tbox" value="<?php echo $home_sleep_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal32.popup();"/>
												<a href="javascript:cal32.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
												<label for="add1">Appointment Date </label>
											</span>
											<span class="right">
												<input id="home_sleep_comp" name="home_sleep_comp" type="text" class="field text addr tbox" value="<?php echo $home_sleep_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal33.popup();" />
									...
									<?php } ?>	
	 								...
	 								<?php if(($sstep >= 5) && $fstep >= 56){?>
										...
										<div>
											<span class="left">
												<input id="further_checks_apt" name="further_checks_apt" type="text" class="field text addr tbox" value="<?php echo $further_checks_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal34.popup();"/>
												<a href="javascript:cal34.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
												<label for="add1">Appointment Date </label>
											</span>
											<span class="right">
												<input id="further_checks_comp" name="further_checks_comp" type="text" class="field text addr tbox" value="<?php echo $further_checks_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal35.popup();" />
									...
									<?php if(($sstep >= 5) && $fstep >= 57) { ?>	
										...
										<div>
											<span class="left">
												<input id="comp_treatment_date" name="comp_treatment_date" type="text" class="field text addr tbox" value="<?php echo $comp_treatment_date?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal79.popup();"/>
									...
									<?php if(($sstep >= 5) && $fstep >= 58) { ?>					
										<label class="desc" id="title0" for="Field0">
											Letter sent to doctors with copy of sleep study
										</label>
										<div>
											<span class="left">
												<input id="ltr_doc_ss_date_prepared" name="ltr_doc_ss_date_prepared" type="text" class="field text addr tbox" value="<?php echo $ltr_doc_ss_date_prepared?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal81.popup();"/>
											...
											<span class="right">
												<input id="ltr_doc_ss_date_sent" name="ltr_doc_ss_date_sent" type="text" class="field text addr tbox" value="<?php echo $ltr_doc_ss_date_sent?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal82.popup();" />
									...
									<?php } ?>
					 				...
					 				<?php if(($sstep >= 5) && $fstep >= 59) { ?>
										...
										<div>
											<span class="left">
												<input id="annual_exam_apt" name="annual_exam_apt" type="text" class="field text addr tbox" value="<?php echo $annual_exam_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal40.popup();"/>
												<a href="javascript:cal40.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
												<label for="add1">Appointment Date </label>
											</span>
											<span class="right">
												<input id="annual_exam_comp" name="annual_exam_comp" type="text" class="field text addr tbox" value="<?php echo $annual_exam_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal41.popup();" />
										...
										<div>
											<span class="left">
												<input id="ltr_doc_pt_date_prepared" name="ltr_doc_pt_date_prepared" type="text" class="field text addr tbox" value="<?php echo $ltr_doc_pt_date_prepared?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal87.popup();"/>
												<a href="javascript:cal87.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
												<label for="add1">Date prepared </label>
											</span>
											<span class="right">
												<input id="ltr_doc_pt_date_sent" name="ltr_doc_pt_date_sent" type="text" class="field text addr tbox" value="<?php echo $ltr_doc_pt_date_sent?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal88.popup();" />
						...
						<td valign="top" colspan="2" class="frmhead">
							<ul>
								<li id="foli8" class="complex">	
									...
									<div>
										<span class="left">
											<input id="ambulatory_ss_apt" name="ambulatory_ss_apt" type="text" class="field text addr tbox" value="<?php echo $ambulatory_ss_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal46.popup();"/>
											<a href="javascript:cal46.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
											<label for="add1">Appointment Date </label>
										</span>
										<span class="right">
											<input id="ambulatory_ss_comp" name="ambulatory_ss_comp" type="text" class="field text addr tbox" value="<?php echo $ambulatory_ss_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal47.popup();" />
									...
									<div>
										<span class="left">
											<input id="diag_s_md_sent" name="diag_s_md_sent" type="text" class="field text addr tbox" value="<?php echo $diag_s_md_sent?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal83.popup();"/>
										...
										<span class="right">
											<input id="diag_s_md_received" name="diag_s_md_received" type="text" class="field text addr tbox" value="<?php echo $diag_s_md_received?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal84.popup();" />
						...
						<td valign="top" colspan="2" class="frmhead">
							<ul>
								<li id="foli8" class="complex">	
									...
									<div>
										<span class="left">
											<input id="psg_apt" name="psg_apt" type="text" class="field text addr tbox" value="<?php echo $psg_apt?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal50.popup();"/>
											<a href="javascript:cal50.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
											<label for="add1">Appointment Date </label>
										</span>
										<span class="right">
											<input id="psg_comp" name="psg_comp" type="text" class="field text addr tbox" value="<?php echo $psg_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal51.popup();" />
									...
									<div>
										<span class="left">
											<?php 
												...
												$s_my = $db->getResults($slab_sql);
											?>
												
											<select name="sleep_lab" class="field text addr tbox">
												<option value=""></option>
												<?php if ($s_my) foreach ($s_my as $s_myarray) { ?>
													<option value="<?php echo $s_myarray["sleeplabid"];?>" <?php if($sleep_lab == $s_myarray["sleeplabid"]) { echo "selected";}?>>
														<?php echo $s_myarray["company"];?>
													</option>
												<?php } ?>
											</select>
										</span>
						...
						<td valign="top" colspan="2" class="frmhead">
							<ul>
								<li id="foli8" class="complex">	
									...
									<div>
										<span class="full">
											<input type="checkbox" name="not_candidate" value="1" <?php if($not_candidate == 1) echo " checked";?> class="field text addr tbox" style="width:30px;" />
											Not candidate
											<br /><br>		
											
											<input type="checkbox" name="financial_restraints" value="1" <?php if($financial_restraints == 1) echo " checked";?> class="field text addr tbox" style="width:30px;" />
											Financial restraints
											<br /><br>		
							
											<input type="checkbox" name="pt_needing_dental_work" value="1" <?php if($pt_needing_dental_work == 1) echo " checked";?> class="field text addr tbox" style="width:30px;" />
											Pt needing dental work
											<br /><br>		
											
											<input type="checkbox" name="inadequate_dentition" value="1" <?php if($inadequate_dentition == 1) echo " checked";?> class="field text addr tbox" style="width:30px;" />
											Inadequate dentition
											<br /><br>		
											
											Other: <input id="pt_not_ds_other" name="pt_not_ds_other" type="text" class="field text addr tbox" value="<?php echo $pt_not_ds_other?>" style="width:150px;" maxlength="255" />
										</span>
									</div>
									...
									<div>
										<span class="left">
											<input id="ltr_pp_date_prepared" name="ltr_pp_date_prepared" type="text" class="field text addr tbox" value="<?php echo $ltr_pp_date_prepared?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal85.popup();"/>
											<a href="javascript:cal85.popup();"><img src="img/cal.gif" width="16" height="16" border="0" alt="Click Here to Pick up the date"></a>
											<label for="add1">Date prepared</label>
										</span>
										<span class="right">
											<input id="ltr_pp_date_sent" name="ltr_pp_date_sent" type="text" class="field text addr tbox" value="<?php echo $ltr_pp_date_sent?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal86.popup();" />
							...
							<td valign="top" colspan="2" class="frmhead">
								<ul>
									<li id="foli8" class="complex">	
										...
										<div>
											<span class="left">
												<input id="date_referred" name="date_referred" type="text" class="field text addr tbox" value="<?php echo $date_referred?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal72.popup();"/>
											...
											<span class="right">
												<?php 
													...
													$doc_my = $db->getResults($doc_sql);
												?>
												<select name="dss_dentists" class="field text addr tbox"  style="width:250px;">
													<option value=""></option>
													<?php if ($doc_my) foreach ($doc_my as $doc_myarray) { ?>
										...
										<div>
											<span class="left">
												<select name="send_np" class="field text addr tbox">
													<option value=""></option>
													<option value="faxed" <?php if($send_np == 'faxed') echo " selected";?>>
														faxed
													</option>
													<option value="mail" <?php if($send_np == 'mail') echo " selected";?>>
														mail
													</option>
													<option value="email" <?php if($send_np == 'email') echo " selected";?>>
														email
													</option>
													<option value="internet" <?php if($send_np == 'internet') echo " selected";?>>
														internet 
													</option>
												</select>
											...
											<span class="right">
												<input id="send_np_comp" name="send_np_comp" type="text" class="field text addr tbox" value="<?php echo $send_np_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal3.popup();" />
						...
						<td valign="top" colspan="2" class="frmhead">
							<ul>
								<li id="foli8" class="complex">	
									...
									<div>
										<span class="left">
											<input id="inquiry_call_comp" name="inquiry_call_comp" type="text" class="field text addr tbox" value="<?php echo $inquiry_call_comp?>" style="width:150px;" maxlength="255" readonly="readonly" onclick="javascript:cal1.popup();" />

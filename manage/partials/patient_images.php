<table width="98%" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" align="center" class="table table-bordered table-hover">
        <tr class="tr_bg_h">
                <th valign="top" class="col_head <?= ($_REQUEST['sort'] == 'imagetypeid')?'arrow_'.strtolower($_REQUEST['sortdir']):''; ?>" width="15%">
                ...
                <th valign="top" class="col_head <?= ($_REQUEST['sort'] == 'title')?'arrow_'.strtolower($_REQUEST['sortdir']):''; ?>" width="25%">
                ...
                <th valign="top" class="col_head <?= ($_REQUEST['sort'] == 'adddate')?'arrow_'.strtolower($_REQUEST['sortdir']):''; ?>" width="15%">
                ...
                <th valign="top" class="col_head <?= ($_REQUEST['sort'] == 'added_by')?'arrow_'.strtolower($_REQUEST['sortdir']):''; ?>" width="15%">
                        <a href="<?= $_SERVER['PHP_SELF']; ?>?<?= isset($_GET['pid'])?"pid=".$_GET['pid']."&":''; ?>sort=added_by&sortdir=<?php echo ($_REQUEST['sort']=='added_by'&&$_REQUEST['sortdir']=='ASC')?'DESC':'ASC'; ?>">Added By</a>
                </th>

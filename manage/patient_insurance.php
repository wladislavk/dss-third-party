<?php namespace Ds3\Legacy; ?><link rel="stylesheet" type="text/css" href="css/manage_display_similar.css">
<?php
...
<table width="98%" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" align="center" >
	...
	<tr class="<?php echo (!empty($tr_class) ? $tr_class : '');?> <?php echo (!empty($myarray['viewed']))?'':'unviewed'; ?>">
		...
		<td valign="top">
			<a href="#" onclick="loadPopup('view_patient_insurance.php?id=<?php echo $myarray["id"]; ?>'); return false;" class="editlink" title="EDIT">
				View
			</a> 

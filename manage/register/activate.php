...
<body>
    <div id="login_container">
        ...
        <div class="login_content" id="first2_sect">
            ...
            <p id="sent_text" class="error"><?php echo  $error; ?></p>
            <div class="field">
                <label>Email Address</label>
                <span>
                    <a href="#" onclick="$('#text_instructions').show('slow');">Didn't receive a text message?</a>
                </span>
                <div style="display:none;" id="text_instructions">
                    <p>Didn't receive a text message from us? Don't worry. Click here and we'll send a new text message to your phone number ending in -<?php echo  substr($r['phone'], strlen($r['phone'])-2); ?>.</p>
                    <button class="fr" onclick="send_text('button', this, <?php echo  $_GET['id']; ?>, '<?php echo  $_GET['hash']; ?>', <?php echo  substr($r['phone'], strlen($r['phone'])-2); ?>)">Text Access Code</button>
                </div>
                <input value="<?php echo  $r['email']; ?>" type="text" readonly="readonly" id="email" />
            </div>
            <div class="field">
            ...
            <div class="field half">
                <button class="fr" onclick="register()">Register</button>
            </div>
        </div>
    </div>
    ...
    <div style="display:none">
        <div id="saas_agree">
            ...
            <h4>DENTAL SLEEP SOLUTIONS FRANCHISING LLC</h4>
        	...
        	<p>This Software as a Service Agreement (the "Agreement") is a legal agreement between you and Dental Sleep Solutions Franchising LLC, a Florida limited liability company ("Provider"), governing your use of the Dental Sleep Solutions Practice Manager software (the Software") as a hosted solution via Provider's web site (www.dentalsleepsolutions.com) (the "Service"). The term "You" or "you" means the individual or entity who is using the Service under this Agreement.  The term "use" means accessing, displaying, executing, loading or otherwise using the Service. </p>
        	<p>Service License.  You are granted a nonexclusive, nontransferable, revocable, limited license to use the Service for your internal business purposes in accordance with this Agreement during the Term.</p>
        	<p>Scope of License.  This Agreement grants you up to ten (10) user accounts that will allow you to use the Service.  One (1) account will have administrative permissions, which will provide the user the ability to make global changes, such as password management and ledger/financial correction.  Up to nine (9) other accounts will have general use (non-administrative) permissions.  Any additional users are subject to additional fees, as determined by Provider.</p>
            <p>Equipment.  You are responsible for and must provide all equipment, software (other than any software provided by Provider) and services necessary to use the Service.  The Software may currently be accessed by any modern browser.  However, at some point in the future, Provider may elect to provide you with a custom browser to be installed on your computer in order to access the Software (the "Custom Browser"), for purposes of enhancing Software security.  You agree to promptly install any such Custom Browser on behalf of all users hereunder.</p>  
            <p>Privacy.  Provider will not sell, exchange, or release any confidential patient information you upload to the Service to a third party without your express permission, unless required by law or court or governmental order; provided that Provider may disclose such information to a third party to the extent necessary to perform Provider’s obligations under this Agreement and the Franchise Agreement (as defined below) (e.g. sending patient information to an insurer in connection with an insurance claim). Provider may contact you regarding account status and other matters relevant to the underlying Service and/or may use your confidential information, including without limitation your patient treatment data statistics, for purposes of making suggestions and recommendations to you in connection with the relationship contemplated under the Franchise Agreement.  Both you and Provider agree to adhere to data security standards of the Health Insurance Portability and Accountability Act of 1996 ("HIPAA").</p> 
            <p>Endorsements.  All product and service marks contained on or associated with the Service that are not Provider marks are the trademarks of their respective owners. References to any names, marks, products or services of third parties or hypertext links to third party sites or information do not necessarily constitute or imply Provider's endorsement, sponsorship or recommendation of the third party, information, product or service. </p>
        	<p>Ownership.  You acknowledge and agree that the Provider company names and logos and all related product and service names, design marks and slogans (collectively, the "Marks"), and the Service, including all underlying software or other intellectual property are the property of Provider, its affiliates or its third party suppliers, as applicable.  You are not authorized to use any of the Marks in any advertising, publicity or any other commercial manner without the prior written consent of Provider, except as expressly set forth in the Franchise Agreement. Your use of the Service confers no title or ownership in the Service, Software, Materials (as defined below) or Marks and is not a sale of any rights in the Service, Software, Materials or Marks.  All copyright, patent, trademark, trade secret and other intellectual property rights in the Software, Service, Materials and Marks remain in Provider or its third party suppliers, as the case may be.</p> 
        	<p>Usage Restrictions. You warrant that you will not access or use the Service in any unlawful manner, for any unlawful purpose or in violation of these terms and conditions or applicable laws, rules and regulations.  You agree that you will be responsible for all usage of the Service through your account, whether or not authorized by you.</p>  
            <p>Except to the extent permitted above, you may not: permit other individuals to use the Service; modify, translate, reverse engineer, decompile, disassemble, or create derivative works based on any product, service, information, content, software, message, advertisement or any other work found at, aggregated at, contained on, distributed through, linked to or from, downloaded to or from or in any other manner accessed from the Service, including without limitation any Custom Browser (the "Materials"); copy (including copying onto a bulletin board or similar system) the Service or Materials other than as specified herein; rent, lease, grant a security interest in, or otherwise transfer rights to the Service or Materials or remove any proprietary notices or labels on the Service and Materials. With regard to any Materials in which Provider or any affiliate or third party supplier of Provider claims a proprietary interest and which are offered for downloading from the Service, you may download one copy of such Materials on any single computer for your personal or internal business use, provided you keep intact all copyright and other proprietary notices. </p> 
            <p>Your Risks.  Provider acts solely as an operator of the Service for your convenience, and use of the Service and any reliance by you upon any Materials, including any action taken by you because of such use or reliance, is at your sole risk.  Neither Provider nor any of its underlying suppliers, service providers, business partners, licensors, employees, distributors or agents is responsible or liable for, or makes any representations or warranties as to: <br />
            ...
            B.	The timeliness, accuracy, reliability, completeness, legality, copyright compliance or decency of the Service or any Materials; <br />
            C.	Any inaccuracy, omission, error or delay in the Service or any Materials; <br />
    ...
    <div style="display:none">
        <div id="hipaa_agree">
            ...
            3. Effect of Termination.<br />
            	a. Except as provided in paragraph E.3(b) of this section, upon termination of this Agreement, for any reason, Business Associate shall return or destroy all Protected Health Information received from Covered Entity, or created or received by Business Associate on behalf of Covered Entity. This provision shall apply to Protected Health Information that is in the possession of subcontractors or agents of Business Associate. Business Associate shall retain no copies of the Protected Health Information.<br />
            	b. In the event that Business Associate determines that returning or destroying the Protected Health Information is infeasible, Business Associate shall provide to Covered Entity notification of the conditions that make return or destruction infeasible. Upon notification to Covered Entity that return or destruction of Protected Health Information is infeasible, Business Associate shall extend the protections of this Agreement to such Protected Health Information and limit further uses and disclosures of such Protected Health Information to those purposes that make the return or destruction infeasible, for so long as Business Associate maintains such Protected Health Information.<br />
            G. Miscellaneous Terms.<br />
            	1. State Law. If state law applicable to the relationship between Business Associate and Covered Entity contains additional or more stringent requirements than federal law for Business Associates regarding any aspect of PHI privacy, then Business Associate agrees to comply with the higher standard contained in applicable state law.<br />
            	2. Consideration. Business Associate recognizes that the promises it has made in this Agreement shall, henceforth, be detrimentally relied upon by Covered Entity in choosing to continue or commence a business relationship with Business Associate.<br />
                3. Modification. This Agreement may only be modified through a writing signed by the Parties and, thus, no oral modification hereof shall be permitted. The Parties agree to take such action as is necessary to amend this Agreement from time to time as is necessary for Covered Entity to comply with the requirements of the Privacy Rule and the Health Insurance Portability and Accountability Act of 1996, as amended.<br />

            ...
            <span class="large"><?php echo $pagenum++; ?>. Payment Info</span>
				...
				<div id="register" class="wizard" style="height:1400px;">
					<div class="items formEl_a">
                      ...
                      <div class="sepH_b">
                        <label class="lbl_a"><strong>4.</strong> Email: <span class="req">*</span></label>
                        <input class="inpt_a validate" type="text" id="email" name="email" value="" />
                      </div>
                      <div class="sepH_b clear">
                        <label class="lbl_a"><strong>5.</strong> Cell Phone: <span class="req">*</span></label>
                        <input class="inpt_a validate phonemask" type="text" id="cell_phone" name="cell_phone" value="" />
                      </div>
                      <div class="sepH_b clear">

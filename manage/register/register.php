										...
										<div class="pageInside">
											<div class="cf">
												<div class="dp25">
													...
													<p class="s_color small">Please complete these fields using the name of the dental provider and practice location as they appear on your Tax Statements. These fields must be completed accurately in order to ensure accurate filing of insurance claims.</p>
												</div>
												<div class="dp75">
													<div>
                                                                                ...
                                                                                <div class="pageInside">
                                                                                        <div class="cf">
                                                                                                <div class="dp25">
                                                                                                        ...
                                                                                                        <p class="s_color small">This information will be used on all correspondence and mailing materials generated by the software. Please complete these fields as you would like them to appear on all correspondence sent to patients and physicians.</p>
                                                                                                </div>
                                                                                                <div class="dp75">
                                                                                                        <div>
                                                                                ...
                                                                                <div class="pageInside">
                                                                                        <div class="cf">
                                                                                                <div class="dp25">
                                                                                                        ...
                                                                                                        <p class="s_color small">You must provide this information in order for auto-filing of medical insurance and patient verification of benefits. If you do not provide this information many features of the software will be disabled. If you do not have a Medicare DME number please leave this field blank. If you do not have this information you can contact us to provide it later.</p>
                                                                                                </div>
                                                                                                <div class="dp75">
                                                                                                        <div>
                                                                                                                <div class="form_errors" style="display:none"></div>
                                                                                ...
                                                                                <div class="pageInside">
                                                                                        <div class="cf">
                                                                                                <div class="dp25">
                                                                                                        ...
                                                                                                        <p class="s_color small">Please create a username and password for your account. Please store your username and password in a secure place - you will use this information to access the software.</p>
                                                                                                </div>
                                                                                                <div class="dp75">
                                                                                                        <div>
                                                                                                                <div class="form_errors" style="display:none"></div>
...
<div class="page">
										<div class="pageInside">
											<div class="last sepH_c">
												...
												<p  class="sepH_b">You have successfully registered your software account! Click the button below to log on, and use your username and password to log on in the future.</p>

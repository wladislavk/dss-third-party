...
if($_POST['selsub'] == 1)
{
	...
	<script type="text/javascript">	
		parent.document.q_page1frm.additional_paragraph.value = '<?=st($_POST['description']);?>';
...
<script type="text/javascript">
	function change_desc(document.Form.title.options[document.Form.title.options.selectedIndex].value)
	{
		if(fa != '')
		{
			...
			document.selfrm.description.value = desc_arr[fa];
			fa = ;
      document.write(fa); 
		}
		else
		{
			document.selfrm.description.value = "";
		}
	}
	
</script>

<form name="selfrm" action="<?=$_SERVER['PHP_SELF']?>" method="post" onsubmit="return selabc(this)">

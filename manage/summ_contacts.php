...
<table width="100%">
  ...
  <tr>
    <td>Primary Care</td>
    <td><a href="#" onclick="loadPopup('add_contact.php?ed=<?= $docpcp_id; ?>'); return false;"><?= $docpcp_name; ?></a></td>
    <td><?= $docpcp_phone; ?></td>
    <td><?= $docpcp_fax; ?></td>
  ...
  <tr>
    <td>Sleep Doctor</td>
    <td><a href="#" onclick="loadPopup('add_contact.php?ed=<?= $docsleep_id; ?>'); return false;"><?= $docsleep_name; ?></a></td>
  ...
  <tr>
    <td>Dentist</td>
    <td><a href="#" onclick="loadPopup('add_contact.php?ed=<?= $docdentist_id; ?>'); return false;"><?= $docdentist_name; ?></a></td>
  ...
  <tr>
    <td>ENT</td>
    <td><a href="#" onclick="loadPopup('add_contact.php?ed=<?= $docent_id; ?>'); return false;"><?= $docent_name; ?></a></td>
    <td><?= $docent_phone; ?></td>
    <td><?= $docent_fax; ?></td>
    <td><a href="new_letter.php?pid=<?= $_GET['pid']; ?>">Write Letter</a></td>
  </tr>
  <tr>
    <td>MD Other</td>
    <td><a href="#" onclick="loadPopup('add_contact.php?ed=<?= $docmdother_id; ?>'); return false;"><?= $docmdother_name; ?></a></td>
  ...
  <tr>
    <td>MD Other 2</td>
    <td><a href="#" onclick="loadPopup('add_contact.php?ed=<?= $docmdother2_id; ?>'); return false;"><?= $docmdother2_name; ?></a></td>
  ...
  <tr>
    <td>MD Other 3</td>
    <td><a href="#" onclick="loadPopup('add_contact.php?ed=<?= $docmdother3_id; ?>'); return false;"><?= $docmdother3_name; ?></a></td>

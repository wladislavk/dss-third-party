...
<?php
if ($other_history != '') { ?>
    <label class="desc" id="title0" for="Field0" style="width:90%;">Medical History</label>
    <div>
        <span>
            <span id="h_det" ><?= $other_history; ?></span>
        </span>
    </div>
    <?php
} ?>
    <br />
    <label class="desc" id="title0" for="Field0">Dental History</label>
    <table width="90%">
        <?php
        if ($dental_health != '') { ?>
            <tr>
        ...
        if ($wisdom_extraction == 'Yes' || $wisdom_extraction_text != '') { ?>
            <tr>
                ...
                <td id="wisdom_extraction_extra">Please describe: <?= $wisdom_extraction_text; ?></td>
            </tr>
            <?php
        }
        if ($removable == 'Yes' || $removable_text != '') { ?>
            <tr>
                ...
                <td><?= $removable; ?></td>
                <td id="removable_extra">Please describe: <?= $removable_text; ?></td>
            </tr>
            <?php
        }
        if ($dentures == 'Yes' || $dentures_text != '') { ?>
            <tr>
                ...
                <td><?= $dentures; ?></td>
                <td id="dentures_extra">Please describe: <?= $dentures_text; ?></td>
            </tr>
            <?php
        }
        if ($orthodontics == 'Yes' || $year_completed != '') { ?>
            <tr>
                ...
                <td><?= $orthodontics;?></td>
                <td id="orthodontics_extra">Year completed: <?= $year_completed;?></td>
            </tr>
            <?php
        }
        if ($tmj_cp == 'Yes' || $tmj_cp_text != '') { ?>
            <tr>
                ...
                <td><?= $tmj_cp;?></td>
                <td id="tmj_cp_extra">Please describe: <?= $tmj_cp_text; ?></td>
            </tr>
            <?php
        }
        if ($tmj_pain == 'Yes' || $tmj_pain_text != '') { ?>
            <tr>
                ...
                <td><?= $tmj_pain; ?></td>
                <td id="tmj_pain_extra">Please describe: <?= $tmj_pain_text; ?></td>
            </tr>
            <?php
        }
        if ($tmj_surgery == 'Yes' || $tmj_surgery_text != '') { ?>
            <tr>
                ...
                <td><?= $tmj_surgery;?></td>
                <td id="tmj_surgery_extra">Please describe: <?= $tmj_surgery_text; ?></td>
            </tr>
            <?php
        }
        if ($gum_prob == 'Yes' || $gum_prob_text != '') { ?>
            <tr>
                ...
                <td><?= $gum_prob;?></td>
                <td id="gum_prob_extra">Please describe: <?= $gum_prob_text; ?></td>
            </tr>
            <?php
        }
        if ($gum_surgery == 'Yes' || $gum_surgery_text != '') { ?>
            <tr>
                ...
                <td><?= $gum_surgery; ?></td>
                <td id="gum_surgery_extra">Please describe: <?= $gum_surgery_text; ?></td>
            </tr>
            <?php
        }
        if ($drymouth == 'Yes' || $drymouth_text != '') { ?>
            <tr>
                ...
                <td><?= $drymouth; ?></td>
                <td id="drymouth_extra">Please describe: <?= $drymouth_text; ?></td>
            </tr>
            <?php
        }
        if ($injury == 'Yes' || $injury_text != '') { ?>
            <tr>
                ...
                <td><?= $injury; ?></td>
                <td id="injury_extra">Please describe: <?= $injury_text; ?></td>
            </tr>
            <?php
        }
        if ($completed_future == 'Yes' || $future_dental_det != '') { ?>
            <tr>
                ...
                <td id="completed_future_extra">Please describe: <?= $future_dental_det; ?></td>
            </tr>
            <?php
        }
        if (!empty($clinch_teeth) && ($clinch_teeth == 'Yes' || $clinch_grind_text != '')) { ?>
            <tr>
                ...
                <td><?= $clinch_grind; ?></td>
                <td id="clinch_grind_extra">Please describe: <?= $clinch_grind_text; ?></td>
            </tr>
            <?php
        } ?>
    </table>
    ...
    if ($smoke != '') { ?>
        ...
        <?= $smoke; ?>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <div id="smoke">If Yes, number of packs per day<?= $smoke_packs ?></div>
        <br /><br />
        <?php
    }
    if ($tobacco != '') { ?>
...
<label class="desc" id="title0" for="Field0">
    <span class="form_info">DENTAL SCREENING</span>
</label>
<?php
if ($missing != '') { ?>
    <div>
...
<label class="desc" id="title0" for="Field0">EXAMINATION OF TEETH REVEALED</label>
<div>
    <span>
        <?php
    ...
    <div>
        <span class="left">
            <table width="100%" cellpadding="3" cellspacing="1" border="0">
                <tr>
                    <td valign="top" colspan="2" align="center" style="font-size:16px;">Right</td>
                </tr>
                <tr>
                    <td valign="top" width="60%"><u>Class</u></td>
                    <td valign="top" width="40%"><u>Division</u></td>
                </tr>
                <tr>
                    <td valign="top"><?= $dental_class_right; ?></td>
                    <td valign="top"><?= $dental_division_right; ?></td>
                </tr>
            </table>
        </span>
        <span class="left">
            <table width="100%" cellpadding="3" cellspacing="1" border="0">
                <tr>
                    <td valign="top" colspan="2" align="center" style="font-size:16px;">Left</td>
                </tr>
                <tr>
                    <td valign="top" width="60%"><u>Class</u></td>
                    <td valign="top" width="40%"><u>Division</u></td>
                ...
                <tr>
                    <td valign="top"><?= $dental_class_left; ?></td>
                    <td valign="top"><?= $dental_division_left; ?></td>
                </tr>
            </table>
        </span>
    </div>
...
<?php
if ($additional_paragraph != '') { ?>
    <label class="desc clear" id="title0" for="Field0">Other Items:</label>
    <div>
        <span><?= $additional_paragraph; ?></span>
    </div>
    <br />
    <?php
} ?>
<label class="desc" id="title0" for="Field0">TOOTH CONTACT PRIOR TO ORAL APPLIANCE</label>
<?php
if ($crossbite != '') { ?>
    <div>
        <span>
...
?>
<label class="desc" id="title0" for="Field0">VITAL DATA</label>
<?php
if ($blood_pressure != '') { ?>
    <div>
        <span>
...
<label class="desc" id="title0" for="Field0">HEIGHT/WEIGHT</label>
<?php
if ($feet != '') {
    echo $feet; ?>
...
if ($tongue != "" || $additional_paragraph != "") { ?>
    ...
    <?php
    if ($additional_paragraph != '') { ?>
        <label class="desc" id="title0" for="Field0">Additional Paragraph</label>
        <div>
            <span><?= $additional_paragraph; ?></span>
        </div>
        <br />
...
<div class="half">
    <label class="desc" id="title0" for="Field0">TONSILS</label>
    <?php
    if ($tonsils != '') { ?>
        <div>
            <span>
...
?>
<label class="desc" id="title0" for="Field0">
    <span class="form_info">OTHER AIRWAY ITEMS</span>
</label>
<?php 
if ($maxilla != "" || $other_maxilla != "") { ?>
    <label class="desc" id="title0" for="Field0">Maxilla</label>
    <div class="cb_half">
        <span>
            <?php
...
if ($mandible != '' || $other_mandible != '') { ?>
    <label class="desc" id="title0" for="Field0">Mandible</label>
    <div class="cb_half">
        <span>
            <?php
...
if ($soft_palate != '' || $other_soft_palate != '') { ?>
    <label class="desc" id="title0" for="Field0">Soft Palate</label>
    <div class="cb_half">
        <span>
            <?php
...
if ($uvula != '' || $other_uvula != '') { ?>
    <label class="desc" id="title0" for="Field0">Uvula</label>
    <div class="cb_half">
        <span>
            <?php
...
if ($gag_reflex != '' || $other_gag_reflex != '') { ?>
    <label class="desc" id="title0" for="Field0">Gag Reflex</label>
    <div class="cb_half">
        <span>
            <?php
...
if ($nasal_passages != '' || $other_nasal_passages != '') { ?>
    <label class="desc" id="title0" for="Field0">Nasal Passages</label>
    <div class="cb_half">
        <span>
            <?php
    ...
    if ($other_nasal_passages != '') { ?>
        <div class="ta_half">
            <span><?= $other_nasal_passages; ?></span>
        </div>
        <br />
        <?php
    }
...
?>
<label class="desc" id="title0" for="Field0">Muscles & Manual Palpation</label>
<br />
<div align="right" style="text-align:right; float:right;">
    <span class="ex_p5_0">0 - No Tenderness</span>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <span class="ex_p5_1" style="padding-left:10px;">1 - Mild</span>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <span class="ex_p5_2"  style="padding-left:10px;">2 - Moderate</span>
    &nbsp;&nbsp;&nbsp;
    <span class="ex_p5_3" style="padding-left:10px;" >3 - Severe</span>
</div>
<div id="topcb">
    <span class="full">
        <table width="80%" cellpadding="3" cellspacing="1" border="0">
            <tr>
                <td valign="top" width="20%">Left</td>
                <td valign="top" width="20%">Right</td>
            ...
            foreach ($palpation_my as $palpation_myarray) {
                $chk = '';
                if (($searchResult = @array_search($palpation_myarray['palpationid'], $palid)) !== false) {
                    $chk = (!empty($palseq) ? $palseq[$searchResult] : '');
                }
                $chkR = '';
                if (($searchResult = @array_search($palpation_myarray['palpationid'], $palRid)) !== false) {
                    $chkR = (!empty($palRseq) ? $palRseq[$searchResult] : '');
                }
                if ($chk != '' || $chkR != '') { ?>
                    <tr>
                        <td valign="top"><?= $chk; ?></td>
                        <td valign="top"><?= $chkR;?></td>
                        <td valign="top">
                            <span><?= st($palpation_myarray['palpation']); ?></span>
                        </td>
                    </tr>
                    <?php
                }
...
if ($additional_paragraph_pal != '') { ?>
    ...
    <div>
        <span><?= $additional_paragraph_pal; ?></span>
    </div>
    <br />
    <?php
} ?>
                ...
                <td valign="top">
                    <table width="100%" cellpadding="3" cellspacing="1">
                        ...
                        foreach ($joint_my as $joint_myarray) {
                            $chkJ = '';
                            if (($searchResult = @array_search($joint_myarray['jointid'], $joid)) !== false) {
                                $chkJ = (!empty($joseq) ? $joseq[$searchResult] : '');
                            }
                            if ($chkJ != '') { ?>
                                <tr>
                                    <td valign="top" width="40%">
                                        <span><?= st($joint_myarray['joint']); ?></span>
                                    </td>
                                    <td valign="top"><?= $chkJ; ?></td>
                                </tr>
                                <?php
                            }
                        } ?>
...
<label class="desc" id="title0" for="Field0">Range Of Motion</label>
<div>
    <span>
        <table width="100%" cellpadding="3" cellspacing="1">
            <?php
            if ($i_opening_from != '') { ?>
                <tr>
                    <td valign="top">
                        <span>Interincisal Opening</span>
                    </td>
                    <td valign="top">
                        <span><?= $i_opening_from; ?></span>
                    </td>
                </tr>
                <?php
            }
            if ($protrusion_from != '' || $protrusion_to != '') { ?>
                ...
                <tr>
                    <td valign="top">
                        <span>Protrusion (Automatically calculated from George Gauge above)</span>
                    </td>
                    <td valign="top">
                        <span><?= abs($protrusion_to - $protrusion_from); ?></span>
                     </td>
                </tr>
                <?php
            }
            if ($l_lateral_from != '') { ?>
                <tr>
                    <td valign="top">
                        <span>Left Lateral Excursion</span>
                    </td>
                    <td valign="top">
                        <span><?= $l_lateral_from; ?></span>
                    </td>
                </tr>
                <?php
            }
            if ($r_lateral_from != '') { ?>
                <tr>
                    <td valign="top">
                        <span>Right Lateral Excursion</span>
                    </td>
                    <td valign="top">
                        <span><?= $r_lateral_from; ?></span>
                    </td>
                </tr>
                <?php
            }
...
<br />
<?php
if ($additional_paragraph_rm != '') { ?>
    <label class="desc" id="title0" for="Field0">Additional Paragraph</label>
    <div>
        <span><?= $additional_paragraph_rm; ?></span>
    </div>
    <br />
    <?php
} ?>
<label class="desc" id="title0" for="Field0">Craniomandibular Screening</label>
<div>
    <span>
        <?php

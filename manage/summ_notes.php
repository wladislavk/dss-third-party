<button onclick="Javascript: loadPopup('add_notes.php?pid=<?php echo $_GET['pid'];?>');" class="addButton" style="float: right;">
...
<a href="print_notes.php?pid=<?php echo $_GET['pid'];?>" target="_blank" class="addButton" style="float: left;">

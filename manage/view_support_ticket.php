...
<div style="width:96%; margin:0 auto;">
  <div id="support_ticket">
    <span class="admin_head">
    	<?php echo $t['title']." - ".$company_name; ?>
    </span>
    <br />
    <br />
    <div class="response_type_<?php echo $t['create_type']; ?>">
      <?php echo $t['body'];
if($t['attachment']!=''){?>
...
echo date('m/d/Y h:i:s a', strtotime($t['adddate'])); ?>
      </div>
    </div>
  </div>
...
<?php 
if($t['status']==DSS_TICKET_STATUS_OPEN || $t['status'] == DSS_TICKET_STATUS_REOPENED){ ?>

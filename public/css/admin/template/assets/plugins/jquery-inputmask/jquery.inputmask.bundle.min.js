...
!0,!1,H.explode("")),d.click()):g!=f.keyCode.INSERT||a.shiftKey||a.ctrlKey?!1!=f.insertMode||a.shiftKey||(g==f.keyCode.RIGHT?setTimeout(function(){var a=w(c);w(c,a.begin)},0):g==f.keyCode.LEFT&&setTimeout(function(){var a=w(c);w(c,a.begin-1)},0)):(f.insertMode=!f.insertMode,w(c,f.insertMode||h.begin!=q()?h.begin:h.begin-1));d=w(c);!0===f.onKeyDown.call(this,a,n(),f)&&w(c,d.begin,d.end);fa=-1!=e.inArray(g,f.ignorables)}function W(b,d,g,h,k,t){if(void 0==g&&Y)return!1;Y=!0;var m=e(this);b=b||window.event;
...
this._valueGet=void 0}}});case "getemptymask":return this.data("_inputmask")?(g=this.data("_inputmask").masksets,h=this.data("_inputmask").activeMasksetIndex,g[h]._buffer.join("")):"";case "hasMaskedValue":return this.data("_inputmask")?!this.data("_inputmask").opts.autoUnmask:!1;case "isComplete":return g=this.data("_inputmask").masksets,h=this.data("_inputmask").activeMasksetIndex,f=this.data("_inputmask").opts,m(g,h,f,{action:"isComplete",buffer:this[0]._valueGet().explode("")});case "getmetadata":if(this.data("_inputmask"))return g=

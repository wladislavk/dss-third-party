...
<h4 class="modal-title">Add New Access Code</h4><br/><br/>
 <form name="contacttypefrm" action="/manage/admin/accesscode/new" method="post" onsubmit="return accesscodeabc(this)">
     <table class="table table-bordered table-hover">
         ...
         <tr bgcolor="#FFFFFF">
             ...
             <td valign="top" class="frmdata">
                 <input type="text" name="access_code" value="" class="form-control">
                 <span class="red">*</span>
             </td>
         </tr>
         <tr bgcolor="#FFFFFF">
         ...
         <tr bgcolor="#FFFFFF">
             ...
             <td valign="top" class="frmdata">
                 ...
                 {!! Form::select('plan_id',$plans,'',['class'=>'form-control']) !!}
             </td>
         </tr>
         <tr bgcolor="#FFFFFF">
             <td valign="top" class="frmhead">

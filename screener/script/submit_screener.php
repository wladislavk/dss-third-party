...
$rx_tongue = $_REQUEST['rx_tongue'];
$rx_reflux = $_REQUEST['rx_reflux'];
$rx_hypertension = $_REQUEST['rx_hypertension'];
$rx_jaw = $_REQUEST['rx_jaw'];
$rx_tonsils = $_REQUEST['rx_tonsils'];
$rx_heart = $_REQUEST['rx_heart'];
$rx_pallet = $_REQUEST['rx_pallet'];
$rx_metabolic = $_REQUEST['rx_metabolic'];
$rx_stroke = $_REQUEST['rx_stroke'];
$rx_bruxism = $_REQUEST['rx_bruxism'];
...
$s = "INSERT INTO dental_screener SET
	...
	rx_tongue = '".mysql_real_escape_string($rx_tongue)."',
        rx_reflux = '".mysql_real_escape_string($rx_reflux)."',
        rx_hypertension = '".mysql_real_escape_string($rx_hypertension)."',
        rx_jaw = '".mysql_real_escape_string($rx_jaw)."',
        rx_tonsils = '".mysql_real_escape_string($rx_tonsils)."',
        rx_heart = '".mysql_real_escape_string($rx_heart)."',
        rx_pallet = '".mysql_real_escape_string($rx_pallet)."',
        rx_metabolic = '".mysql_real_escape_string($rx_metabolic)."',
        rx_stroke = '".mysql_real_escape_string($rx_stroke)."',
        rx_bruxism = '".mysql_real_escape_string($rx_bruxism)."',

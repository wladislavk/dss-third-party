<?php namespace Ds3\Libraries\Legacy; ?>ALTER TABLE dental_users ADD COLUMN access_code varchar(100);
...
ALTER TABLE dental_users ADD COLUMN registration_email_date datetime;

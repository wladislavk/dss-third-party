...
INSERT INTO dental_locations (location, docid, name, address, city, state, zip, phone, default_location) SELECT mailing_practice, userid, mailing_name, mailing_address, mailing_city, mailing_state, mailing_zip, mailing_phone, '1' FROM dental_users where docid=0;

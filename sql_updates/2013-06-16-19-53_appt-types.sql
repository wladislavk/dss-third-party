...
--
-- Host: localhost    Database: dentalsl_main_dev
-- ------------------------------------------------------
...
INSERT INTO `dental_appt_types` VALUES (1,'General','FFF9CF','general'),(2,'Follow-up','D6CFFF','follow-up'),(3,'Sleep Test','CFF5FF','sleep_test'),(4,'Impressions','DFFFCF','impressions'),(5,'New Pt','FFCFCF','new_pt'),(6,'Deliver Device','FBA16C','deliver_device');
...
-- Dump completed on 2013-06-16 19:53:06

                                ...
                                <div>
                                    <span>
                                        <select
                                            ...
                                            tabindex="20"
                                        >
                                            <option value="0" disabled>Select a contact type</option>
                                            <option
                ...
                <template v-if="contact.contacttypeid && contact.contacttypeid > 0">
                    ...
                    <tr class="content physician insurance other">
                        <td valign="top" colspan="2" class="frmhead">
                            <ul>
                                <li id="foli8" class="complex">
                                    <label class="desc" id="title0" for="Field0">Notes:</label>
                                    <div>
                                        <span class="full">
                                            <textarea
                    ...
                    <tr bgcolor="#FFFFFF" class="content physician insurance other">
                        <td valign="top" class="frmhead">Preferred Contact Method</td>
                        <td valign="top" class="frmdata">
                            <select
                                ...
                                tabindex="22"
                            >
                                <option value="default" disabled>Select a method</option>
                    ...
                    <tr bgcolor="#FFFFFF" class="content physician insurance other">
                        <td valign="top" class="frmhead">Status</td>
                        <td valign="top" class="frmdata">
                            <select
                    ...
                    <tr class="content physician insurance other">
                        <td colspan="2" align="center">
                            ...
                            <template v-if="contact.contactid > 0">
                                <a
                                    style="float:right;"
                                    v-bind:href="legacyUrl + 'duplicate_contact.php?winner=' + contact.contactid"
                                    title="Duplicate"

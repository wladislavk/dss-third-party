                                ...
                                <div id="profile_image" style="float:right; width:270px;">
                                    <span style="float:right">
                                        ...
                                        <img
                                            ...
                                            style="max-height:150px;max-width:200px;float:right;"
                                        />
                                    </span>
                                </div>
                                ...
                                <div>
                                    ...
                                    <span>
                                        <select
                                            ...
                                            tabindex="6"
                                        >
                                            <option value="-1" disabled>Inches</option>
                                            <option
                                                v-for="i in inches"
                                                :value="i"
                                            >{{ i }}</option>
                                    ...
                                    <span>
                                        <select
                                            ...
                                            tabindex="7"
                                        >
                                            <option value="0" disabled>Weight</option>
                                            <option
                                                v-for="i in weight"
                                                :value="i"
                                            >{{ i }}</option>

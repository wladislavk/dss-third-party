...
<div id="header" >
    <div class="wrapper cf">
        ...
        <ul id="main_nav" class="fr">
            <li class="nav_item lgutipT" title="start over" style="display:none;" id="restart_nav">
                <a href="index.php" class="main_link" onclick="return confirm('Are you sure? All current progress will be lost.');">
                    <img class="img_holder" style="background-image: url(images/images/icons/refresh.png)" alt="" src="images/blank.gif"/>
                    <span>Reset and Start Over</span>
                </a>
            </li>
            <li class="nav_item lgutipT" title="Log Out">
                <a href="logout.php" onclick="return confirm('Are you sure you want to logout?')" class="main_link">
            ...
            <form class="formEl_a screener">
                ...
                <div class="sect" id="sect0">
                    <div class="dp50">
                        ...
                        <p style="font-size:14px;">
                            More than 20 million Americans suffer from Obstructive Sleep Apnea (OSA). Despite this high prevalence, 93% of women and 82% of men with moderate to severe OSA remain UNDIAGNOSED and UNAWARE that they have a deadly disease.<br />
                    ...
                    <div class="formEl_a">
                        <div class="dp66">
                            ...
                            <div class="sepH_b clear" id="epworth_<?= $epworth_myarray['epworthid']; ?>_div">
                                <select class="inpt_in epworth_select" id="epworth_<?=$epworth_myarray['epworthid']; ?>" name="epworth_<?= $epworth_myarray['epworthid']; ?>">
                ...
                <div class="sect" id="sect3">
                    ...
                    <div class="sepH_b" id="breathing_div">
                        <div class="buttonset">
                            <input type="radio" id="breathing1" name="breathing" value="8" />
                            <label for="breathing1">Yes</label>
                            <input type="radio" id="breathing2" name="breathing" value="0" />
                            <label for="breathing2">No</label>
                        </div>

...
class CustomsApiTest extends TestCase
{
     ...
     * Post to /api/v1/customs -> Api/ApiCustomsController@store method
     * 
     */
     ...
     * Put to /api/v1/customs/{id} -> Api/ApiCustomsController@update method
     * 
     */
    public function testUpdateCustom()
    {
        ...
        $this->put('/api/v1/customs/' . $customTestRecord->customid, $data)
            ->seeStatusCode(200)
            ->seeJsonContains(['status' => $statusOk])
     ...
     * Delete to /api/v1/customs/{id} -> Api/ApiCustomsController@destroy method
     * 
     */
    public function testDeleteCustom()
    {
        ...
        $this->delete('/api/v1/customs/' . $customTestRecord->customid)
            ->seeStatusCode(200)
            ->seeJsonContains(['status' => $statusOk])
